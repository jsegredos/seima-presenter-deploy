...
`),i=new Blob([s],{type:"text/csv;charset=utf-8"});return console.log("✅ CSV generated successfully"),i}catch(t){throw console.error("❌ CSV generation failed:",t),t}}async generateBothFiles(e){try{const[t,o]=await Promise.all([this.generatePDF(e),this.generateCSV(e)]);return{pdfBlob:t,csvBlob:o}}catch(t){throw console.error("❌ File generation failed:",t),t}}getSelectedProducts(){const e=JSON.parse(localStorage.getItem("selection")||"[]"),t=JSON.parse(localStorage.getItem(F.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");return t.length>0?t:e.map(o=>({product:o,room:o.Room||"",notes:o.Notes||"",quantity:o.Quantity||1}))}calculateTotalPrice(e,t){const s=(parseFloat(e.toString().replace(/[^0-9.]/g,""))||0)*(t||1);return s>0?s.toFixed(2):""}cleanForCSV(e){return e?e.toString().replace(/"/g,'""').replace(/[\r\n]/g," "):""}async generateQuotePDF(e){return await this.generatePDF(e)}async generateReportPDF(e){return await this.generatePDF(e)}generateFileName(e,t){const o=new Date,s=String(o.getDate()).padStart(2,"0"),i=String(o.getMonth()+1).padStart(2,"0"),n=String(o.getFullYear()).slice(-2),r=String(o.getHours()).padStart(2,"0"),a=String(o.getMinutes()).padStart(2,"0");return`${(e.project||"seima-selection").replace(/[^a-zA-Z0-9\s]/g,"")}-${s}${i}${n}.${r}${a}.${t}`}downloadFile(e,t){const o=URL.createObjectURL(e),s=document.createElement("a");s.href=o,s.download=t,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(o)}getSelectionSummary(){const e=this.getSelectedProducts(),t=e.length,s=new Set(e.map(n=>n.room).filter(Boolean)).size||1;let i=0;return e.forEach(n=>{var c,l;const r=parseFloat((((c=n.product)==null?void 0:c.UserEditedPrice)||((l=n.product)==null?void 0:l.RRP_EX)||"0").toString().replace(/[^0-9.]/g,""))||0,a=n.quantity||1;i+=r*a}),{totalProducts:t,totalRooms:s,totalValue:i,hasProducts:t>0}}}const io=new so,no={Utils:x},ro=A;class ao{constructor(){this.modules={dataLayer:_,pdfGenerator:io,pdfCore:lt,pdfLayouts:kt,StorageManager:E,utils:no},this.isInitialized=!1,this.initStatus={}}async init(){try{console.log("🚀 Initializing modular components...");const e=await this.initModule("dataLayer",this.modules.dataLayer);return this.initStatus.dataLayer=e,this.initStatus.pdfGenerator="deferred",this.isInitialized=!0,console.log("✅ Module initialization complete:",this.initStatus),this.initStatus}catch(e){return console.error("❌ Module coordinator initialization failed:",e),!1}}async initModule(e,t){try{if(t&&typeof t.init=="function"){const o=await t.init();return console.log(`✅ ${e} initialized:`,o),o}else return console.log(`ℹ️ ${e} does not require initialization`),!0}catch(o){throw console.error(`❌ Failed to initialize ${e}:`,o),o}}async searchProducts(e,t=10){return this.modules.dataLayer.isLoaded||await this.modules.dataLayer.init(),this.modules.dataLayer.searchProducts(e,t)}async findProductByCode(e){return this.modules.dataLayer.isLoaded||await this.modules.dataLayer.init(),this.modules.dataLayer.findProductByCode(e)}async addProductToSelection(e,{room:t="",notes:o="",quantity:s=1}={}){return this.modules.dataLayer.addProductToSelection(e,{room:t,notes:o,quantity:s})}getSelectedProducts(){return this.modules.dataLayer.getSelectedProducts()}getSelectionSummary(){return this.modules.dataLayer.getSelectionSummary()}async generatePDF(e){return await this.modules.pdfGenerator.generatePDF(e)}async generateCSV(e){return await this.modules.pdfGenerator.generateCSV(e)}async generateBothFiles(e){return await this.modules.pdfGenerator.generateBothFiles(e)}async sendEmail(e,t){return await this.modules.emailService.sendEmailWithPDF(e,t)}clearSelection(){return this.modules.dataLayer.clearSelection()}getModuleStatus(){return{initialized:this.isInitialized,moduleStatus:this.initStatus,dataLayer:{loaded:this.modules.dataLayer.isLoaded,productCount:this.modules.dataLayer.products.length},selection:{count:this.getSelectedProducts().length,summary:this.getSelectionSummary()}}}async reinitializeModule(e){if(this.modules[e])try{return this.initStatus[e]=await this.initModule(e,this.modules[e]),this.initStatus[e]}catch(t){return console.error(`❌ Failed to reinitialize ${e}:`,t),!1}return!1}async batchAddProducts(e){const t=[];for(const{product:o,room:s,notes:i,quantity:n}of e)try{const r=await this.addProductToSelection(o,{room:s,notes:i,quantity:n});t.push({success:!0,result:r})}catch(r){t.push({success:!1,error:r.message,product:o})}return t}exportState(){return{moduleStatus:this.getModuleStatus(),config:ro,timestamp:new Date().toISOString()}}}const co=new ao;co.init().catch(g=>{console.error("❌ Auto-initialization failed:",g)});class lo{constructor(){this.currentScreen="welcome",this.currentSearchResults=[]}async init(){if(!_.isLoaded)try{await _.init()}catch(e){console.error("Failed to load product catalog:",e)}this.updateSelectionCount(),this.setVersion()}setVersion(){const e=document.getElementById("version-number");e&&(e.innerText=F.VERSION)}_formatProductPriceGstLabel(e){const t=e.RRP_EX||e["RRP EX GST"]||e.RRP_EX||e.RRP_EXGST||e.rrpExGst||e["PL1 - RRP EX GST"]||"",o=e.RRP_INCGST||e["RRP INC GST"]||e.rrpIncGst||"",s=parseFloat(String(t).replace(/,/g,""));if(Number.isFinite(s)&&s>0)return`$${s.toFixed(2)} ex GST`;const i=parseFloat(String(o).replace(/,/g,""));return Number.isFinite(i)&&i>0?`$${i.toFixed(2)} inc GST`:"Price not available"}async showProductLookupScreen(){try{const t=await(await fetch("./screens/product-grid.html")).text();document.body.innerHTML=t,this.currentScreen="product-grid";const o=document.createElement("script");o.type="module",o.src="js/app.js",document.body.appendChild(o),setTimeout(()=>{document.querySelectorAll(".back-btn").forEach(s=>s.remove())},100),window.productGridManager&&window.productGridManager.init(),await this.loadVersion(),setTimeout(()=>this.loadVersion(),1e3)}catch(e){console.error("Failed to load product grid screen:",e)}}setupSplitInterface(){const e=document.getElementById("back-to-home");e&&(e.onclick=()=>location.reload());const t=document.getElementById("download-btn"),o=document.getElementById("clear-all-btn");t&&(t.onclick=()=>this.showDownloadFormModal()),o&&(o.onclick=()=>this.showClearConfirmModal()),this.setupSplitProductSearch(),this.setupReviewTable(),this.renderReviewTable(),this.loadInitialSearchResults()}setupSplitProductSearch(){const e=document.getElementById("product-search-input"),t=document.getElementById("search-results-list"),o=document.getElementById("search-loading"),s=document.getElementById("search-no-results");if(!e||!t)return;const i=[],n=x.debounce(r=>{this.performSplitProductSearch(r,t,i,o,s)},200);e.addEventListener("input",()=>{const r=e.value.trim();r?n(r):this.loadInitialSearchResults()}),t.addEventListener("click",r=>{const a=r.target.closest(".result-item");if(!a)return;const c=parseInt(a.getAttribute("data-idx"),10),l=i.length>0?i:this.currentSearchResults||[];!isNaN(c)&&l[c]&&this.showSplitProductDetails(l[c])})}performSplitProductSearch(e,t,o,s,i){if(!_.isLoaded){s.style.display="flex",i.style.display="none",t.innerHTML="";return}o.length=0,o.push(..._.searchProducts(e)),s.style.display="none",o.length===0?(i.style.display="flex",t.innerHTML=""):(i.style.display="none",t.innerHTML=o.map((n,r)=>`
    ...
    `,document.body.appendChild(o);const i=Ft();Ke(Qe("assets/seima-logo.png"),async(n,r,a)=>{const c=JSON.parse(localStorage.getItem("selection")||"[]"),l=JSON.parse(localStorage.getItem(F.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");let d=[];l.length>0?d=l.map(v=>{const b=v.product||{};return Be({...b,Image_URL:b.Image_URL||b.imageUrl||b["Image URL"]||"",Diagram_URL:b.Diagram_URL||b.diagramUrl||b["Diagram URL"]||"",Datasheet_URL:b.Datasheet_URL||b.datasheetUrl||b["Datasheet URL"]||"",Website_URL:b.Website_URL||b.websiteUrl||b["Website URL"]||"",Room:v.room,Notes:v.notes,PlanCode:v.planCode||"",Quantity:v.quantity,Timestamp:new Date(v.timestamp).toISOString()})}):d=Array.isArray(c)?c.map(v=>Be({...v})):c;const u=document.getElementById("sort-by"),m=u?u.value:"room";switch(m){case"code":d.sort((v,b)=>{const C=v.OrderCode||v.Code||"",k=b.OrderCode||b.Code||"";return C.localeCompare(k)});break;case"product":d.sort((v,b)=>{const C=v.Description||v.ProductName||"",k=b.Description||b.ProductName||"";return C.localeCompare(k)});break;case"imported":break;case"category":d.sort((v,b)=>{const C=String(v.Group||v.SubGroup||v["Sub Group"]||"").trim()||"Blank",k=String(b.Group||b.SubGroup||b["Sub Group"]||"").trim()||"Blank";return C===k?0:C==="Blank"?1:k==="Blank"?-1:C.localeCompare(k)});break;case"room":default:{let v=[];try{const b=localStorage.getItem("customRoomOrder");v=b?JSON.parse(b):[]}catch{v=[]}d.sort((b,C)=>{const k=b.Room||"Blank",R=C.Room||"Blank";if(k===R)return 0;if(k==="Blank")return 1;if(R==="Blank")return-1;const I=v.indexOf(k),T=v.indexOf(R);return I!==-1&&T!==-1?I-T:I!==-1?-1:T!==-1?1:k.localeCompare(R)});break}}if(!d.length){alert("No products selected."),t&&(t.style.display="none");return}if(pt()>0)console.log(`📷 Using ${pt()} pre-cached images (skipping duplicate preload)`);else{const v=document.getElementById("pdf-processing-notification");if(v){const b=document.createElement("span");b.id="preload-progress",b.style.cssText="display: block; font-size: 12px; margin-top: 8px; color: #1e40af;",b.textContent="Loading images: 0%",v.appendChild(b)}console.log("📷 Starting image preload for",d.length,"products"),_t(d).then(b=>{const C=document.getElementById("preload-progress");C&&(C.textContent=`✓ ${b} images ready`,C.style.color="#059669")}).catch(b=>{console.warn("Image preloading error:",b)})}const h={};m==="room"?d.forEach(v=>{const b=v.Room||"Blank";h[b]||(h[b]=[]),h[b].push(v)}):m==="category"?d.forEach(v=>{const b=String(v.Group||v.SubGroup||v["Sub Group"]||"").trim()||"Blank";h[b]||(h[b]=[]),h[b].push(v)}):h.__all__=d,await i;const{jsPDF:y}=window.jspdf,f=new y({orientation:"landscape",unit:"pt",format:"a4",compress:!0,putOnlyUsedFonts:!0,precision:16,userUnit:1,floatPrecision:16}),S=f.internal.pageSize.getWidth(),w=f.internal.pageSize.getHeight();Ke(Qe("assets/seima-logo.png"),async(v,b,C)=>{const k=L.getCurrentUser(),R=E.getUserSettings(),I=k?{name:k.name,email:k.email,phone:k.phone,position:k.position}:R;let T=null;try{const{get:B}=await M(async()=>{const{get:U}=await import("./vendor-idb-DwnyWBFG.js");return{get:U}},[]);T=await B("customerLogo")}catch{}Gt(f,{pageWidth:S,pageHeight:w,seimaLogoDataUrl:v,seimaLogoNaturalW:b,seimaLogoNaturalH:C,customerLogoDataUrl:T,userDetails:g,staffContact:I,footerHeight:ht.footerHeight}),f.addPage(),Ke(Qe("assets/seima-logo-white.png"),(B,U,H)=>{const W=g.showRrp&&!g.excludePrice,de=!g.excludePrice,Ae=!g.excludeQty,We=Ht(S,{leftMargin:32,rightMargin:32,showRrp:W,showPrice:de,showQty:Ae,showTotal:de&&Ae}),{colX:le,colW:xe,headers:oe}=We,_e=ht.footerHeight;yt();const ut=($,G,Z,ae,j,q,O)=>{if(!G||typeof G!="string"){O&&O();return}let X=G.trim();if(X.startsWith("//")&&(X=`https:${X}`),Mt(X)){O&&O();return}if(Se.totalImages++,g.emailCompatible){Se.failedImages++,O&&O();return}const se=Ut(X);if(se&&se.dataUrl)try{const me=se.width/se.height;let D=j,N=j/me;N>q&&(N=q,D=q*me),$.addImage(se.dataUrl,se.format,Z,ae,D,N,void 0,"FAST"),Se.optimizedImages++,O&&O();return}catch{console.warn("Failed to use cached image, falling back to direct load")}let ie=!1;const ke=Ot(X);let ue=0;function ee(){if(ie)return;if(ue>=ke.length){ie=!0,console.warn("All image fetch attempts failed, skipping:",X.substring(0,70)),Se.failedImages++,O&&O();return}const me=ke[ue];ue+=1;const D=new Image;D.crossOrigin="Anonymous";let N=null;D.onload=function(){if(!ie){N&&clearTimeout(N);try{const pe=It(0),Ue=pe.imageMaxWidth,ve=j,he=q;try{const z=document.createElement("canvas"),Y=z.getContext("2d"),{width:ge,height:Ce}=vo(D.width,D.height,Ue);z.width=ge,z.height=Ce,Y.imageSmoothingEnabled=!0,Y.imageSmoothingQuality="high",Y.drawImage(D,0,0,ge,Ce);let Ye,Je="JPEG";const $t=yo(z,Y),Bt=fo(z,Y);$t||Bt?(Ye=z.toDataURL("image/png",pe.imageQuality),Je="PNG"):(Ye=z.toDataURL("image/jpeg",pe.imageQuality),Je="JPEG");const At=`img_${_o(X)}`;$.addImage(Ye,Je,Z,ae,ve,he,At,"FAST"),ie=!0,Se.optimizedImages++,O&&O()}catch(z){console.warn(`Failed to optimize image: ${X}`,z);try{$.addImage(D,"JPEG",Z,ae,ve,he),ie=!0,Se.optimizedImages++,O&&O()}catch(Y){console.error(`Fallback also failed for: ${X}`,Y),setTimeout(ee,150)}}}catch(pe){console.warn("Failed to add image to PDF:",pe),setTimeout(ee,150)}}},D.onerror=function(){ie||(N&&clearTimeout(N),console.warn(`Failed to load image attempt: ${me.substring(0,80)}`),setTimeout(ee,150))},N=setTimeout(()=>{ie||(D.src="",D.onload=null,D.onerror=null,setTimeout(ee,50))},3e3),D.src=me}ee()},re=[];Object.keys(h).forEach(($,G)=>{const Z=h[$];if(!Z||!Array.isArray(Z)){console.warn("⚠️ Skipping invalid room items:",$,Z);return}Z.forEach((ae,j)=>{if(!ae){console.warn("⚠️ Skipping null item in room:",$,"at index:",j);return}re.push({item:ae,room:$,rIdx:G,iIdx:j,isFirstInRoom:j===0,roomCount:Z.length})})}),re.reduce(($,G)=>{if(!G||!G.item)return console.warn("⚠️ Skipping null row in data analysis:",G),$;const Z=String(G.item.Description||""),ae=String(G.item.LongDescription||""),j=String(G.item.Notes||""),q=String(G.item.OrderCode||"");return $+Z.length+ae.length+j.length+q.length},0);let Te=0,Fe=0;const Ne=4,Me=8,Ve=Math.floor((w-80)/Ne);let mt=_e+8;function Xe(){if(!re||!Array.isArray(re)){console.error("❌ Critical error: rowsToDraw is not a valid array:",re),ft(new Error("Invalid product data structure"),"generating PDF","unknown.pdf");return}if(Te>=re.length){const j=f.internal.getNumberOfPages()-1;for(let D=2;D<=j+1;D++){f.setPage(D);const pe=(D-2)*Ne,Ue=Math.min(pe+Ne,re.length);let ve=!1,he=!1;for(let z=pe;z<Ue;z++){const Y=re[z]&&re[z].item;if(Y&&(!ve&&jt(Y)&&(ve=!0),!he&&String(Y.PlanCode||"").trim()&&(he=!0),ve&&he))break}qt(f,{pageWidth:S,colX:le,colW:xe,leftMargin:32,footerHeight:_e,logoDataUrl:B,logoNaturalW:U,logoNaturalH:H,headers:oe,userDetails:g,skipWelsHeader:!ve,showRefAboveCode:he}),Wt(f,{pageWidth:S,pageHeight:w,leftMargin:32,footerHeight:_e,pageNumber:D-1,totalPages:j})}const q=new Date,O=String(q.getDate()).padStart(2,"0"),X=String(q.getMonth()+1).padStart(2,"0"),se=String(q.getFullYear()).slice(-2),ie=String(q.getHours()).padStart(2,"0"),ke=String(q.getMinutes()).padStart(2,"0"),ee=`${g.project.replace(/[^a-zA-Z0-9\s]/g,"")}-${O}${X}${se}.${ie}${ke}.pdf`,me=document.getElementById("pdf-processing-notification");me&&me.remove(),ko(g.emailCompatible);try{const D=f.output("blob"),N=f.output("string"),pe=N?N.match(/\/Type\s*\/XObject/g):null,Ue=N?N.match(/Tj\s/g):null,ve=N?N.match(/\/A\s*<</g):null;g.pdfSize=D.size;const he=So(D,ee);if(g.sendEmail&&D.size>15*1024*1024){console.warn(`❌ PDF too large for email (${(D.size/1024/1024).toFixed(1)}MB), offering email-compatible version`),Ro(g,ee);return}const z=bo(D,he.settings);if(g.sendEmail&&g.email)if(g.exportCsv){const Y=ee.replace(/\.pdf$/,".csv");gt(g,Y).then(ge=>{window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:g,pdfBlob:z,csvBlob:ge}}))}).catch(ge=>{console.error("Async CSV generation for email failed:",ge),window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:g,pdfBlob:z,csvBlob:null}}))})}else window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:g,pdfBlob:z,csvBlob:null}}));else(async()=>{const Y=await Lo(z);if(await nt(Y,ee,"PDF"),g.exportCsv){const ge=ee.replace(/\.pdf$/,".csv");try{const Ce=await gt(g,ge);Ce&&await nt(Ce,ge,"CSV")}catch(Ce){console.error("CSV generation failed:",Ce)}}})()}catch(D){console.error("PDF generation failed:",D),ft(D,"generating PDF",ee);const N=document.getElementById("pdf-processing-notification");N&&N.remove()}t&&(t.style.display="none");return}Fe>=Ne&&(f.addPage(),mt=_e+8,Fe=0);const $=re[Te];if(!$||!$.item){console.warn(`⚠️  Skipping invalid row at index ${Te}:`,$),Te++,Xe();return}const G=mt+Ve*Fe;$.isFirstInRoom&&(m==="room"||m==="category")&&$.room!=="__all__"&&Vt(f,$.room,$.roomCount,32,G);const Z=le[0],ae=Z+90+12;Nt($.item),ut(f,$.item.Image_URL||"",Z,G+Me+16,90,Ve-Me*2,()=>{ut(f,$.item.Diagram_URL||"",ae,G+Me+16,90,Ve-Me*2,()=>{const j=G+28,q=le[1]+xe[1]/2,O=String($.item.PlanCode||"").trim(),X=j+10,se=X+12,ie=se+25;O&&(f.setFontSize(10),f.setTextColor(zt.headerBackground),f.setFont("helvetica","bold"),f.text(O.toUpperCase(),q,X,{align:"center"}),f.setFont("helvetica","normal")),f.setFontSize(10),f.setTextColor("#222"),f.text(String($.item.OrderCode||""),q,se,{align:"center"}),Xt(f,$.item,q,ie);const ke=xe[2]-10;Yt(f,$.item,le[2],j+10,ke,g.excludeLongDescription);const ue=oe.indexOf("WELS")+1;if(ue>0&&le[ue]){const ee=le[ue]+xe[ue]/2;Jt(f,$.item,ee,j+10)}Qt(f,$.item,le,xe,oe,j+10,{excludePrice:g.excludePrice,includeGst:g.includeGst}),Te++,Fe++,Xe()})})}Xe()})})})}function Ke(g,e){const t=new window.Image;t.crossOrigin="Anonymous",t.onload=function(){const o=document.createElement("canvas"),s=o.getContext("2d"),i=400,n=150;let r=t.width,a=t.height;if(r>i||a>n){const l=i/r,d=n/a,u=Math.min(l,d);r=Math.round(r*u),a=Math.round(a*u)}o.width=r,o.height=a,s.imageSmoothingEnabled=!0,s.imageSmoothingQuality="high",s.drawImage(t,0,0,r,a);const c=o.toDataURL("image/png",.9);e(c,r,a)},t.onerror=function(){console.error("PDF brand image failed to load:",g),e(null,0,0)},t.src=g}function uo(){if(!document.getElementById("pdf-spinner")){const g=document.createElement("div");if(g.id="pdf-spinner",g.style.display="none",g.style.position="fixed",g.style.top="0",g.style.left="0",g.style.width="100vw",g.style.height="100vh",g.style.zIndex="9999",g.style.background="rgba(255,255,255,0.7)",g.style.alignItems="center",g.style.justifyContent="center",g.innerHTML='<div style="border:6px solid #e0e0e0;border-top:6px solid #2563eb;border-radius:50%;width:54px;height:54px;animation:spin 1s linear infinite;"></div>',document.body.appendChild(g),!document.getElementById("pdf-spinner-style")){const e=document.createElement("style");e.id="pdf-spinner-style",e.innerHTML="@keyframes spin { 0% { transform: rotate(0deg);} 100% { transform: rotate(360deg);} }",document.head.appendChild(e)}}}async function gt(g,e){return new Promise(async t=>{if(!window.Papa)try{await x.loadScript("https://cdn.jsdelivr.net/npm/papaparse@5.4.1/papaparse.min.js")}catch(n){console.error("Failed to load PapaParse:",n),t(null);return}const o=JSON.parse(localStorage.getItem("selection")||"[]"),s=JSON.parse(localStorage.getItem(F.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");let i=[];if(s.length>0?i=s.map(n=>{const r=n.product||{};return Be({...r,Image_URL:r.Image_URL||r.imageUrl||r["Image URL"]||"",Diagram_URL:r.Diagram_URL||r.diagramUrl||r["Diagram URL"]||"",Datasheet_URL:r.Datasheet_URL||r.datasheetUrl||r["Datasheet URL"]||"",Website_URL:r.Website_URL||r.websiteUrl||r["Website URL"]||"",Room:n.room,Notes:n.notes,PlanCode:n.planCode||"",Quantity:n.quantity,Timestamp:new Date(n.timestamp).toISOString()})}):i=Array.isArray(o)?o.map(n=>Be({...n})):o,!i.length){t(null);return}setTimeout(()=>{const n=i.map(r=>{let a,c,l,d;const u=g.excludePrice;let m=0;if(r.UserEditedPrice!==void 0&&r.UserEditedPrice!==null&&r.UserEditedPrice!=="")m=parseFloat(r.UserEditedPrice.toString().replace(/,/g,""));else{const f=r.RRP_EX||r["RRP EX GST"]||r.RRP_EX||r.RRP_EXGST||"";m=parseFloat((f||"0").toString().replace(/,/g,""))}a=m,l="Price ea ex GST",d="Price Total ex GST",c=!isNaN(a)&&a>=0?(a*(r.Quantity||1)).toFixed(2):"";const p=r["WELS STAR"]||r.WELS_STAR||r.WELS_STAR||r.WelsStar||"",h=p&&p.toString().trim()?p.toString().replace(/[^\d.]/g,"").trim():"",y={Code:ce(r.OrderCode||""),Description:ce(r.Description||""),"WELS Star":ce(h),Quantity:r.Quantity||1,Notes:ce(r.Notes||""),Room:ce(r.Room||""),"Image URL":ce(r.Image_URL||""),"Diagram URL":ce(r.Diagram_URL||""),"Datasheet URL":ce(r.Datasheet_URL||""),"Website URL":ce(r.Website_URL||"")};return y[l]=u?"0.00":a>=0?a.toFixed(2):"",y[d]=u?"0.00":c,y["Plan Code"]=ce(r.PlanCode||""),y});setTimeout(()=>{const r=window.Papa.unparse(n,{quotes:!0,quoteChar:'"',delimiter:",",header:!0,newline:`\r
`,skipEmptyLines:!1,escapeChar:'"',transform:{value(a,c){return typeof a=="string"?a.replace(/\0/g,"").replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g,""):a}}});g.sendEmail?setTimeout(()=>{try{const a=btoa(unescape(encodeURIComponent(r)));t({name:e,data:a,contentType:"text/csv",originalSize:r.length,base64Size:a.length})}catch(a){console.error("CSV base64 encoding failed:",a),t(new Blob([r],{type:"text/csv"}))}},0):t(new Blob([r],{type:"text/csv"}))},0)},0)})}function ce(g){return typeof g!="string"&&(g=String(g)),g=g.replace(/\0/g,"").replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g,"").replace(/\r?\n|\r/g," ").trim(),g}async function mo(g,e,t="file"){try{if("showSaveFilePicker"in window){const s=await(await window.showSaveFilePicker({suggestedName:e,types:[{description:`${t} files`,accept:{[g.type]:[`.${e.split(".").pop()}`]}}]})).createWritable();return await s.write(g),await s.close(),!0}}catch(o){console.warn("File System Access API failed:",o)}return!1}function po(g,e,t="file"){try{if(g.size>2*1024*1024)return console.warn("File too large for data URI method"),!1;const o=new FileReader;return o.onload=function(s){try{const i=document.createElement("a");i.href=s.target.result,i.download=e,i.style.display="none",document.body.appendChild(i),i.click(),document.body.removeChild(i)}catch(i){console.error("Data URI download failed:",i)}},o.readAsDataURL(g),!0}catch(o){return console.warn("Data URI method failed:",o),!1}}function ho(g,e,t="file"){const o=URL.createObjectURL(g),s=document.createElement("div");s.style.cssText=`
  ...
  `,s.appendChild(i),document.body.appendChild(s),document.getElementById("manual-download-close").onclick=()=>{URL.revokeObjectURL(o),document.body.removeChild(s)},document.getElementById("manual-download-retry").onclick=()=>{URL.revokeObjectURL(o),document.body.removeChild(s),setTimeout(()=>{Rt(g,e,t)},1e3)},document.getElementById("copy-url-btn").onclick=()=>{const n=document.getElementById("manual-download-url");n.select(),n.setSelectionRange(0,99999);try{navigator.clipboard.writeText(o).then(()=>{const r=document.getElementById("copy-url-btn");r.textContent="Copied!",r.style.background="#059669",setTimeout(()=>{r.textContent="Copy",r.style.background="#059669"},2e3)}).catch(()=>{document.execCommand("copy");const r=document.getElementById("copy-url-btn");r.textContent="Copied!",setTimeout(()=>r.textContent="Copy",2e3)})}catch{alert("Copy failed. Please select the URL manually and copy it.")}},s.onclick=n=>{n.target===s&&(URL.revokeObjectURL(o),document.body.removeChild(s))},setTimeout(()=>{s.parentElement&&(URL.revokeObjectURL(o),document.body.removeChild(s))},5*60*1e3)}async function Rt(g,e,t="file"){try{if(await go(g,e))return}catch(o){console.warn("Standard download failed:",o)}await mo(g,e,t)||po(g,e,t)||ho(g,e,t)}function go(g,e){return new Promise(t=>{try{const o=URL.createObjectURL(g),s=document.createElement("a");s.href=o,s.download=e,s.style.display="none",document.body.appendChild(s);const i=setTimeout(()=>{n(),t(!1)},3e3),n=()=>{clearTimeout(i),s.parentElement&&document.body.removeChild(s),setTimeout(()=>URL.revokeObjectURL(o),1e3)};s.onclick=()=>{n(),t(!0)},s.click(),setTimeout(()=>{n(),t(!0)},500)}catch(o){console.error("Standard download error:",o),t(!1)}})}function fo(g){const e=document.createElement("canvas"),t=e.getContext("2d");e.width=Math.min(100,g.width),e.height=Math.min(100,g.height),t.drawImage(g,0,0,e.width,e.height);const s=t.getImageData(0,0,e.width,e.height).data,i=new Set;for(let n=0;n<s.length;n+=4){const r=`${s[n]},${s[n+1]},${s[n+2]}`;i.add(r)}return i.size<1e3}function yo(g,e){const o=e.getImageData(0,0,g.width,g.height).data;for(let s=3;s<o.length;s+=4)if(o[s]<255)return!0;return!1}function vo(g,e,t){if(g<=t)return{width:g,height:e};const o=e/g;return{width:t,height:Math.round(t*o)}}function It(g){return g>25*1024*1024?{compressionLevel:"aggressive",imageQuality:.6,imageMaxWidth:300,removeImages:!1,usePNG:!0,message:"Aggressive compression - maintaining technical diagram clarity"}:g>20*1024*1024?{compressionLevel:"high",imageQuality:.65,imageMaxWidth:350,removeImages:!1,usePNG:!0,message:"High compression - preserving technical diagram details"}:g>15*1024*1024?{compressionLevel:"medium",imageQuality:.7,imageMaxWidth:400,removeImages:!1,usePNG:!0,message:"Medium compression - optimal for technical documentation"}:g>10*1024*1024?{compressionLevel:"light",imageQuality:.75,imageMaxWidth:450,removeImages:!1,usePNG:!0,message:"Light compression - excellent technical diagram quality"}:{compressionLevel:"minimal",imageQuality:.8,imageMaxWidth:500,removeImages:!1,usePNG:!0,message:"Minimal compression - maximum technical diagram quality"}}function bo(g,e){return g}function So(g,e){const t=(g.size/1048576).toFixed(2),o=It(g.size);if(g.size>15*1024*1024){console.warn(`Large file detected (${t} MB) - exceeds typical email limit, may need email-compatible version`);const s=document.createElement("div");s.style.cssText=`
    ...
    `,s.innerHTML=`
      ...
      ">OK</button>
    `,document.body.appendChild(s),setTimeout(()=>{s.parentElement&&s.remove()},8e3)}else g.size>3*1024*1024;return{size:g.size,sizeInMB:parseFloat(t),settings:o}}function ft(g,e="",t=""){console.error("Detailed error:",g);const o={type:wo(g),message:g.message||"Unknown error",context:e,filename:t,timestamp:new Date().toISOString(),userAgent:navigator.userAgent},s=document.createElement("div");s.style.cssText=`
    position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
  ...
  `,s.appendChild(i),document.body.appendChild(s),document.getElementById("error-close").onclick=()=>{document.body.removeChild(s)},document.getElementById("error-retry").onclick=()=>{document.body.removeChild(s),console.log("Retry requested for:",e)},document.getElementById("error-report").onclick=()=>{Po(o),alert("Error details copied to clipboard. Please send this to support.")},s.onclick=n=>{n.target===s&&document.body.removeChild(s)},o}function wo(g){var o,s;const e=((o=g.message)==null?void 0:o.toLowerCase())||"",t=((s=g.stack)==null?void 0:s.toLowerCase())||"";return e.includes("network")||e.includes("fetch")?"network":e.includes("permission")||e.includes("denied")?"permission":e.includes("memory")||e.includes("quota")?"memory":e.includes("blob")||e.includes("url")?"download":e.includes("canvas")||e.includes("image")?"rendering":t.includes("jspdf")||e.includes("pdf")?"pdf":"unknown"}function xo(g){return{network:"Network Connection Error",permission:"Permission Required",memory:"Insufficient Memory",download:"Download Failed",rendering:"Display Error",pdf:"PDF Generation Error",unknown:"Unexpected Error"}[g]||"Error Occurred"}function Co(g,e,t){return{network:"Unable to load required resources. Please check your internet connection and try again.",permission:`Browser permission required to save ${t}. Please allow downloads and try again.`,memory:"Not enough memory to process this large file. Try closing other browser tabs or use fewer products.",download:`Failed to download ${t}. This may be due to browser security settings or storage limitations.`,rendering:"Unable to display product images properly. Some images may be missing from the final output.",pdf:`PDF generation failed while ${e}. The file may be too large or contain problematic data.`,unknown:`An unexpected error occurred while ${e}. Please try again or contact support.`}[g]||"An unknown error has occurred."}function Eo(g){const e={network:`
      ...
      </div>`};return e[g]||e.unknown}function Lt(){const g=navigator.userAgent;return g.includes("Chrome")?"Chrome":g.includes("Firefox")?"Firefox":g.includes("Safari")?"Safari":g.includes("Edge")?"Edge":g.includes("SamsungBrowser")?"Samsung Internet":"Unknown"}function Po(g){const e=`
...
========================
  `.trim();try{navigator.clipboard.writeText(e)}catch(t){console.error("Failed to copy error report:",t)}}let Se={totalImages:0,optimizedImages:0,failedImages:0,totalSavings:0};function _o(g){let e=0;if(g.length===0)return e.toString();for(let t=0;t<g.length;t++){const o=g.charCodeAt(t);e=(e<<5)-e+o,e=e&e}return Math.abs(e).toString(36)}function yt(){Se={totalImages:0,optimizedImages:0,failedImages:0,totalSavings:0}}function ko(g=!1){Se.totalImages>0}function Ro(g,e){const t=document.createElement("div");t.style.cssText=`
    position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
    background: rgba(0,0,0,0.8); z-index: 10001; display: flex; 
    align-items: center; justify-content: center; padding: 20px;
  ...
  `,document.body.appendChild(t),setTimeout(()=>{t.parentElement&&t.remove()},8e3)}const et="fredChatHistory",He="fredChatMessages",De="fredFeedback",Ie="fredQuestionLog",tt=16,K={PROXY_URL:"https://seima-ai-proxy.seima.workers.dev",MODEL:"gpt-4o",MAX_TOKENS:2e3,TEMPERATURE:.2,MAX_CATALOG_RESULTS:60};function ot(){return{"Content-Type":"application/json",...L.getAuthHeaders()}}const To=`You are a product specification parser for building/construction projects. Extract ALL product references from the provided text.
...
Return format: [{"code":"...","name":"...","brand":"...","category":"...","quantity":1,"finish":"...","section":"...","specCode":"...","style":"..."}]`;class Do{constructor(){this.conversationHistory=[],this._historyReady=this._loadHistory(),this.isProcessing=!1,this._catalogChecked=!1,this._syncing=!1,this.lastCompetitorProducts=new Map}async chat(e,t,o=null,s=null,i=null){var n,r;if(this.isProcessing)throw new Error("A request is already in progress");this.isProcessing=!0,await this._historyReady,this._catalogChecked||(this._catalogChecked=!0,this._checkCatalogFreshness());try{const a=typeof e=="string"?e:((r=(n=e.find)==null?void 0:n.call(e,l=>l.type==="text"))==null?void 0:r.text)||"";let c;try{c=await this._agentChatStream(a,o,i,s)}catch(l){console.warn("Agent chat failed, falling back to legacy flow:",l.message),c=null}if(c||(c=await this._legacyChat(e,a,t,o,s)),!c)throw new Error("No response from AI");return this.conversationHistory.push({role:"user",content:a||e},{role:"assistant",content:c}),this.conversationHistory.length>tt&&(this.conversationHistory=this.conversationHistory.slice(-tt)),await this._saveHistory(),{content:c,usage:null}}finally{this.isProcessing=!1}}async _agentChatStream(e,t,o,s){var r,a,c;const i=new AbortController,n=setTimeout(()=>i.abort(),6e4);try{const l=this._deriveIntentProfile(e),d=await fetch(`${K.PROXY_URL}/v1/agent-chat`,{method:"POST",headers:ot(),body:JSON.stringify({message:e,history:this.conversationHistory.slice(-12),model:K.MODEL,staffMode:L.isStaffMode(),powerUser:L.isPowerUser(),userEmail:((r=L.getCurrentUser())==null?void 0:r.email)||"",intentProfile:l,selectedProducts:(t==null?void 0:t.length)>0?t.map(S=>({OrderCode:S.OrderCode,ProductName:S.ProductName||S.Description,room:S.room})):void 0}),signal:i.signal});if(!d.ok){(c=(a=L).handleUnauthorizedResponse)==null||c.call(a,d,"agent-chat");const S=await d.json().catch(()=>({}));throw new Error(S.details||S.error||`Request failed (${d.status})`)}if((d.headers.get("content-type")||"").includes("application/json")){const S=await d.json();return S.needsSync?(this._ensureCatalogSync(),null):S.content||null}const m=d.body.getReader(),p=new TextDecoder;let h="",y="",f="";for(this.lastCompetitorProducts.clear();;){const{done:S,value:w}=await m.read();if(S)break;y+=p.decode(w,{stream:!0});const v=y.split(`
`);y=v.pop();for(const b of v)if(b.startsWith("event: "))f=b.slice(7).trim();else if(b.startsWith("data: ")){try{const C=JSON.parse(b.slice(6));if(f==="status"&&o)o(C.text);else if(f==="token")h+=C.text,s&&s(C.text);else if(f==="comp_products")for(const k of C.products||[])k.code&&this.lastCompetitorProducts.set(k.code,k);else if(f==="error")throw new Error(C.message||"Agent chat failed")}catch(C){if(C instanceof SyntaxError)continue;throw C}f=""}}return h||null}catch(l){throw l.name==="AbortError"?new Error("Request timed out."):l}finally{clearTimeout(n)}}async _legacyChat(e,t,o,s,i){var d,u,m;const n=[],r=await this._findRelevantProductsAI(t,o),a=this._deriveIntentProfile(t);if(r?n.push({role:"system",content:`SEIMA PRODUCT DATA (${r.count} products):
${r.text}
...
@s4`,codeEntries:s,verifiedMatch:i?{orderCode:String(i.OrderCode||i.Code||"").trim(),label:n||""}:null};if(e.product._crossHintCache=r,e.storageId)try{E.updateProductCrossHintCache(e.storageId,r)}catch(a){console.warn("Could not persist cross-hint cache:",(a==null?void 0:a.message)||a)}}_applyPlaceholderCrossHintDom(e,t,o,s){var u,m;const i=o.product.Description||"",n=e.closest(".grid-product-cell"),r=n==null?void 0:n.querySelector(".grid-placeholder-hint");if(r&&((u=s.codeEntries)==null?void 0:u.length)>0&&(r.innerHTML=this.buildPlaceholderHintHtml(i,s.codeEntries)),!((m=s.verifiedMatch)!=null&&m.orderCode)||!_.isLoaded||e.querySelector(".grid-seima-match-option"))return;const a=_.findProductByCode(String(s.verifiedMatch.orderCode).trim());if(!a)return;const c=document.createElement("button");c.type="button",c.className="grid-seima-match-btn grid-seima-match-option";const l=(a.Description||"").trim(),d=l.length>45?l.slice(0,45)+"…":l;c.textContent=`Matched Seima: ${a.OrderCode||""} – ${d}`,c.title=s.verifiedMatch.label||"",c.addEventListener("click",()=>{this._applyVerifiedSeimaToRow(t,a.OrderCode||a.Code||"")}),e.appendChild(c)}buildPlaceholderHintHtml(e,t){if(!e)return"";let o=x.sanitizeInput(e);if(t.length===0)return o;for(const{code:s,competitor:i,searchCode:n}of t){const r=this.escapeRegex(s),a="(?:(?:Code|Part\\s*(?:No\\.?|Number)|P\\/N|Order\\s*Code|SKU|Item\\s*(?:No\\.?|Number)?|#)\\s*:?\\s*)?",c=new RegExp("("+a+r+")","gi"),l=n??s,d=`<a href="#" class="grid-competitor-code-link" data-competitor="${x.sanitizeInput(i)}" data-code="${x.sanitizeInput(l)}" title="Review and link to a Seima product">$1</a>`;o=o.replace(c,d)}return o}async attachSeimaMatchSuggestions(){var r,a,c,l;if(!L.isPowerUser())return;const e=++this._matchSuggestionsRunId,t=document.querySelectorAll(".grid-seima-match-wrap");t.forEach(d=>{d.querySelectorAll(".grid-seima-match-btn, .grid-seima-match-option").forEach(u=>u.remove())});const o=[...t].filter(d=>{var m;const u=this.gridRows.find(p=>p.id===d.dataset.rowId);return(m=u==null?void 0:u.product)==null?void 0:m._placeholder});if(o.length===0)return;const s=document.getElementById("tender-import-banner");let i=0;if(s&&(s.innerHTML=`
    ...
    `,this._wireValidatorModalActions(e,t,o)}_wireValidatorModalActions(e,t,o){var a;const s=(a=this._validatorModal)==null?void 0:a.modal;if(!s)return;s.querySelectorAll(".gvm-match-card").forEach(c=>{c.addEventListener("click",l=>{if(l.target.closest(".gvm-btn"))return;const d=c.dataset.seimaSku;d&&this._showSeimaDetailInModal(d)})}),s.querySelectorAll(".gvm-btn-verify, .gvm-btn-reject, .gvm-btn-undo").forEach(c=>{c.addEventListener("click",async l=>{var p;l.stopPropagation();const d=c.dataset.sku,u=c.dataset.action,m=u==="verify"?"Verified":"Rejected";c.disabled=!0,c.textContent="…";try{await P.updateMatch(o,String(e.product_code),d,m);const h=t.find(y=>String(y.SeimaSKU)===d);if(h&&(h.Status=m),m==="Verified"&&((p=this._validatorModal)!=null&&p.rowId)){this._applyVerifiedSeimaToRow(this._validatorModal.rowId,d),this.closeValidatorModal(this._validatorModal.rowId);return}this._renderValidatorModal(e,t,o)}catch(h){console.error("Match update failed:",h),c.disabled=!1,c.textContent=u==="verify"?"✓ Verify":"✗ Reject"}})});const i=s.querySelector(".gvm-search-add-input"),n=s.querySelector(".gvm-search-results");if(!i||!n)return;let r;i.addEventListener("input",()=>{clearTimeout(r),r=setTimeout(()=>{this._renderValidatorSeimaSearch(i.value,n,e,t,o)},250)})}_renderValidatorSeimaSearch(e,t,o,s,i){if(!e||e.length<2){t.innerHTML="";return}const n=_.searchProducts(e,20),r=new Set(s.map(l=>String(l.SeimaSKU))),a=n.filter(l=>{const d=String(l.OrderCode||l.Code||"");return d&&!r.has(d)});if(a.length===0){t.innerHTML='<div class="gvm-no-matches">No Seima products found.</div>';return}const c=l=>x.sanitizeInput(l||"");t.innerHTML=a.slice(0,15).map(l=>{const d=l.OrderCode||l.Code||"",u=l.Description||l.ProductName||"",m=l.Image_URL||l.imageUrl||"",p=Ct(l);return`<div class="gvm-search-result" data-seima-code="${c(d)}">
      ...
      </div>`}).join(""),t.querySelectorAll(".gvm-search-result").forEach(l=>{const d=l.querySelector(".gvm-btn-verify");d==null||d.addEventListener("click",async u=>{var p;u.stopPropagation();const m=d.dataset.seimaCode;d.disabled=!0,d.textContent="…";try{const h=s.length+1;if(await P.addMatch(i,String(o.product_code),m,h,"Manual verification"),await P.updateMatch(i,String(o.product_code),m,"Verified"),s.push({CompetitorSKU:String(o.product_code),SeimaSKU:m,Rank:h,Confidence:"",MatchReason:"Manual verification",Status:"Verified"}),(p=this._validatorModal)!=null&&p.rowId){this._applyVerifiedSeimaToRow(this._validatorModal.rowId,m),this.closeValidatorModal(this._validatorModal.rowId);return}this._renderValidatorModal(o,s,i)}catch(h){console.error("Add match failed:",h),d.disabled=!1,d.textContent="✓ Verify"}})})}closeValidatorModal(e){var t,o;if(this._validatorModal){this._closeSeimaDetailPanel(),this._validatorModal.overlay.remove(),this._validatorModal.modal.remove(),this._validatorModal.escHandler&&document.removeEventListener("keydown",this._validatorModal.escHandler),this._validatorModal=null,P._index=null;try{for(const s of this.gridRows){if(!((t=s==null?void 0:s.product)!=null&&t._placeholder))continue;const i=s.product._crossHintCache;if(!(!i||i.v!==1)&&!((o=i.verifiedMatch)!=null&&o.orderCode)&&(delete s.product._crossHintCache,s.storageId))try{E.updateProductCrossHintCache(s.storageId,null)}catch{}}}catch(s){console.warn("Could not invalidate placeholder cross-hint caches:",(s==null?void 0:s.message)||s)}this.attachSeimaMatchSuggestions()}}async openPlaceholderSearch(e){var r,a,c;const t=this.gridRows.find(l=>l.id===e);if(!((r=t==null?void 0:t.product)!=null&&r._placeholder))return;const o=String(t.product.Description||""),s=this.extractCandidateCodes(o);_.isLoaded||await new Promise(l=>{const d=Date.now(),u=()=>{if(_.isLoaded||Date.now()-d>8e3)return l();setTimeout(u,80)};u()});const i=[];if(_.isLoaded&&s.length>0)for(const l of s){const d=_.findProductByCode(l);if(!d)continue;const u=String(d.OrderCode||d.Code||"").trim();u&&!i.includes(u)&&i.push(u)}if(i.length===1){this._applyVerifiedSeimaToRow(e,i[0]);return}if(P.isEnabled()&&s.length>0)try{await P.preload()}catch{}if(P.isEnabled()){for(const l of s)if(!(_.isLoaded&&_.findProductByCode(l)))try{const d=await P.findCompetitorEntryByCode(l);if(!d)continue;const u=d.matchedCode??((a=d.competitorProduct)==null?void 0:a.product_code)??l;P.isWriteEnabled()?await this.openValidatorModal(d.competitor,String(u),e):$e.open(`${P.getPublicCompetitorLabel(d.competitor)}: ${u}`,m=>{const p=(m==null?void 0:m.OrderCode)||(m==null?void 0:m.Code)||"";p&&this._applyVerifiedSeimaToRow(e,p)});return}catch{}}const n=[...i];if(P.isEnabled()){for(const l of s.slice(0,3))if(!(_.isLoaded&&_.findProductByCode(l)))try{const d=await P.findSeimaMatches(l);if((c=d==null?void 0:d.matches)!=null&&c.length)for(const u of d.matches){const m=String(u.SeimaSKU||"").trim();m&&!n.includes(m)&&n.push(m)}}catch{}}this.openSeimaSearchModal(e,o,n,s)}openSeimaSearchModal(e,t,o=[],s=[]){var S,w;this.closeSeimaSearchModal();const i=v=>x.sanitizeInput(v||""),n=this._derivePlaceholderSearchQuery(t),r=document.createElement("div");r.className="grid-validator-overlay";const a=document.createElement("div");a.className="grid-validator-modal";const c=o.map(v=>{const b=_.findProductByCode(v);if(!b)return"";const C=b.Description||b.ProductName||v;return`
    ...
    `;const B=()=>{T.remove(),document.removeEventListener("keydown",U)};T.addEventListener("click",H=>{H.target===T&&B()}),T.querySelector(".grid-pdm-close").addEventListener("click",B);const U=H=>{H.key==="Escape"&&B()};document.addEventListener("keydown",U),document.body.appendChild(T)}renderRowHtml(e){const t=e.product,o=t&&(t.Image_URL||t.imageUrl||t.Image)||"assets/no-image.png",s=t&&(t.Description||t.ProductName||t["Product Name"])||"",i=t&&(t.OrderCode||t.Code)||"",n=i?String(parseInt(i,10)):"",r=!!(t&&t._outsidePublicPricelist),a=r?'<abbr class="grid-part-ext-not-public" title="Not on the public price list. Confirm availability and pricing with Seima before treating as a standard stocked item.">*</abbr>':"",c=r?'<span class="grid-non-public-pill" title="Outside the public price list — validate with Seima">Special order</span>':"",l=e.planCode?x.sanitizeInput(e.planCode):"",d=e.price||t&&(t.RRP_EX||t["RRP EX GST"]||t.RRP_EX||t.rrpExGst||t.RRP_EXGST||t["PL1 - RRP EX GST"])||"",u=parseFloat((d||"").toString().replace(/,/g,""))||0,m=parseInt(e.quantity)||1,p=u*m,h=p>0?p.toLocaleString("en-AU",{minimumFractionDigits:2,maximumFractionDigits:2}):"";return`
      <div class="grid-row ${this.getRoomRowClass(e.room)}" data-row-id="${e.id}" data-room="${(e.room||"blank").toLowerCase()}">
        ...
        <div class="col-ref">
          <input type="text" class="grid-input" name="planCode" value="${l}" maxlength="32" placeholder="—" title="Builder/architect plan reference (e.g. SW01S, FX-01)" autocomplete="off" spellcheck="false">
        </div>
        ...
        <div class="col-price">
          <input type="text" class="grid-input" name="price" value="${d}" placeholder="0.00">
        </div>
        <div class="col-total">
    ...
    `;this.injectSaveDialogStyles(),document.body.insertAdjacentHTML("beforeend",i);const n=document.getElementById("save-dialog"),r=document.getElementById("save-doc-name"),a=document.getElementById("save-notes");r==null||r.focus(),r==null||r.select(),n.querySelectorAll("button[data-action]").forEach(l=>{l.addEventListener("click",async()=>{const d=l.dataset.action;if(d==="cancel"){n.remove();return}const u=(r==null?void 0:r.value.trim())||"Untitled Selection",m=(a==null?void 0:a.value.trim())||"";this.currentSelectionName=u;const p={...this.prepareSelectionData(),documentName:u,notes:m};n.querySelectorAll("button").forEach(h=>h.disabled=!0),l.textContent="Saving...";try{let h;d==="save-update"?h=await we.updateSelection(this.currentSelectionId,p):(h=await we.saveSelection(p),h.success&&h.id&&(this.currentSelectionId=h.id)),n.remove(),h.success?(this.hasUnsavedChanges=!1,this.lastSaveTime=new Date,this.updateContextHeader(),fe.success(d==="save-update"?"Selection updated!":"Selection saved!")):fe.error("Failed to save: "+(h.error||"Unknown error"))}catch(h){n.remove(),fe.error("Failed to save: "+h.message)}})}),n.addEventListener("click",l=>{l.target===n&&n.remove()});const c=l=>{l.key==="Escape"&&(n.remove(),document.removeEventListener("keydown",c))};document.addEventListener("keydown",c)}injectSaveDialogStyles(){if(document.getElementById("save-dialog-styles"))return;document.head.insertAdjacentHTML("beforeend",`
      <style id="save-dialog-styles">
        .save-dialog-overlay {
          position: fixed;
          top: 0;
    ...
    `,document.head.appendChild(e)}getSteps(){return[{icon:"logo",title:"Welcome to Product Presenter",text:"Create beautiful PDF presentations of Seima products for your clients in minutes.",features:[]},{icon:"📦",title:"Add Your Products",text:"There are three ways to get started:",features:[{icon:"📁",title:"Import a File",desc:"Upload CSV or Excel files with product codes"},{icon:"📂",title:"Load a Selection",desc:"Continue from a previous saved selection"},{icon:"🔍",title:"Search Products",desc:"Search and add products one by one"}]},{icon:"🏠",title:"Organise by Room",text:"Group products by room or area. Drag to reorder, and easily manage your selection.",features:[{icon:"🎨",title:"Colour-coded",desc:"Rooms are visually distinct for quick reference"},{icon:"📊",title:"Sort Options",desc:"Sort by Room/Group, Product Code, or Product Name"},{icon:"💾",title:"Auto-saves",desc:"Your work is automatically preserved"}]},{icon:"📄",title:"Create Your PDF",text:'Click "Create PDF" to customise and generate a professional presentation with your branding.',features:[{icon:"💰",title:"Pricing Options",desc:"Show RRP, add GST, or hide pricing entirely"},{icon:"📝",title:"Content Control",desc:"Include descriptions and custom notes"},{icon:"📑",title:"Cover Pages",desc:"Add branded cover and appendix pages"}]}]}renderStep(){const e=this.getSteps(),t=e[this.currentStep],o=document.getElementById("onboarding-content"),s=document.getElementById("onboarding-dots"),i=document.getElementById("onboarding-next");if(!o||!s)return;let n="";t.features.length>0&&(n=t.features.map(a=>`
      ...
      ${n}
    `,s.innerHTML=e.map((a,c)=>`<div class="onboarding-dot ${c===this.currentStep?"active":""}"></div>`).join(""),i&&(i.textContent=this.currentStep===e.length-1?"Get Started":"Next")}nextStep(){const e=this.getSteps();this.currentStep<e.length-1?(this.currentStep++,this.renderStep()):this.complete()}complete(){localStorage.setItem(it,JSON.stringify({version:Et,completedAt:new Date().toISOString()})),this.overlay&&(this.overlay.style.animation="fadeIn 0.2s ease reverse",setTimeout(()=>{this.overlay.remove(),this.overlay=null},200))}reset(){localStorage.removeItem(it)}}const Dt=new jo;class qo{constructor(){this.panel=null,this.messagesContainer=null,this.input=null,this.sendBtn=null,this.isOpen=!1,this._lastUserMessage=null,this._conversationId=null,this._userEmail=null,this._historyOpen=!1}init(){this._createPanel(),this._bindEvents(),this._restoreMessages(),this._initUserEmail()}_createPanel(){const e=document.createElement("div");e.id="ai-chat-panel",e.className="ai-chat-panel",e.innerHTML=`
...
`).filter(d=>d.trim());if(s.length<2)return o;const i=d=>d.split("|").slice(1,-1).map(u=>u.trim()),n=d=>/^\|[\s:|-]+\|$/.test(d.trim());let r=i(s[0]),a=1;s.length>1&&n(s[1])&&(a=2);let c="<thead><tr>"+r.map(d=>`<th>${d}</th>`).join("")+"</tr></thead>",l="<tbody>"+s.slice(a).filter(d=>!n(d)).map(d=>"<tr>"+i(d).map(u=>`<td>${u}</td>`).join("")+"</tr>").join("")+"</tbody>";return`<table class="ai-comparison-table">${c}${l}</table>`}),t=t.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>"),t=t.replace(/`([^`]+)`/g,"<code>$1</code>"),t=t.replace(/^### (.+)$/gm,"<h4>$1</h4>"),t=t.replace(/^## (.+)$/gm,"<h3>$1</h3>"),t=t.replace(/^- (.+)$/gm,"<li>$1</li>"),t=t.replace(/(<li>.*<\/li>\n?)+/g,o=>`<ul>${o}</ul>`),t=t.replace(/^\d+\. (.+)$/gm,"<li>$1</li>"),t=t.replace(/\n\n/g,"</p><p>"),t=`<p>${t}</p>`,t=t.replace(/<p><\/p>/g,""),t=t.replace(/<p>(<h[34]>)/g,"$1"),t=t.replace(/(<\/h[34]>)<\/p>/g,"$1"),t=t.replace(/<p>(<ul>)/g,"$1"),t=t.replace(/(<\/ul>)<\/p>/g,"$1"),t=t.replace(/<p>(<table)/g,"$1"),t=t.replace(/(<\/table>)<\/p>/g,"$1"),t=t.replace(/\b(\d{6})\b/g,'<button class="ai-add-product-btn" data-code="$1" title="Add $1 to selection">$1 <span class="ai-add-icon">+</span></button>'),t}_getBasePath(){var e;return(((e=document.querySelector("base"))==null?void 0:e.href)||window.location.origin+"/").replace(/\/$/,"")}_getProductImage(e){return e.Image_URL||e.imageUrl||e.Image||`${this._getBasePath()}/assets/no-image.png`}_getProductName(e){return e.Description||e.ProductName||e["Product Name"]||""}_getProductMeta(e){const t=e.Finish||e.Colour||"",o=e.DimX||e["X Dimension (mm)"]||"",s=e.DimY||e["Y Dimension (mm)"]||"",i=e.DimZ||e["Z Dimension (mm)"]||"",n=o&&o!=="0"?`${o} × ${s||0} × ${i||0}mm`:"";return[t,n].filter(Boolean).join("  ·  ")}_getProductPrice(e){const t=e["RRP INC GST"]||e.RRP_INCGST||e["RRP EX GST"]||e.RRP_EXGST||"";return t?`$${parseFloat(t).toLocaleString("en-AU",{minimumFractionDigits:2})}`:""}_enrichTableProducts(e){const t=this._getBasePath(),o=ne.lastCompetitorProducts;e.querySelectorAll(".ai-comparison-table").forEach(s=>{const i=s.querySelector("thead"),n=s.querySelector("tbody");if(!i||!n)return;const a=i.querySelectorAll("th").length;if(a<2)return;const c=new Array(a).fill(null);if(n.querySelectorAll("tr").forEach(d=>{d.querySelectorAll("td").forEach((m,p)=>{if(c[p])return;const h=m.querySelector("strong"),y=(h?h.textContent:m.textContent).trim();if(y){if(/^\d{6}$/.test(y)){const f=_.findProductByCode(y);f&&(c[p]={src:this._getProductImage(f),click:()=>this._showProductModal(y)})}else if(o)for(const[f,S]of o){const w=String(f);if(w===y||y.includes(w)||w.includes(y)){c[p]={src:S.imageUrl||"",click:()=>this._showCompetitorModal(S.brand,f)};break}}}})}),!c.some(Boolean))return;const l=document.createElement("tr");l.className="ai-table-image-row";for(let d=0;d<a;d++){const u=document.createElement("td"),m=c[d];if(m&&m.src){const p=document.createElement("img");p.className="ai-table-product-img",p.src=m.src,p.alt="",p.onerror=()=>{p.src=`${t}/assets/no-image.png`},u.appendChild(p),m.click&&(u.style.cursor="pointer",u.addEventListener("click",m.click))}l.appendChild(u)}n.insertBefore(l,n.firstChild)})}_injectProductCards(e){e.querySelectorAll("table .ai-add-product-btn").forEach(s=>{const i=document.createElement("strong");i.textContent=s.dataset.code,s.replaceWith(i)});const t=e.querySelectorAll(".ai-add-product-btn");if(!t.length)return;const o=this._getBasePath();t.forEach(s=>{const i=s.dataset.code,n=_.findProductByCode(i);if(!n)return;const r=s.closest("li");if(!(r||s.parentElement))return;const c=this._getProductImage(n),l=this._getProductName(n),d=this._getProductMeta(n),u=this._getProductPrice(n),m=document.createElement("div");if(m.className="ai-product-card",m.dataset.code=i,m.innerHTML=`
    ...
    `,l.addEventListener("click",h=>{h.target===l&&l.remove()}),l.querySelector(".ai-product-modal-close").addEventListener("click",()=>l.remove()),document.addEventListener("keydown",function h(y){y.key==="Escape"&&(l.remove(),document.removeEventListener("keydown",h))}),document.body.appendChild(l),this._enrichCompetitorModal(l,e,t,s)}async _enrichCompetitorModal(e,t,o,s){const i=e.querySelector(".ai-product-modal-body"),n=i==null?void 0:i.querySelector(".ai-comp-modal-loading");try{const r=await P.findCompetitorEntryByCode(o);if(!(r!=null&&r.competitorProduct)){n&&n.remove();return}const a=r.competitorProduct,c=a.image_url||a.Image_URL||`${s}/assets/no-image.png`,l=a.product_name||a.ProductName||o,d=a.description||a.product_description||a.features||"",u=a.rrp_ex_gst||a.rrp||a.price||a.rrp_inc_gst||"",m=u?`$${parseFloat(u).toLocaleString("en-AU",{minimumFractionDigits:2})}`:"",p=a.product_url||"",h=[];a.product_code&&h.push(["Product Code",a.product_code]),a.collection&&h.push(["Collection",a.collection]),a.product_type&&h.push(["Category",a.product_type]),a.subcategory&&h.push(["Subcategory",a.subcategory]),(a.finish||a.colour)&&h.push(["Finish",a.finish||a.colour]),a.material&&h.push(["Material",a.material]),a.dimensions_mm&&h.push(["Dimensions",a.dimensions_mm]),a.wels_rating&&h.push(["WELS",a.wels_rating]),i.innerHTML=`
      ...
      <div class="ai-product-modal">
        ...
        <div class="ai-product-modal-body">
          ...
          <h3 class="ai-product-modal-title">${this._escapeHtml(n)}</h3>
          ${w.length?`<dl class="ai-product-modal-specs">${w.map(([b,C])=>`<dt>${this._escapeHtml(b)}</dt><dd>${this._escapeHtml(C)}</dd>`).join("")}</dl>`:""}
    ...
    `,v.addEventListener("click",b=>{b.target===v&&v.remove()}),v.querySelector(".ai-product-modal-close").addEventListener("click",()=>v.remove()),v.querySelector(".ai-product-modal-add").addEventListener("click",b=>{this._addProductToGrid(e,null);const C=b.currentTarget;C.classList.add("added"),C.disabled=!0,C.textContent="Added to Selection ✓"}),document.addEventListener("keydown",function b(C){C.key==="Escape"&&(v.remove(),document.removeEventListener("keydown",b))}),document.body.appendChild(v)}_appendFeedbackRow(e,t,o){const s=document.createElement("div");s.className="ai-feedback-row";const i=this._getFeedbackEntry(t),n=(i==null?void 0:i.rating)||null;s.innerHTML=`
    ...
    `,s.querySelectorAll(".ai-feedback-btn").forEach(a=>{a.addEventListener("click",()=>{const c=a.dataset.rating;s.querySelectorAll(".ai-feedback-btn").forEach(l=>l.classList.remove("active")),a.classList.add("active"),this._saveFeedback(t,o,c)})});const r=e.querySelector(".ai-msg-bubble");r?e.insertBefore(s,r.nextSibling):e.appendChild(s)}async _saveFeedback(e,t,o){try{const s=await this._loadFeedback(),i=s.findIndex(a=>a.id===e),n={id:e,question:this._lastUserMessage||"",answer:(t||"").slice(0,500),rating:o,timestamp:Date.now(),synced:!1};i>=0?s[i]={...s[i],...n}:s.push(n);const{set:r}=await M(async()=>{const{set:a}=await import("./vendor-idb-DwnyWBFG.js");return{set:a}},[]);await r(De,s)}catch{}}_getFeedbackEntry(e){return this._loadFeedback().then(t=>t.find(o=>o.id===e)||null)}async _loadFeedback(){try{const{get:e}=await M(async()=>{const{get:o}=await import("./vendor-idb-DwnyWBFG.js");return{get:o}},[]),t=await e(De);return Array.isArray(t)?t:[]}catch{return[]}}_escapeHtml(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}_scrollToBottom(){requestAnimationFrame(()=>{this.messagesContainer.scrollTop=this.messagesContainer.scrollHeight})}_enrichResponseBubble(e){this._injectProductCards(e),L.isPowerUser()&&(this._enrichTableProducts(e),this._injectCompetitorCards(e)),this._cleanupCardOrphans(e),this._collapseProductCards(e),this._attachProductButtons(e)}_persistMessages(){clearTimeout(this._persistTimer),this._persistTimer=setTimeout(()=>this._doPersistMessages(),500)}async _doPersistMessages(){try{const e=[];this.messagesContainer.querySelectorAll(".ai-msg").forEach(o=>{var s,i;o.classList.contains("ai-msg-user")?e.push({role:"user",content:((s=o.querySelector(".ai-msg-bubble"))==null?void 0:s.textContent)||""}):o.classList.contains("ai-msg-assistant")&&!o.querySelector(".ai-msg-thinking")&&e.push({role:"assistant",content:((i=o.querySelector(".ai-msg-bubble"))==null?void 0:i.dataset.rawContent)||"",feedbackId:o.dataset.feedbackId||null})});const{set:t}=await M(async()=>{const{set:o}=await import("./vendor-idb-DwnyWBFG.js");return{set:o}},[]);await t(He,e)}catch{}}async _restoreMessages(){try{localStorage.removeItem(He);const{get:e}=await M(async()=>{const{get:i}=await import("./vendor-idb-DwnyWBFG.js");return{get:i}},[]),t=await e(He);if(!Array.isArray(t)||t.length===0)return;const o=this.messagesContainer.querySelector(".ai-chat-welcome");o&&o.remove();for(const i of t)i.role==="user"&&(this._lastUserMessage=i.content),this._addMessage(i.role,i.content,{skipPersist:!0,feedbackId:i.feedbackId||null});const s=document.createElement("div");s.className="ai-chat-restored",s.textContent="Previous conversation restored",this.messagesContainer.prepend(s)}catch{}}_generateId(){return Date.now().toString(36)+Math.random().toString(36).substr(2)}async _trackQuestion(e){try{const{get:t,set:o}=await M(async()=>{const{get:n,set:r}=await import("./vendor-idb-DwnyWBFG.js");return{get:n,set:r}},[]),s=await t(Ie)||{},i=e.trim();if(i.length<5)return;s[i]=(s[i]||0)+1,await o(Ie,s)}catch{}}async _syncFeedback(){try{const{get:e,set:t,del:o}=await M(async()=>{const{get:a,set:c,del:l}=await import("./vendor-idb-DwnyWBFG.js");return{get:a,set:c,del:l}},[]),s=await this._loadFeedback(),i=s.filter(a=>!a.synced),n=await e(Ie)||null;if(i.length===0&&!n)return;if((await fetch(`${K.PROXY_URL}/v1/feedback`,{method:"POST",headers:{"Content-Type":"application/json",...L.getAuthHeaders()},body:JSON.stringify({entries:i,questionLog:n})})).ok){for(const a of i)a.synced=!0;this._pruneFeedback(s),await t(De,s),await o(Ie)}}catch{}}_pruneFeedback(e){const t=Date.now()-6048e5;for(let o=e.length-1;o>=0;o--)e[o].synced&&e[o].timestamp<t&&e.splice(o,1)}async _clearChat(){await ne.clearHistory();try{const{del:e}=await M(async()=>{const{del:t}=await import("./vendor-idb-DwnyWBFG.js");return{del:t}},[]);await e(De),await e(Ie)}catch{}localStorage.removeItem(De),localStorage.removeItem(Ie),this._showWelcome()}async _initUserEmail(){try{const e=L.getCurrentUser();this._userEmail=(e==null?void 0:e.email)||null}catch{}}async _saveConversation(){var s;if(!this._userEmail)return;const e=[];if(this.messagesContainer.querySelectorAll(".ai-msg").forEach(i=>{var n,r;i.classList.contains("ai-msg-user")?e.push({role:"user",content:((n=i.querySelector(".ai-msg-bubble"))==null?void 0:n.textContent)||""}):i.classList.contains("ai-msg-assistant")&&!i.querySelector(".ai-msg-thinking")&&e.push({role:"assistant",content:((r=i.querySelector(".ai-msg-bubble"))==null?void 0:r.dataset.rawContent)||""})}),e.length<2)return;this._conversationId||(this._conversationId=Date.now().toString(36)+Math.random().toString(36).slice(2,8));const t=((s=e.find(i=>i.role==="user"))==null?void 0:s.content)||"Untitled",o=t.length>50?t.slice(0,47)+"...":t;try{await fetch(`${K.PROXY_URL}/v1/conversations/${this._conversationId}`,{method:"PUT",headers:{"Content-Type":"application/json",...L.getAuthHeaders()},body:JSON.stringify({email:this._userEmail,title:o,messages:e})})}catch{}}_startNewConversation(){this._saveConversation(),this._conversationId=null,this._clearChat()}_toggleHistory(e){const t=this.panel.querySelector("#ai-chat-history-panel");this._historyOpen=e!==void 0?e:!this._historyOpen,t.classList.toggle("open",this._historyOpen),this._historyOpen&&this._loadConversationList()}async _loadConversationList(){if(!this._userEmail){this.panel.querySelector("#ai-chat-history-list").innerHTML='<div class="ai-chat-history-empty">Sign in to see conversation history.</div>';return}const e=this.panel.querySelector("#ai-chat-history-list");e.innerHTML='<div class="ai-chat-history-empty">Loading...</div>';try{const t=`${K.PROXY_URL}/v1/conversations?email=${encodeURIComponent(this._userEmail)}`,o=await fetch(t,{headers:L.getAuthHeaders()});if(!o.ok)throw new Error("Failed");const i=(await o.json()).conversations||[];if(i.length===0){e.innerHTML='<div class="ai-chat-history-empty">No previous conversations.</div>';return}e.innerHTML=i.map(n=>`
      ...
      `).join(""),e.querySelectorAll(".ai-chat-history-item").forEach(n=>{n.addEventListener("click",()=>this._loadConversation(n.dataset.id))})}catch{e.innerHTML='<div class="ai-chat-history-empty">Failed to load conversations.</div>'}}async _loadConversation(e){try{const t=`${K.PROXY_URL}/v1/conversations/${e}`,o=await fetch(t,{headers:L.getAuthHeaders()});if(!o.ok)throw new Error("Failed");const s=await o.json();this._conversationId=e,ne.clearHistory(),this.messagesContainer.innerHTML="";const i=this.messagesContainer.querySelector(".ai-chat-welcome");i&&i.remove();for(const r of s.messages||[])r.role==="user"&&(this._lastUserMessage=r.content),this._addMessage(r.role,r.content,{skipPersist:!0}),(r.role==="user"||r.role==="assistant")&&ne.conversationHistory.push(r);this._persistMessages(),this._toggleHistory(!1);const n=document.createElement("div");n.className="ai-chat-restored",n.textContent="Conversation restored",this.messagesContainer.prepend(n)}catch{console.error("Failed to load conversation")}}_formatHistoryTime(e){if(!e)return"";const t=new Date(e),s=new Date-t,i=Math.floor(s/864e5);return i===0?"Today":i===1?"Yesterday":i<7?`${i}d ago`:t.toLocaleDateString("en-AU",{day:"numeric",month:"short"})}open(){this.panel&&(this.panel.style.right="",this.panel.classList.add("open"),this.isOpen=!0,setTimeout(()=>{var e;return(e=this.input)==null?void 0:e.focus()},300),this._syncFeedback())}close(){if(!this.panel){this.isOpen=!1;return}const e=this.panel.offsetWidth||620;this.panel.style.right=-(e+20)+"px",this.panel.classList.remove("open"),this.isOpen=!1}toggle(){this.isOpen?this.close():this.open()}}const ct=new qo;class Wo{constructor(){this.navigationManager=null,this.fileImportManager=new $o,this.productGridManager=new je,this.isInitialized=!1,J.log("SeimaScanner application starting",Q.INFO)}async init(){var e,t,o;try{J.log("Initializing application modules",Q.INFO),L.configure({googleSheetsUrl:(e=F.PRESENTATION_RECORDING)==null?void 0:e.GOOGLE_SHEETS_URL,email:F.EMAIL}),te.configure({logoSrc:"assets/seima-logo.png",brandName:"Seima",appName:"Product Presenter"});const s=(t=F.PRESENTATION_RECORDING)==null?void 0:t.GOOGLE_SHEETS_URL;if(s&&eo(s).catch(r=>{console.warn("Synonyms preload failed:",(r==null?void 0:r.message)||r)}),(o=F.CROSSHAIR)!=null&&o.ENABLED){const r=L.getCurrentUser();P.configure(F.CROSSHAIR,(r==null?void 0:r.email)||""),P.preload().catch(a=>{console.warn("Crosshair preload failed (user may not be logged in):",a.message)})}this.navigationManager=new lo;const i=Re.getCompatibilityReport();J.log(`Browser compatibility: ${i.score}% (${i.browserName})`,Q.INFO),Re.shouldShowCompatibilityWarning()&&this.showCompatibilityWarning(),await this.navigationManager.init(),this.fileImportManager.init(),this.setupGlobalEventListeners(),this.productGridManager.init(),ct.init();const n=document.getElementById("ai-chat-trigger");return n&&n.addEventListener("click",()=>ct.toggle()),window.navigationManager=this.navigationManager,window.productGridManager=this.productGridManager,window.browserCompatibility=Re,window.downloadWithFallback=nt,window.showPdfFormScreen=rt,this.isInitialized=!0,J.log("Seima Scanner initialized successfully",Q.INFO),this._dismissLoadingOverlay(),setTimeout(()=>{Dt.show()},500),!0}catch(s){return J.handleError({message:"Failed to initialize application",error:s,category:Ee.UI,level:Q.CRITICAL,context:"app-init"}),this._dismissLoadingOverlay(),!1}}_dismissLoadingOverlay(){const e=document.getElementById("app-loading-overlay");e&&(e.classList.add("fade-out"),e.addEventListener("transitionend",()=>e.remove(),{once:!0}),setTimeout(()=>e.remove(),400))}showCompatibilityWarning(){const e=Re.getCompatibilityReport(),t=e.recommendations;if(t.length===0)return;const o=t.filter(n=>n.type==="critical"),s=e.score<A.get("compatibility.minCompatibilityScore",70);if(o.length===0&&!s)return;const i=document.createElement("div");i.style.cssText=`
    ...
    `,document.body.insertBefore(i,document.body.firstChild)}setupGlobalEventListeners(){window.addEventListener("generatePdf",e=>{const{tipTailSettings:t,...o}=e.detail;uo(),rt(o,t||null)}),window.addEventListener("beforeunload",()=>{}),Re.features.memoryAPI&&setInterval(()=>{const e=Re.memoryInfo;e.memoryPressure==="high"&&console.warn("High memory usage detected:",e)},6e4)}getSelectedProducts(){return E.getSelectedProducts()}clearSelection(){return E.clearAllSelections()}addProduct(e,{notes:t="",room:o="",quantity:s=1}={}){return E.addProductToSelection(e,{notes:t,room:o,quantity:s})}updateSelectionCount(){this.navigationManager&&this.navigationManager.updateSelectionCount()}showError(e){alert(e)}}document.addEventListener("DOMContentLoaded",async()=>{window.seimaScanner=new Wo,await window.seimaScanner.init(),window._appVersion=F.VERSION;const g=document.getElementById("menu-version-footer");g&&(g.textContent=`Ver: ${F.VERSION}`),Vo(),Xo();const e=document.getElementById("changelog-close");e&&e.addEventListener("click",()=>{document.getElementById("changelog-modal").style.display="none"})});function Vo(){const g=document.getElementById("help-btn");g&&g.addEventListener("click",()=>{Yo()});const e=document.getElementById("crosshair-btn");e&&e.addEventListener("click",()=>{window.location.href="screens/validator.html"});const t=document.getElementById("pending-btn");t&&t.addEventListener("click",()=>{window.location.href="screens/admin-pending.html"});const o=document.getElementById("landscape-btn");o&&o.addEventListener("click",()=>{window.location.href="screens/landscape.html"});const s=document.getElementById("admin-btn");s&&s.addEventListener("click",()=>{window.location.href="screens/admin.html"});const i=document.getElementById("quick-start-btn");i&&i.addEventListener("click",()=>{Dt.showForced()})}function Xo(){const g=document.getElementById("user-menu-container"),e=document.getElementById("user-menu-trigger"),t=document.getElementById("user-menu-dropdown"),o=document.getElementById("sign-in-btn"),s=document.getElementById("user-avatar"),i=document.getElementById("user-name-display");function n(c){var l,d,u,m,p,h,y,f,S,w,v;if(c){(l=F.CROSSHAIR)!=null&&l.ENABLED&&(P.configure(F.CROSSHAIR,c.email||""),P.preload().catch(de=>{console.warn("Crosshair preload after login failed:",de)})),g&&(g.style.display="block"),o&&(o.style.display="none");const b=document.getElementById("crosshair-btn"),C=document.getElementById("pending-btn"),k=L.isStaffMode(),R=L.isPowerUser(),I=L.isAdmin();b&&(b.style.display=(d=F.CROSSHAIR)!=null&&d.ENABLED&&k?"":"none"),C&&(C.style.display=k?"":"none");const T=document.getElementById("landscape-btn");T&&(T.style.display=(u=F.CROSSHAIR)!=null&&u.ENABLED&&k?"":"none");const B=document.getElementById("admin-btn");B&&(B.style.display=I?"":"none");const U=document.getElementById("staff-divider"),H=(b==null?void 0:b.style.display)!=="none"||(C==null?void 0:C.style.display)!=="none"||(T==null?void 0:T.style.display)!=="none"||(B==null?void 0:B.style.display)!=="none";U&&(U.style.display=H?"":"none"),document.querySelectorAll("#import-file-btn, #entry-import").forEach(de=>{de&&(de.style.display=R?"":"none")});const ye=document.getElementById("ai-chat-trigger");ye&&(ye.style.display="");const Pe=document.getElementById("guided-ask-fred");Pe&&(Pe.style.display="");const Le=r(c.name);s&&(s.textContent=Le),i&&(i.textContent=((m=c.name)==null?void 0:m.split(" ")[0])||"User");const qe=(c.email||"").toLowerCase().endsWith("@seima.com.au")&&c.emailVerified===!1;let W=document.getElementById("verify-email-banner");if(qe?(W||(W=document.createElement("div"),W.id="verify-email-banner",W.className="verify-email-banner",W.innerHTML=`
            <span>Verify your email to access staff features.</span>
            <button id="verify-email-btn" class="verify-email-btn">Verify now</button>
          `,document.body.insertBefore(W,document.body.firstChild),W.querySelector("#verify-email-btn").addEventListener("click",()=>{te.showVerifyEmail(c.email,()=>{n(L.getCurrentUser()),W==null||W.remove()})})),W.style.display=""):W&&(W.style.display="none"),t){const de=qe?`
        ...
        `,(p=document.getElementById("menu-verify-email"))==null||p.addEventListener("click",()=>{t.style.display="none",te.showVerifyEmail(c.email,()=>{var V;n(L.getCurrentUser()),(V=document.getElementById("verify-email-banner"))==null||V.remove()})}),(h=document.getElementById("menu-refresh"))==null||h.addEventListener("click",async()=>{t.style.display="none";try{const{del:V,keys:We}=await M(async()=>{const{del:oe,keys:_e}=await import("./vendor-idb-DwnyWBFG.js");return{del:oe,keys:_e}},[]),le=await We(),xe=["productCatalogCsv","customerLogo","fredChatHistory","fredChatMessages","fredFeedback","fredQuestionLog"];await Promise.all(le.filter(oe=>typeof oe=="string"&&(xe.includes(oe)||oe.startsWith("crosshair_"))).map(oe=>V(oe)))}catch{}localStorage.removeItem("configPreferences"),localStorage.removeItem("pdfWizardSettings"),Object.keys(localStorage).filter(V=>V.startsWith("crosshair_")||V.startsWith("fred")).forEach(V=>localStorage.removeItem(V)),window.location.reload()}),(y=document.getElementById("menu-version-footer"))==null||y.addEventListener("click",()=>{t.style.display="none",Qo()}),(f=document.getElementById("menu-profile"))==null||f.addEventListener("click",()=>{t.style.display="none",te.showEditProfile(V=>{E.clearUserSettings(),n(V)})}),(S=document.getElementById("menu-password"))==null||S.addEventListener("click",()=>{t.style.display="none",te.showChangePassword()}),(w=document.getElementById("menu-logout"))==null||w.addEventListener("click",()=>{var V;t.style.display="none",E.clearUserSettings(),P.clearAllCaches(),(V=window.productGridManager)!=null&&V.searchCache&&window.productGridManager.searchCache.clear(),L.logout(),n(null)})}}else{g&&(g.style.display="none"),o&&(o.style.display="block"),document.querySelectorAll("#import-file-btn, #entry-import").forEach(U=>{U&&(U.style.display="none")});const b=document.getElementById("ai-chat-trigger");b&&(b.style.display="none");const C=document.getElementById("guided-ask-fred");C&&(C.style.display="none"),ct.close();const k=document.getElementById("crosshair-btn");k&&(k.style.display="none");const R=document.getElementById("pending-btn");R&&(R.style.display="none");const I=document.getElementById("landscape-btn");I&&(I.style.display="none");const T=document.getElementById("admin-btn");T&&(T.style.display="none");const B=document.getElementById("staff-divider");B&&(B.style.display="none")}typeof((v=_)==null?void 0:v.refreshCatalogAccessForRole)=="function"&&_.refreshCatalogAccessForRole().catch(b=>{console.warn("Catalog access refresh failed:",(b==null?void 0:b.message)||b)})}function r(c){if(!c)return"?";const l=c.trim().split(" ");return l.length>=2?(l[0][0]+l[l.length-1][0]).toUpperCase():c.substring(0,2).toUpperCase()}function a(c){const l=document.createElement("div");return l.textContent=c||"",l.innerHTML}e&&t&&(e.addEventListener("click",c=>{c.stopPropagation();const l=t.style.display!=="none";t.style.display=l?"none":"block"}),document.addEventListener("click",c=>{g!=null&&g.contains(c.target)||(t.style.display="none")})),o&&o.addEventListener("click",()=>{te.showLogin(c=>{n(c)})}),L.onAuthChange=n,n(L.getCurrentUser())}function Yo(){const g=document.getElementById("user-guide-modal"),e=document.getElementById("user-guide-content");if(!g||!e)return;e.innerHTML=Jo(),g.style.display="flex";const t=document.getElementById("user-guide-close");t&&(t.onclick=()=>{g.style.display="none"}),g.onclick=s=>{s.target===g&&(g.style.display="none")};const o=s=>{s.key==="Escape"&&(g.style.display="none",document.removeEventListener("keydown",o))};document.addEventListener("keydown",o)}function Jo(){return`
  ...
  `}async function Qo(){try{const g=document.getElementById("changelog-modal"),e=document.getElementById("changelog-content"),s=(await(await fetch("./version.txt")).text()).trim().split(`
