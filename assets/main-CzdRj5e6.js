...
`).filter(r=>r.trim()!==""),i=s.length>0?s[s.length-1]:"Unknown",n=i.split(" - ")[0]||i;o.innerText=n,o.innerText.trim()||(o.innerText="v2.1.0")}}else throw new Error("Version file not found")}catch{const t=document.getElementById("version-number");if(t){const o=N.get("app.version")||"v2.1.0";t.innerText=o}else setTimeout(()=>{const o=document.getElementById("version-number");if(o&&!o.innerText.trim()){const s=N.get("app.version")||"v2.1.0";o.innerText=s}},1e3);console.info("Version loaded from config (GitHub Pages mode)")}}async showProductLookupScreen(){try{const t=await(await fetch("./screens/product-grid.html")).text();document.body.innerHTML=t,this.currentScreen="product-grid";const o=document.createElement("script");o.type="module",o.src="js/app.js",document.body.appendChild(o),setTimeout(()=>{document.querySelectorAll(".back-btn").forEach(s=>s.remove())},100),window.productGridManager&&window.productGridManager.init(),await this.loadVersion(),setTimeout(()=>this.loadVersion(),1e3)}catch(e){console.error("Failed to load product grid screen:",e)}}setupSplitInterface(){const e=document.getElementById("back-to-home");e&&(e.onclick=()=>location.reload());const t=document.getElementById("download-btn"),o=document.getElementById("clear-all-btn");t&&(t.onclick=()=>this.showDownloadFormModal()),o&&(o.onclick=()=>this.showClearConfirmModal()),this.setupSplitProductSearch(),this.setupReviewTable(),this.renderReviewTable(),this.loadInitialSearchResults()}setupSplitProductSearch(){const e=document.getElementById("product-search-input"),t=document.getElementById("search-results-list"),o=document.getElementById("search-loading"),s=document.getElementById("search-no-results");if(!e||!t)return;const i=[],n=x.debounce(r=>{this.performSplitProductSearch(r,t,i,o,s)},200);e.addEventListener("input",()=>{const r=e.value.trim();r?n(r):this.loadInitialSearchResults()}),t.addEventListener("click",r=>{const a=r.target.closest(".result-item");if(!a)return;const c=parseInt(a.getAttribute("data-idx"),10),d=i.length>0?i:this.currentSearchResults||[];!isNaN(c)&&d[c]&&this.showSplitProductDetails(d[c])})}performSplitProductSearch(e,t,o,s,i){if(!D.isLoaded){s.style.display="flex",i.style.display="none",t.innerHTML="";return}o.length=0,o.push(...D.searchProducts(e)),s.style.display="none",o.length===0?(i.style.display="flex",t.innerHTML=""):(i.style.display="none",t.innerHTML=o.map((n,r)=>`
    ...
    `,document.body.appendChild(o);const i=Ct();He("./assets/seima-logo.png",async(n,r,a)=>{const c=JSON.parse(localStorage.getItem("selection")||"[]"),d=JSON.parse(localStorage.getItem(G.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");let l=[];d.length>0?l=d.map(b=>({...b.product,Room:b.room,Notes:b.notes,Quantity:b.quantity,Timestamp:new Date(b.timestamp).toISOString()})):l=c;const u=document.getElementById("sort-by"),p=u?u.value:"room";switch(p){case"code":l.sort((b,S)=>{const C=b.OrderCode||b.Code||"",P=S.OrderCode||S.Code||"";return C.localeCompare(P)});break;case"product":l.sort((b,S)=>{const C=b.Description||b.ProductName||"",P=S.Description||S.ProductName||"";return C.localeCompare(P)});break;case"room":default:{let b=[];try{const S=localStorage.getItem("customRoomOrder");b=S?JSON.parse(S):[]}catch{b=[]}l.sort((S,C)=>{const P=S.Room||"Blank",k=C.Room||"Blank";if(P===k)return 0;if(P==="Blank")return 1;if(k==="Blank")return-1;const _=b.indexOf(P),I=b.indexOf(k);return _!==-1&&I!==-1?_-I:_!==-1?-1:I!==-1?1:P.localeCompare(k)});break}}if(!l.length){alert("No products selected."),t&&(t.style.display="none");return}if(st()>0)console.log(`📷 Using ${st()} pre-cached images (skipping duplicate preload)`);else{const b=document.getElementById("pdf-processing-notification");if(b){const S=document.createElement("span");S.id="preload-progress",S.style.cssText="display: block; font-size: 12px; margin-top: 8px; color: #1e40af;",S.textContent="Loading images: 0%",b.appendChild(S)}console.log("📷 Starting image preload for",l.length,"products"),pt(l).then(S=>{const C=document.getElementById("preload-progress");C&&(C.textContent=`✓ ${S} images ready`,C.style.color="#059669")}).catch(S=>{console.warn("Image preloading error:",S)})}const m={};p==="room"?l.forEach(b=>{const S=b.Room||"Blank";m[S]||(m[S]=[]),m[S].push(b)}):m.__all__=l,await i;const{jsPDF:y}=window.jspdf,g=new y({orientation:"landscape",unit:"pt",format:"a4",compress:!0,putOnlyUsedFonts:!0,precision:16,userUnit:1,floatPrecision:16}),v=g.internal.pageSize.getWidth(),w=g.internal.pageSize.getHeight();He("./assets/seima-logo.png",async(b,S,C)=>{const P=U.getCurrentUser(),k=E.getUserSettings(),_=P?{name:P.name,email:P.email,phone:P.phone,position:P.position}:k;let I=null;try{const{get:L}=await z(async()=>{const{get:H}=await import("./vendor-idb-DwnyWBFG.js");return{get:H}},[]);I=await L("customerLogo")}catch{}kt(g,{pageWidth:v,pageHeight:w,seimaLogoDataUrl:b,seimaLogoNaturalW:S,seimaLogoNaturalH:C,customerLogoDataUrl:I,userDetails:f,staffContact:_,footerHeight:it.footerHeight}),g.addPage(),He("./assets/seima-logo-white.png",(L,H,ae)=>{const ce=f.showRrp&&!f.excludePrice,Re=!f.excludePrice,et=!f.excludeQty,St=_t(v,{leftMargin:32,rightMargin:32,showRrp:ce,showPrice:Re,showQty:et,showTotal:Re&&et}),{colX:fe,colW:Ee,headers:Ne}=St,Ie=it.footerHeight;ct();const tt=($,T,X,te,q,W,F)=>{if(!T||typeof T!="string"||T.length<10||!T.startsWith("http://")&&!T.startsWith("https://")&&!T.startsWith("data:")){F&&F();return}if((B=>{if(!B||B.length<25||/\/images\/\d+$/.test(B)||B.endsWith("/0"))return!0;const A=/\.(jpg|jpeg|png|gif|webp|svg)(\?.*)?$/i.test(B),j=B.startsWith("data:");return!A&&!j})(T)){console.warn("Skipping malformed image URL:",(T==null?void 0:T.substring(0,50))+"..."),F&&F();return}if(Z.totalImages++,f.emailCompatible){Z.failedImages++,F&&F();return}const oe=Dt(T);if(oe&&oe.dataUrl)try{const B=oe.width/oe.height;let A=q,j=q/B;j>W&&(j=W,A=W*B),$.addImage(oe.dataUrl,oe.format,X,te,A,j,void 0,"FAST"),Z.optimizedImages++,F&&F();return}catch{console.warn("Failed to use cached image, falling back to direct load")}let de=!1;const ve=["https://wsrv.nl/?url=","https://images.weserv.nl/?url=","https://api.codetabs.com/v1/proxy?quest="];let se=0;function ie(){if(de)return;const B=new Image;B.crossOrigin="Anonymous";let A=null;B.onload=function(){if(!de){de=!0,A&&clearTimeout(A);try{const le=ft(0),$e=le.imageMaxWidth,be=q,ne=W;try{const V=document.createElement("canvas"),re=V.getContext("2d"),{width:ue,height:we}=no(B.width,B.height,$e);V.width=ue,V.height=we,re.imageSmoothingEnabled=!0,re.imageSmoothingQuality="high",re.drawImage(B,0,0,ue,we);let Oe,ze="JPEG";const xt=io(V,re),Et=so(B);xt||Et?(Oe=V.toDataURL("image/png",le.imageQuality),ze="PNG"):(Oe=V.toDataURL("image/jpeg",le.imageQuality),ze="JPEG");const Pt=`img_${ho(T)}`;$.addImage(Oe,ze,X,te,be,ne,Pt,"FAST"),Z.optimizedImages++,F&&F()}catch(V){console.warn(`Failed to optimize image: ${T}`,V),console.warn("Error details:",V.message,V.stack);try{$.addImage(B,"JPEG",X,te,be,ne),Z.optimizedImages++,F&&F()}catch(re){console.error(`Fallback also failed for: ${T}`,re),Z.failedImages++,F&&F()}}}catch(le){console.warn("Failed to add image to PDF:",le),Z.failedImages++,F&&F()}}},B.onerror=function(){de||(A&&clearTimeout(A),console.warn(`Failed to load image with proxy ${se}: ${T}`),console.warn(`Error details for: ${T} - Proxy: ${ve[se]}`),se++,se<ve.length?setTimeout(()=>{ie()},200):(de=!0,console.warn("All proxies failed, skipping image"),Z.failedImages++,F&&F()))},A=setTimeout(()=>{de||(console.warn(`⏰ Timeout with proxy ${se}: ${T}`),B.src="",B.onload=null,B.onerror=null,se++,se<ve.length?setTimeout(()=>{ie()},200):(de=!0,console.warn("All proxies timed out, skipping image"),Z.failedImages++,F&&F()))},3e3);let j=T;se<ve.length&&(j=ve[se]+encodeURIComponent(T)),B.src=j}ie()},K=[];Object.keys(m).forEach(($,T)=>{const X=m[$];if(!X||!Array.isArray(X)){console.warn("⚠️ Skipping invalid room items:",$,X);return}X.forEach((te,q)=>{if(!te){console.warn("⚠️ Skipping null item in room:",$,"at index:",q);return}K.push({item:te,room:$,rIdx:T,iIdx:q,isFirstInRoom:q===0,roomCount:X.length})})}),K.reduce(($,T)=>{if(!T||!T.item)return console.warn("⚠️ Skipping null row in data analysis:",T),$;const X=String(T.item.Description||""),te=String(T.item.LongDescription||""),q=String(T.item.Notes||""),W=String(T.item.OrderCode||"");return $+X.length+te.length+q.length+W.length},0);let Pe=0,Le=0;const Te=4,De=8,Me=Math.floor((w-80)/Te);let ot=Ie+8;function Ue(){if(!K||!Array.isArray(K)){console.error("❌ Critical error: rowsToDraw is not a valid array:",K),at(new Error("Invalid product data structure"),"generating PDF","unknown.pdf");return}if(Pe>=K.length){const q=g.internal.getNumberOfPages()-1;for(let A=2;A<=q+1;A++){g.setPage(A);const le=(A-2)*Te,$e=Math.min(le+Te,K.length);let be=!1;for(let ne=le;ne<$e;ne++)if(K[ne]&&K[ne].item&&Rt(K[ne].item)){be=!0;break}It(g,{pageWidth:v,colX:fe,colW:Ee,leftMargin:32,footerHeight:Ie,logoDataUrl:L,logoNaturalW:H,logoNaturalH:ae,headers:Ne,userDetails:f,skipWelsHeader:!be}),Lt(g,{pageWidth:v,pageHeight:w,leftMargin:32,footerHeight:Ie,pageNumber:A-1,totalPages:q})}const W=new Date,F=String(W.getDate()).padStart(2,"0"),ye=String(W.getMonth()+1).padStart(2,"0"),oe=String(W.getFullYear()).slice(-2),de=String(W.getHours()).padStart(2,"0"),ve=String(W.getMinutes()).padStart(2,"0"),ie=`${f.project.replace(/[^a-zA-Z0-9\s]/g,"")}-${F}${ye}${oe}.${de}${ve}.pdf`,B=document.getElementById("pdf-processing-notification");B&&B.remove(),go(f.emailCompatible);try{const A=g.output("blob"),j=g.output("string"),le=j?j.match(/\/Type\s*\/XObject/g):null,$e=j?j.match(/Tj\s/g):null,be=j?j.match(/\/A\s*<</g):null;f.pdfSize=A.size;const ne=ao(A,ie);if(f.sendEmail&&A.size>15*1024*1024){console.warn(`❌ PDF too large for email (${(A.size/1024/1024).toFixed(1)}MB), offering email-compatible version`),fo(f,ie);return}const V=ro(A,ne.settings);if(f.sendEmail&&f.email)if(f.exportCsv){const re=ie.replace(/\.pdf$/,".csv");rt(f,re).then(ue=>{window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:f,pdfBlob:V,csvBlob:ue}}))}).catch(ue=>{console.error("Async CSV generation for email failed:",ue),window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:f,pdfBlob:V,csvBlob:null}}))})}else window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:f,pdfBlob:V,csvBlob:null}}));else(async()=>{const re=await vo(V);if(await Ye(re,ie,"PDF"),f.exportCsv){const ue=ie.replace(/\.pdf$/,".csv");try{const we=await rt(f,ue);we&&await Ye(we,ue,"CSV")}catch(we){console.error("CSV generation failed:",we)}}})()}catch(A){console.error("PDF generation failed:",A),at(A,"generating PDF",ie);const j=document.getElementById("pdf-processing-notification");j&&j.remove()}t&&(t.style.display="none");return}Le>=Te&&(g.addPage(),ot=Ie+8,Le=0);const $=K[Pe];if(!$||!$.item){console.warn(`⚠️  Skipping invalid row at index ${Pe}:`,$),Pe++,Ue();return}const T=ot+Me*Le;$.isFirstInRoom&&p==="room"&&$.room!=="__all__"&&Tt(g,$.room,$.roomCount,32,T);const X=fe[0],te=X+90+12;tt(g,$.item.Image_URL||"",X,T+De+16,90,Me-De*2,()=>{tt(g,$.item.Diagram_URL||"",te,T+De+16,90,Me-De*2,()=>{const q=T+28,W=fe[1]+Ee[1]/2;g.setFontSize(10),g.setTextColor("#222"),g.text(String($.item.OrderCode||""),W,q+10,{align:"center"}),$t(g,$.item,W,q+35);const F=Ee[2]-10;Bt(g,$.item,fe[2],q+10,F,f.excludeLongDescription);const ye=Ne.indexOf("WELS")+1;if(ye>0&&fe[ye]){const oe=fe[ye]+Ee[ye]/2;At(g,$.item,oe,q+10)}Ft(g,$.item,fe,Ee,Ne,q+10,{excludePrice:f.excludePrice,includeGst:f.includeGst}),Pe++,Le++,Ue()})})}Ue()})})})}function He(f,e){const t=new window.Image;t.crossOrigin="Anonymous",t.onload=function(){const o=document.createElement("canvas"),s=o.getContext("2d"),i=400,n=150;let r=t.width,a=t.height;if(r>i||a>n){const d=i/r,l=n/a,u=Math.min(d,l);r=Math.round(r*u),a=Math.round(a*u)}o.width=r,o.height=a,s.imageSmoothingEnabled=!0,s.imageSmoothingQuality="high",s.drawImage(t,0,0,r,a);const c=o.toDataURL("image/png",.9);e(c,r,a)},t.src=f}function Kt(){if(!document.getElementById("pdf-spinner")){const f=document.createElement("div");if(f.id="pdf-spinner",f.style.display="none",f.style.position="fixed",f.style.top="0",f.style.left="0",f.style.width="100vw",f.style.height="100vh",f.style.zIndex="9999",f.style.background="rgba(255,255,255,0.7)",f.style.alignItems="center",f.style.justifyContent="center",f.innerHTML='<div style="border:6px solid #e0e0e0;border-top:6px solid #2563eb;border-radius:50%;width:54px;height:54px;animation:spin 1s linear infinite;"></div>',document.body.appendChild(f),!document.getElementById("pdf-spinner-style")){const e=document.createElement("style");e.id="pdf-spinner-style",e.innerHTML="@keyframes spin { 0% { transform: rotate(0deg);} 100% { transform: rotate(360deg);} }",document.head.appendChild(e)}}}async function rt(f,e){return new Promise(async t=>{if(!window.Papa)try{await x.loadScript("https://cdn.jsdelivr.net/npm/papaparse@5.4.1/papaparse.min.js")}catch(n){console.error("Failed to load PapaParse:",n),t(null);return}const o=JSON.parse(localStorage.getItem("selection")||"[]"),s=JSON.parse(localStorage.getItem(G.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");let i=[];if(s.length>0?i=s.map(n=>({...n.product,Room:n.room,Notes:n.notes,Quantity:n.quantity,Timestamp:new Date(n.timestamp).toISOString()})):i=o,!i.length){t(null);return}setTimeout(()=>{const n=i.map(r=>{let a,c,d,l;const u=f.excludePrice;let p=0;if(r.UserEditedPrice!==void 0&&r.UserEditedPrice!==null&&r.UserEditedPrice!=="")p=parseFloat(r.UserEditedPrice.toString().replace(/,/g,""));else{const g=r.RRP_EX||r["RRP EX GST"]||r.RRP_EX||r.RRP_EXGST||"";p=parseFloat((g||"0").toString().replace(/,/g,""))}a=p,d="Price ea ex GST",l="Price Total ex GST",c=!isNaN(a)&&a>=0?(a*(r.Quantity||1)).toFixed(2):"";const h=r["WELS STAR"]||r.WELS_STAR||r.WELS_STAR||r.WelsStar||"",m=h&&h.toString().trim()?h.toString().replace(/[^\d.]/g,"").trim():"",y={Code:me(r.OrderCode||""),Description:me(r.Description||""),"WELS Star":me(m),Quantity:r.Quantity||1,Notes:me(r.Notes||""),Room:me(r.Room||""),"Image URL":me(r.Image_URL||""),"Diagram URL":me(r.Diagram_URL||""),"Datasheet URL":me(r.Datasheet_URL||""),"Website URL":me(r.Website_URL||"")};return y[d]=u?"0.00":a>=0?a.toFixed(2):"",y[l]=u?"0.00":c,y});setTimeout(()=>{const r=window.Papa.unparse(n,{quotes:!0,quoteChar:'"',delimiter:",",header:!0,newline:`\r
`,skipEmptyLines:!1,escapeChar:'"',transform:{value(a,c){return typeof a=="string"?a.replace(/\0/g,"").replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g,""):a}}});f.sendEmail?setTimeout(()=>{try{const a=btoa(unescape(encodeURIComponent(r)));t({name:e,data:a,contentType:"text/csv",originalSize:r.length,base64Size:a.length})}catch(a){console.error("CSV base64 encoding failed:",a),t(new Blob([r],{type:"text/csv"}))}},0):t(new Blob([r],{type:"text/csv"}))},0)},0)})}function me(f){return typeof f!="string"&&(f=String(f)),f=f.replace(/\0/g,"").replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g,"").replace(/\r?\n|\r/g," ").trim(),f}async function Zt(f,e,t="file"){try{if("showSaveFilePicker"in window){const s=await(await window.showSaveFilePicker({suggestedName:e,types:[{description:`${t} files`,accept:{[f.type]:[`.${e.split(".").pop()}`]}}]})).createWritable();return await s.write(f),await s.close(),!0}}catch(o){console.warn("File System Access API failed:",o)}return!1}function eo(f,e,t="file"){try{if(f.size>2*1024*1024)return console.warn("File too large for data URI method"),!1;const o=new FileReader;return o.onload=function(s){try{const i=document.createElement("a");i.href=s.target.result,i.download=e,i.style.display="none",document.body.appendChild(i),i.click(),document.body.removeChild(i)}catch(i){console.error("Data URI download failed:",i)}},o.readAsDataURL(f),!0}catch(o){return console.warn("Data URI method failed:",o),!1}}function to(f,e,t="file"){const o=URL.createObjectURL(f),s=document.createElement("div");s.style.cssText=`
  ...
  `,s.appendChild(i),document.body.appendChild(s),document.getElementById("manual-download-close").onclick=()=>{URL.revokeObjectURL(o),document.body.removeChild(s)},document.getElementById("manual-download-retry").onclick=()=>{URL.revokeObjectURL(o),document.body.removeChild(s),setTimeout(()=>{gt(f,e,t)},1e3)},document.getElementById("copy-url-btn").onclick=()=>{const n=document.getElementById("manual-download-url");n.select(),n.setSelectionRange(0,99999);try{navigator.clipboard.writeText(o).then(()=>{const r=document.getElementById("copy-url-btn");r.textContent="Copied!",r.style.background="#059669",setTimeout(()=>{r.textContent="Copy",r.style.background="#059669"},2e3)}).catch(()=>{document.execCommand("copy");const r=document.getElementById("copy-url-btn");r.textContent="Copied!",setTimeout(()=>r.textContent="Copy",2e3)})}catch{alert("Copy failed. Please select the URL manually and copy it.")}},s.onclick=n=>{n.target===s&&(URL.revokeObjectURL(o),document.body.removeChild(s))},setTimeout(()=>{s.parentElement&&(URL.revokeObjectURL(o),document.body.removeChild(s))},5*60*1e3)}async function gt(f,e,t="file"){try{if(await oo(f,e))return}catch(o){console.warn("Standard download failed:",o)}await Zt(f,e,t)||eo(f,e,t)||to(f,e,t)}function oo(f,e){return new Promise(t=>{try{const o=URL.createObjectURL(f),s=document.createElement("a");s.href=o,s.download=e,s.style.display="none",document.body.appendChild(s);const i=setTimeout(()=>{n(),t(!1)},3e3),n=()=>{clearTimeout(i),s.parentElement&&document.body.removeChild(s),setTimeout(()=>URL.revokeObjectURL(o),1e3)};s.onclick=()=>{n(),t(!0)},s.click(),setTimeout(()=>{n(),t(!0)},500)}catch(o){console.error("Standard download error:",o),t(!1)}})}function so(f){const e=document.createElement("canvas"),t=e.getContext("2d");e.width=Math.min(100,f.width),e.height=Math.min(100,f.height),t.drawImage(f,0,0,e.width,e.height);const s=t.getImageData(0,0,e.width,e.height).data,i=new Set;for(let n=0;n<s.length;n+=4){const r=`${s[n]},${s[n+1]},${s[n+2]}`;i.add(r)}return i.size<1e3}function io(f,e){const o=e.getImageData(0,0,f.width,f.height).data;for(let s=3;s<o.length;s+=4)if(o[s]<255)return!0;return!1}function no(f,e,t){if(f<=t)return{width:f,height:e};const o=e/f;return{width:t,height:Math.round(t*o)}}function ft(f){return f>25*1024*1024?{compressionLevel:"aggressive",imageQuality:.6,imageMaxWidth:300,removeImages:!1,usePNG:!0,message:"Aggressive compression - maintaining technical diagram clarity"}:f>20*1024*1024?{compressionLevel:"high",imageQuality:.65,imageMaxWidth:350,removeImages:!1,usePNG:!0,message:"High compression - preserving technical diagram details"}:f>15*1024*1024?{compressionLevel:"medium",imageQuality:.7,imageMaxWidth:400,removeImages:!1,usePNG:!0,message:"Medium compression - optimal for technical documentation"}:f>10*1024*1024?{compressionLevel:"light",imageQuality:.75,imageMaxWidth:450,removeImages:!1,usePNG:!0,message:"Light compression - excellent technical diagram quality"}:{compressionLevel:"minimal",imageQuality:.8,imageMaxWidth:500,removeImages:!1,usePNG:!0,message:"Minimal compression - maximum technical diagram quality"}}function ro(f,e){return f}function ao(f,e){const t=(f.size/1048576).toFixed(2),o=ft(f.size);if(f.size>15*1024*1024){console.warn(`Large file detected (${t} MB) - exceeds typical email limit, may need email-compatible version`);const s=document.createElement("div");s.style.cssText=`
    ...
    `,s.innerHTML=`
      ...
      ">OK</button>
    `,document.body.appendChild(s),setTimeout(()=>{s.parentElement&&s.remove()},8e3)}else f.size>3*1024*1024;return{size:f.size,sizeInMB:parseFloat(t),settings:o}}function at(f,e="",t=""){console.error("Detailed error:",f);const o={type:co(f),message:f.message||"Unknown error",context:e,filename:t,timestamp:new Date().toISOString(),userAgent:navigator.userAgent},s=document.createElement("div");s.style.cssText=`
    position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
  ...
  `,s.appendChild(i),document.body.appendChild(s),document.getElementById("error-close").onclick=()=>{document.body.removeChild(s)},document.getElementById("error-retry").onclick=()=>{document.body.removeChild(s),console.log("Retry requested for:",e)},document.getElementById("error-report").onclick=()=>{po(o),alert("Error details copied to clipboard. Please send this to support.")},s.onclick=n=>{n.target===s&&document.body.removeChild(s)},o}function co(f){var o,s;const e=((o=f.message)==null?void 0:o.toLowerCase())||"",t=((s=f.stack)==null?void 0:s.toLowerCase())||"";return e.includes("network")||e.includes("fetch")?"network":e.includes("permission")||e.includes("denied")?"permission":e.includes("memory")||e.includes("quota")?"memory":e.includes("blob")||e.includes("url")?"download":e.includes("canvas")||e.includes("image")?"rendering":t.includes("jspdf")||e.includes("pdf")?"pdf":"unknown"}function lo(f){return{network:"Network Connection Error",permission:"Permission Required",memory:"Insufficient Memory",download:"Download Failed",rendering:"Display Error",pdf:"PDF Generation Error",unknown:"Unexpected Error"}[f]||"Error Occurred"}function uo(f,e,t){return{network:"Unable to load required resources. Please check your internet connection and try again.",permission:`Browser permission required to save ${t}. Please allow downloads and try again.`,memory:"Not enough memory to process this large file. Try closing other browser tabs or use fewer products.",download:`Failed to download ${t}. This may be due to browser security settings or storage limitations.`,rendering:"Unable to display product images properly. Some images may be missing from the final output.",pdf:`PDF generation failed while ${e}. The file may be too large or contain problematic data.`,unknown:`An unexpected error occurred while ${e}. Please try again or contact support.`}[f]||"An unknown error has occurred."}function mo(f){const e={network:`
      ...
      </div>`};return e[f]||e.unknown}function yt(){const f=navigator.userAgent;return f.includes("Chrome")?"Chrome":f.includes("Firefox")?"Firefox":f.includes("Safari")?"Safari":f.includes("Edge")?"Edge":f.includes("SamsungBrowser")?"Samsung Internet":"Unknown"}function po(f){const e=`
...
========================
  `.trim();try{navigator.clipboard.writeText(e)}catch(t){console.error("Failed to copy error report:",t)}}let Z={totalImages:0,optimizedImages:0,failedImages:0,totalSavings:0};function ho(f){let e=0;if(f.length===0)return e.toString();for(let t=0;t<f.length;t++){const o=f.charCodeAt(t);e=(e<<5)-e+o,e=e&e}return Math.abs(e).toString(36)}function ct(){Z={totalImages:0,optimizedImages:0,failedImages:0,totalSavings:0}}function go(f=!1){Z.totalImages>0}function fo(f,e){const t=document.createElement("div");t.style.cssText=`
    position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
    background: rgba(0,0,0,0.8); z-index: 10001; display: flex; 
    align-items: center; justify-content: center; padding: 20px;
  ...
  `,document.body.appendChild(t),setTimeout(()=>{t.parentElement&&t.remove()},8e3)}const qe="fredChatHistory",Fe="fredChatMessages",Ce="fredFeedback",xe="fredQuestionLog",Ge=16,O={PROXY_URL:"https://seima-ai-proxy.seima.workers.dev",APP_SECRET:"P3hqkuYpLPoovIwTXtPoffKW9liUd0QQoWlOhMG4JJU3rpHRKtBs7SzIDKzRVYya",MODEL:"gpt-4o",MAX_TOKENS:2e3,TEMPERATURE:.2,MAX_CATALOG_RESULTS:60},wo=`You are a product specification parser for building/construction projects. Extract ALL product references from the provided text.
...
`);return console.log(`PDF text extraction: ${o.numPages} pages, ${s.length} with text, ${i.length} chars total`),i}catch(t){return console.warn("PDF text extraction failed, will use vision API:",t),null}}_fileToBase64(e){return new Promise((t,o)=>{const s=new FileReader;s.onload=()=>t(s.result.split(",")[1]),s.onerror=()=>o(new Error("Failed to read file")),s.readAsDataURL(e)})}async _compressPdf(e,t){if(!window.pdfjsLib)throw new Error("PDF.js must be loaded before compression");if(!window.jspdf){const u=document.createElement("script");u.src="https://cdn.jsdelivr.net/npm/jspdf@2.5.2/dist/jspdf.umd.min.js",document.head.appendChild(u),await new Promise((p,h)=>{u.onload=p,u.onerror=()=>h(new Error("Failed to load jsPDF")),setTimeout(()=>h(new Error("jsPDF load timeout")),1e4)})}const o=await e.arrayBuffer(),s=await window.pdfjsLib.getDocument({data:o}).promise,{jsPDF:i}=window.jspdf,n=1.5,r=.65;let a=null;for(let u=1;u<=s.numPages;u++){t&&t(u,s.numPages);const p=await s.getPage(u),h=p.getViewport({scale:n}),m=document.createElement("canvas");m.width=h.width,m.height=h.height;const y=m.getContext("2d");await p.render({canvasContext:y,viewport:h}).promise;const g=m.toDataURL("image/jpeg",r),v=h.width>h.height?"landscape":"portrait";u===1?a=new i({orientation:v,unit:"px",format:[h.width,h.height]}):a.addPage([h.width,h.height],v),a.addImage(g,"JPEG",0,0,h.width,h.height),m.width=0,m.height=0}const c=a.output("blob"),d=new File([c],e.name,{type:"application/pdf"}),l=Math.round((1-d.size/e.size)*100);return console.log(`PDF compressed: ${(e.size/(1024*1024)).toFixed(1)}MB → ${(d.size/(1024*1024)).toFixed(1)}MB (${l}% reduction)`),d.size<e.size*.9?d:(console.log("Compression did not significantly reduce size, using original"),e)}_showSpecResults(e){const t=e.filter(u=>["verified","seima-own","alternative","catalog-suggestion"].includes(u.status)),o=e.filter(u=>u.status==="unmatched"||u.status==="ai-suggested"),s=[...new Set(e.map(u=>u.section).filter(Boolean))],i=document.getElementById("spec-results-content");if(!i)return;let n="";if(this._projectMeta){const u=this._projectMeta;[u.name,u.architect,u.builder,u.location].filter(Boolean).length>0&&(n=`<div class="spec-project-meta" style="margin-bottom:12px;padding:8px 12px;background:#f0f9ff;border-radius:6px;border:1px solid #bae6fd;">
    ...
    `;const a=document.getElementById("spec-add-all-btn");a&&(a.style.display="",a.textContent=`Import Selected to Grid (${e.length})`,a.onclick=()=>this._importSelectedToGrid());const c=document.getElementById("spec-export-pdf-btn");c&&(c.style.display="",c.onclick=()=>this._exportSubstitutionPDF());const d=document.getElementById("spec-done-btn");d&&(d.onclick=()=>{this.closeModal(),window.location.reload()});const l=i.querySelector("#spec-select-all");l&&l.addEventListener("change",()=>{i.querySelectorAll(".spec-row-check").forEach(u=>{u.checked=l.checked}),this._updateImportCount()}),i.addEventListener("change",u=>{u.target.classList.contains("spec-row-check")&&this._updateImportCount()}),this.showSpecResultsStep()}_renderSpecRows(e){let t="",o=null;for(let s=0;s<e.length;s++){const i=e[s];i.section&&i.section!==o&&(o=i.section,t+=`<tr class="spec-section-header"><td colspan="4">${this._escapeHtml(i.section)}</td></tr>`),t+=this._renderSpecRow(i,s)}return t}_renderSpecRow(e,t){var m,y,g;const o=e.specCode?`<strong>${this._escapeHtml(e.specCode)}</strong> `:"",s=e.name||e.category||"",i=e.brand||"",n=e.code||"",r=e.style||"",a=e.finish||"",c={"seima-own":'<span class="spec-badge spec-badge-seima">Seima Product</span>',verified:'<span class="spec-badge spec-badge-verified">Verified Match</span>',alternative:'<span class="spec-badge spec-badge-alt">Alternative</span>',"catalog-suggestion":'<span class="spec-badge spec-badge-suggest">Suggestion</span>',"ai-suggested":'<span class="spec-badge spec-badge-ai">AI Suggested</span>',unmatched:'<span class="spec-badge spec-badge-none">No Match</span>'};let d="";if(e.status==="seima-own"&&e.seimaProduct){const v=e.seimaProduct;d=`<strong>${this._escapeHtml(v.OrderCode||v["Order Code"]||"")}</strong>
        <br><small>${this._escapeHtml(v.Description||v.ProductName||"")}</small>`}else if(["verified","alternative"].includes(e.status)&&((m=e.seimaMatches)==null?void 0:m.length)>0){const v=e.seimaMatches[0].SeimaSKU||"",w=((y=e.seimaProduct)==null?void 0:y.Description)||((g=e.seimaProduct)==null?void 0:g.ProductName)||"";d=`<strong>${this._escapeHtml(v)}</strong>`,w&&(d+=`<br><small>${this._escapeHtml(w)}</small>`)}else if(e.status==="catalog-suggestion"&&e.seimaProduct){const v=e.seimaProduct;d=`<em>${this._escapeHtml(v.OrderCode||v["Order Code"]||"")}</em>
        <br><small style="color:#737373">${this._escapeHtml(v.Description||v.ProductName||"")}</small>`}else d='<span style="color:#aaa">—</span>';const l=[i,r,n,a].filter(Boolean).map(v=>this._escapeHtml(v)),u=`spec-row spec-row-${e.status}`,p=e.orEquivalent?'<span style="display:inline-block;margin-top:2px;padding:1px 5px;font-size:10px;background:#fef3c7;color:#92400e;border-radius:3px;">or equivalent</span>':"",h=e.tier?`<span style="display:inline-block;margin-top:2px;padding:1px 5px;font-size:10px;background:#e0e7ff;color:#3730a3;border-radius:3px;">${this._escapeHtml(e.tier)}</span>`:"";return`
    ...
    `}_updateImportCount(){const e=document.querySelectorAll(".spec-row-check:checked").length,t=document.getElementById("spec-add-all-btn");t&&(t.textContent=`Import Selected to Grid (${e})`,t.disabled=e===0)}_importSelectedToGrid(){var c,d;if(!this._specResults)return;const e=document.querySelectorAll(".spec-row-check:checked");this.importMode==="override"&&(E.clearAllSelections(),console.log("Cleared all existing data for override mode (spec import)"));const t=new Set;e.forEach(l=>{const u=parseInt(l.dataset.index),p=this._specResults[u];p!=null&&p.section&&t.add(p.section)}),t.forEach(l=>E.addCustomRoom(l));const o=[];e.forEach(l=>{var g,v;const u=parseInt(l.dataset.index),p=this._specResults[u];if(!p)return;const h=this._buildSpecNote(p),m=p.section||"Imported";if((p.status==="seima-own"||p.status==="verified")&&p.seimaProduct){const w=p.seimaProduct.OrderCode||p.seimaProduct["Order Code"]||((v=(g=p.seimaMatches)==null?void 0:g[0])==null?void 0:v.SeimaSKU),b=D.findProductByCode(w);if(b){o.push({product:b,notes:h,room:m,quantity:p.quantity||1});return}}let y=h;if(p.seimaProduct&&p.status!=="seima-own"&&p.status!=="verified"){const w=p.seimaProduct.OrderCode||"",b=p.seimaProduct.ProductName||p.seimaProduct.Description||"";y+=` | SEIMA SUGGESTION: ${w} ${b}`}o.push({product:{OrderCode:"",Description:h,_placeholder:!0},notes:y,room:m,quantity:p.quantity||1})});const s=E.addProductsBatch(o),i=s?o.length:0;s||alert(`Could not save all products — browser storage is full.
...
This can be restored later.`))try{const t=await he.deleteSelections([e.id]);t.success?(this.showToast("Selection deleted"),this.fetchAndRenderSelections()):this.showError(t.error||"Failed to delete")}catch(t){this.showError(t.message)}}async restoreSelection(e){try{const t=await he.restoreSelections([e.id]);t.success?(this.showToast("Selection restored"),this.fetchAndRenderSelections()):this.showError(t.error||"Failed to restore")}catch(t){this.showError(t.message)}}showToast(e){const t=document.createElement("div");t.style.cssText=`
    ...
    `;const a=n.querySelector(".toast-close");if(a.onclick=()=>this.dismiss(i),s&&s.callback){const c=n.querySelector(".toast-action");c.onclick=()=>{s.callback(),this.dismiss(i)}}return this.container.appendChild(n),this.toasts.set(i,n),requestAnimationFrame(()=>{n.classList.add("toast-enter")}),o>0&&setTimeout(()=>this.dismiss(i),o),i}dismiss(e){const t=this.toasts.get(e);t&&(t.classList.add("toast-exit"),t.addEventListener("animationend",()=>{t.remove(),this.toasts.delete(e)}))}dismissAll(){this.toasts.forEach((e,t)=>this.dismiss(t))}success(e,t={}){return this.show({message:e,type:"success",...t})}error(e,t={}){return this.show({message:e,type:"error",duration:6e3,...t})}warning(e,t={}){return this.show({message:e,type:"warning",...t})}info(e,t={}){return this.show({message:e,type:"info",...t})}withUndo(e,t,o=5e3){return this.show({message:e,type:"info",duration:o,action:{label:"Undo",callback:t}})}}const pe=new _o;window.toast=pe;const Ro=20;let We=0;class Io{constructor(){this._overlay=null,this._seimaProducts=null,this._seimaByCode={},this._productSearch=new Nt,this._currentCompetitor=null,this._currentCompetitorProduct=null,this._disputeOverlay=null}async open(e,t){if(!this._overlay&&(this._onProductSelected=t||null,await this._ensureSeimaData(),this._render(),e)){const o=this._overlay.querySelector("#uv-comp-search");o&&(o.value=e,this._onCompetitorSearch(e))}}close(){this._overlay&&(this._overlay.remove(),this._overlay=null),this._onProductSelected=null,this._closeDispute()}async _ensureSeimaData(){if(!this._seimaProducts)try{const{dataLayer:e}=await z(async()=>{const{dataLayer:o}=await import("./data-layer-YmoTaWFd.js").then(s=>s.a);return{dataLayer:o}},__vite__mapDeps([0,1,2,3,4,5]));e.isLoaded||await e.init();const t=e.products||[];this._seimaProducts=t,this._seimaByCode={};for(const o of t){const s=String(o.OrderCode||o["Order Code"]||o.Code||"").trim();s&&(this._seimaByCode[s]=o)}this._productSearch.buildIndex(t)}catch(e){console.error("UserVerify: failed to load Seima catalog",e),this._seimaProducts=[]}}_render(){const e=U.getCurrentUser(),t=document.createElement("div");t.className="uv-overlay",t.innerHTML=`
      <div class="uv-modal">
        <div class="uv-header">
          <div>
    ...
    `,a.addEventListener("click",u=>{u.target===a&&this._closeDispute()}),a.querySelector(".uv-close").addEventListener("click",()=>this._closeDispute()),a.querySelector("#uv-dispute-cancel").addEventListener("click",()=>this._closeDispute());let c=null;const d=a.querySelector("#uv-dispute-seima-search");let l;d.addEventListener("input",()=>{clearTimeout(l),l=setTimeout(()=>{const u=d.value,p=a.querySelector("#uv-dispute-seima-results");if(!u||u.length<2){p.style.display="none";return}const h=this._productSearch.search(u,8);if(h.length===0){p.innerHTML='<div class="uv-empty">No products found</div>',p.style.display="block";return}p.innerHTML=h.map(m=>{const y=m.OrderCode||m["Order Code"]||m.Code||"",g=m.Description||m.ProductName||m["Product Name"]||"",v=m.Image_URL||m.imageUrl||"",w=m.RRP_EX||m["RRP EX GST"]||"",b=w?`$${parseFloat(w).toLocaleString("en-AU",{minimumFractionDigits:2})}`:"";return`
            <div class="uv-search-item" data-alt-sku="${this._esc(y)}">
              <img class="uv-match-thumb" src="${this._esc(v||"assets/no-image.png")}" alt=""
    ...
    `,document.head.appendChild(e)}getSteps(){return[{icon:"logo",title:"Welcome to Product Presenter",text:"Create beautiful PDF presentations of Seima products for your clients in minutes.",features:[]},{icon:"📦",title:"Add Your Products",text:"There are three ways to get started:",features:[{icon:"📁",title:"Import a File",desc:"Upload CSV or Excel files with product codes"},{icon:"📂",title:"Load a Selection",desc:"Continue from a previous saved selection"},{icon:"🔍",title:"Search Products",desc:"Search and add products one by one"}]},{icon:"🏠",title:"Organise by Room",text:"Group products by room or area. Drag to reorder, and easily manage your selection.",features:[{icon:"🎨",title:"Colour-coded",desc:"Rooms are visually distinct for quick reference"},{icon:"📊",title:"Sort Options",desc:"Sort by Room/Group, Product Code, or Product Name"},{icon:"💾",title:"Auto-saves",desc:"Your work is automatically preserved"}]},{icon:"📄",title:"Create Your PDF",text:'Click "Create PDF" to customise and generate a professional presentation with your branding.',features:[{icon:"💰",title:"Pricing Options",desc:"Show RRP, add GST, or hide pricing entirely"},{icon:"📝",title:"Content Control",desc:"Include descriptions and custom notes"},{icon:"📑",title:"Cover Pages",desc:"Add branded cover and appendix pages"}]}]}renderStep(){const e=this.getSteps(),t=e[this.currentStep],o=document.getElementById("onboarding-content"),s=document.getElementById("onboarding-dots"),i=document.getElementById("onboarding-next");if(!o||!s)return;let n="";t.features.length>0&&(n=t.features.map(a=>`
      ...
      ${n}
    `,s.innerHTML=e.map((a,c)=>`<div class="onboarding-dot ${c===this.currentStep?"active":""}"></div>`).join(""),i&&(i.textContent=this.currentStep===e.length-1?"Get Started":"Next")}nextStep(){const e=this.getSteps();this.currentStep<e.length-1?(this.currentStep++,this.renderStep()):this.complete()}complete(){localStorage.setItem(Xe,JSON.stringify({version:ut,completedAt:new Date().toISOString()})),this.overlay&&(this.overlay.style.animation="fadeIn 0.2s ease reverse",setTimeout(()=>{this.overlay.remove(),this.overlay=null},200))}reset(){localStorage.removeItem(Xe)}}const bt=new Do;class $o{constructor(){this.panel=null,this.messagesContainer=null,this.input=null,this.sendBtn=null,this.isOpen=!1,this._lastUserMessage=null,this._conversationId=null,this._userEmail=null,this._historyOpen=!1}init(){this._createPanel(),this._bindEvents(),this._restoreMessages(),this._initUserEmail()}_createPanel(){const e=document.createElement("div");e.id="ai-chat-panel",e.className="ai-chat-panel",e.innerHTML=`
...
`).filter(l=>l.trim());if(s.length<2)return o;const i=l=>l.split("|").slice(1,-1).map(u=>u.trim()),n=l=>/^\|[\s:|-]+\|$/.test(l.trim());let r=i(s[0]),a=1;s.length>1&&n(s[1])&&(a=2);let c="<thead><tr>"+r.map(l=>`<th>${l}</th>`).join("")+"</tr></thead>",d="<tbody>"+s.slice(a).filter(l=>!n(l)).map(l=>"<tr>"+i(l).map(u=>`<td>${u}</td>`).join("")+"</tr>").join("")+"</tbody>";return`<table class="ai-comparison-table">${c}${d}</table>`}),t=t.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>"),t=t.replace(/`([^`]+)`/g,"<code>$1</code>"),t=t.replace(/^### (.+)$/gm,"<h4>$1</h4>"),t=t.replace(/^## (.+)$/gm,"<h3>$1</h3>"),t=t.replace(/^- (.+)$/gm,"<li>$1</li>"),t=t.replace(/(<li>.*<\/li>\n?)+/g,o=>`<ul>${o}</ul>`),t=t.replace(/^\d+\. (.+)$/gm,"<li>$1</li>"),t=t.replace(/\n\n/g,"</p><p>"),t=`<p>${t}</p>`,t=t.replace(/<p><\/p>/g,""),t=t.replace(/<p>(<h[34]>)/g,"$1"),t=t.replace(/(<\/h[34]>)<\/p>/g,"$1"),t=t.replace(/<p>(<ul>)/g,"$1"),t=t.replace(/(<\/ul>)<\/p>/g,"$1"),t=t.replace(/<p>(<table)/g,"$1"),t=t.replace(/(<\/table>)<\/p>/g,"$1"),t=t.replace(/\b(\d{6})\b/g,'<button class="ai-add-product-btn" data-code="$1" title="Add $1 to selection">$1 <span class="ai-add-icon">+</span></button>'),t}_getBasePath(){var e;return(((e=document.querySelector("base"))==null?void 0:e.href)||window.location.origin+"/").replace(/\/$/,"")}_getProductImage(e){return e.Image_URL||e.imageUrl||e.Image||`${this._getBasePath()}/assets/no-image.png`}_getProductName(e){return e.Description||e.ProductName||e["Product Name"]||""}_getProductMeta(e){const t=e.Finish||e.Colour||"",o=e.DimX||e["X Dimension (mm)"]||"",s=e.DimY||e["Y Dimension (mm)"]||"",i=e.DimZ||e["Z Dimension (mm)"]||"",n=o&&o!=="0"?`${o} × ${s||0} × ${i||0}mm`:"";return[t,n].filter(Boolean).join("  ·  ")}_getProductPrice(e){const t=e["RRP INC GST"]||e.RRP_INCGST||e["RRP EX GST"]||e.RRP_EXGST||"";return t?`$${parseFloat(t).toLocaleString("en-AU",{minimumFractionDigits:2})}`:""}_enrichTableProducts(e){const t=this._getBasePath(),o=ee.lastCompetitorProducts;e.querySelectorAll(".ai-comparison-table").forEach(s=>{const i=s.querySelector("thead"),n=s.querySelector("tbody");if(!i||!n)return;const a=i.querySelectorAll("th").length;if(a<2)return;const c=new Array(a).fill(null);if(n.querySelectorAll("tr").forEach(l=>{l.querySelectorAll("td").forEach((p,h)=>{if(c[h])return;const m=p.querySelector("strong"),y=(m?m.textContent:p.textContent).trim();if(y){if(/^\d{6}$/.test(y)){const g=D.findProductByCode(y);g&&(c[h]={src:this._getProductImage(g),click:()=>this._showProductModal(y)})}else if(o)for(const[g,v]of o){const w=String(g);if(w===y||y.includes(w)||w.includes(y)){c[h]={src:v.imageUrl||"",click:()=>this._showCompetitorModal(v.brand,g)};break}}}})}),!c.some(Boolean))return;const d=document.createElement("tr");d.className="ai-table-image-row";for(let l=0;l<a;l++){const u=document.createElement("td"),p=c[l];if(p&&p.src){const h=document.createElement("img");h.className="ai-table-product-img",h.src=p.src,h.alt="",h.onerror=()=>{h.src=`${t}/assets/no-image.png`},u.appendChild(h),p.click&&(u.style.cursor="pointer",u.addEventListener("click",p.click))}d.appendChild(u)}n.insertBefore(d,n.firstChild)})}_injectProductCards(e){e.querySelectorAll("table .ai-add-product-btn").forEach(s=>{const i=document.createElement("strong");i.textContent=s.dataset.code,s.replaceWith(i)});const t=e.querySelectorAll(".ai-add-product-btn");if(!t.length)return;const o=this._getBasePath();t.forEach(s=>{const i=s.dataset.code,n=D.findProductByCode(i);if(!n)return;const r=s.closest("li");if(!(r||s.parentElement))return;const c=this._getProductImage(n),d=this._getProductName(n),l=this._getProductMeta(n),u=this._getProductPrice(n),p=document.createElement("div");if(p.className="ai-product-card",p.dataset.code=i,p.innerHTML=`
    ...
    `,s.querySelectorAll(".ai-feedback-btn").forEach(a=>{a.addEventListener("click",()=>{const c=a.dataset.rating;s.querySelectorAll(".ai-feedback-btn").forEach(d=>d.classList.remove("active")),a.classList.add("active"),this._saveFeedback(t,o,c)})});const r=e.querySelector(".ai-msg-bubble");r?e.insertBefore(s,r.nextSibling):e.appendChild(s)}async _saveFeedback(e,t,o){try{const s=await this._loadFeedback(),i=s.findIndex(a=>a.id===e),n={id:e,question:this._lastUserMessage||"",answer:(t||"").slice(0,500),rating:o,timestamp:Date.now(),synced:!1};i>=0?s[i]={...s[i],...n}:s.push(n);const{set:r}=await z(async()=>{const{set:a}=await import("./vendor-idb-DwnyWBFG.js");return{set:a}},[]);await r(Ce,s)}catch{}}_getFeedbackEntry(e){return this._loadFeedback().then(t=>t.find(o=>o.id===e)||null)}async _loadFeedback(){try{const{get:e}=await z(async()=>{const{get:o}=await import("./vendor-idb-DwnyWBFG.js");return{get:o}},[]),t=await e(Ce);return Array.isArray(t)?t:[]}catch{return[]}}_escapeHtml(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}_scrollToBottom(){requestAnimationFrame(()=>{this.messagesContainer.scrollTop=this.messagesContainer.scrollHeight})}_enrichResponseBubble(e){this._injectProductCards(e),this._enrichTableProducts(e),this._injectCompetitorCards(e),this._cleanupCardOrphans(e),this._collapseProductCards(e),this._attachProductButtons(e)}_persistMessages(){clearTimeout(this._persistTimer),this._persistTimer=setTimeout(()=>this._doPersistMessages(),500)}async _doPersistMessages(){try{const e=[];this.messagesContainer.querySelectorAll(".ai-msg").forEach(o=>{var s,i;o.classList.contains("ai-msg-user")?e.push({role:"user",content:((s=o.querySelector(".ai-msg-bubble"))==null?void 0:s.textContent)||""}):o.classList.contains("ai-msg-assistant")&&!o.querySelector(".ai-msg-thinking")&&e.push({role:"assistant",content:((i=o.querySelector(".ai-msg-bubble"))==null?void 0:i.dataset.rawContent)||"",feedbackId:o.dataset.feedbackId||null})});const{set:t}=await z(async()=>{const{set:o}=await import("./vendor-idb-DwnyWBFG.js");return{set:o}},[]);await t(Fe,e)}catch{}}async _restoreMessages(){try{localStorage.removeItem(Fe);const{get:e}=await z(async()=>{const{get:i}=await import("./vendor-idb-DwnyWBFG.js");return{get:i}},[]),t=await e(Fe);if(!Array.isArray(t)||t.length===0)return;const o=this.messagesContainer.querySelector(".ai-chat-welcome");o&&o.remove();for(const i of t)i.role==="user"&&(this._lastUserMessage=i.content),this._addMessage(i.role,i.content,{skipPersist:!0,feedbackId:i.feedbackId||null});const s=document.createElement("div");s.className="ai-chat-restored",s.textContent="Previous conversation restored",this.messagesContainer.prepend(s)}catch{}}_generateId(){return Date.now().toString(36)+Math.random().toString(36).substr(2)}async _trackQuestion(e){try{const{get:t,set:o}=await z(async()=>{const{get:n,set:r}=await import("./vendor-idb-DwnyWBFG.js");return{get:n,set:r}},[]),s=await t(xe)||{},i=e.trim();if(i.length<5)return;s[i]=(s[i]||0)+1,await o(xe,s)}catch{}}async _syncFeedback(){try{const{get:e,set:t,del:o}=await z(async()=>{const{get:a,set:c,del:d}=await import("./vendor-idb-DwnyWBFG.js");return{get:a,set:c,del:d}},[]),s=await this._loadFeedback(),i=s.filter(a=>!a.synced),n=await e(xe)||null;if(i.length===0&&!n)return;if((await fetch(`${O.PROXY_URL}/v1/feedback`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${O.APP_SECRET}`},body:JSON.stringify({entries:i,questionLog:n})})).ok){for(const a of i)a.synced=!0;this._pruneFeedback(s),await t(Ce,s),await o(xe)}}catch{}}_pruneFeedback(e){const t=Date.now()-6048e5;for(let o=e.length-1;o>=0;o--)e[o].synced&&e[o].timestamp<t&&e.splice(o,1)}async _clearChat(){await ee.clearHistory();try{const{del:e}=await z(async()=>{const{del:t}=await import("./vendor-idb-DwnyWBFG.js");return{del:t}},[]);await e(Ce),await e(xe)}catch{}localStorage.removeItem(Ce),localStorage.removeItem(xe),this._showWelcome()}async _initUserEmail(){var e;try{const{authService:t}=await z(async()=>{const{authService:s}=await import("./index-CHK9MvRr.js");return{authService:s}},__vite__mapDeps([6,1,2,3,7])),o=((e=t.getUser)==null?void 0:e.call(t))||{};this._userEmail=o.email||null}catch{}}async _saveConversation(){var s;if(!this._userEmail)return;const e=[];if(this.messagesContainer.querySelectorAll(".ai-msg").forEach(i=>{var n,r;i.classList.contains("ai-msg-user")?e.push({role:"user",content:((n=i.querySelector(".ai-msg-bubble"))==null?void 0:n.textContent)||""}):i.classList.contains("ai-msg-assistant")&&!i.querySelector(".ai-msg-thinking")&&e.push({role:"assistant",content:((r=i.querySelector(".ai-msg-bubble"))==null?void 0:r.dataset.rawContent)||""})}),e.length<2)return;this._conversationId||(this._conversationId=Date.now().toString(36)+Math.random().toString(36).slice(2,8));const t=((s=e.find(i=>i.role==="user"))==null?void 0:s.content)||"Untitled",o=t.length>50?t.slice(0,47)+"...":t;try{await fetch(`${O.PROXY_URL}/v1/conversations/${this._conversationId}`,{method:"PUT",headers:{"Content-Type":"application/json",Authorization:`Bearer ${O.APP_SECRET}`},body:JSON.stringify({email:this._userEmail,title:o,messages:e})})}catch{}}_startNewConversation(){this._saveConversation(),this._conversationId=null,this._clearChat()}_toggleHistory(e){const t=this.panel.querySelector("#ai-chat-history-panel");this._historyOpen=e!==void 0?e:!this._historyOpen,t.classList.toggle("open",this._historyOpen),this._historyOpen&&this._loadConversationList()}async _loadConversationList(){if(!this._userEmail){this.panel.querySelector("#ai-chat-history-list").innerHTML='<div class="ai-chat-history-empty">Sign in to see conversation history.</div>';return}const e=this.panel.querySelector("#ai-chat-history-list");e.innerHTML='<div class="ai-chat-history-empty">Loading...</div>';try{const t=`${O.PROXY_URL}/v1/conversations?token=${encodeURIComponent(O.APP_SECRET)}&email=${encodeURIComponent(this._userEmail)}`,o=await fetch(t);if(!o.ok)throw new Error("Failed");const i=(await o.json()).conversations||[];if(i.length===0){e.innerHTML='<div class="ai-chat-history-empty">No previous conversations.</div>';return}e.innerHTML=i.map(n=>`
      ...
      `).join(""),e.querySelectorAll(".ai-chat-history-item").forEach(n=>{n.addEventListener("click",()=>this._loadConversation(n.dataset.id))})}catch{e.innerHTML='<div class="ai-chat-history-empty">Failed to load conversations.</div>'}}async _loadConversation(e){try{const t=`${O.PROXY_URL}/v1/conversations/${e}?token=${encodeURIComponent(O.APP_SECRET)}`,o=await fetch(t);if(!o.ok)throw new Error("Failed");const s=await o.json();this._conversationId=e,ee.clearHistory(),this.messagesContainer.innerHTML="";const i=this.messagesContainer.querySelector(".ai-chat-welcome");i&&i.remove();for(const r of s.messages||[])r.role==="user"&&(this._lastUserMessage=r.content),this._addMessage(r.role,r.content,{skipPersist:!0}),(r.role==="user"||r.role==="assistant")&&ee.conversationHistory.push(r);this._persistMessages(),this._toggleHistory(!1);const n=document.createElement("div");n.className="ai-chat-restored",n.textContent="Conversation restored",this.messagesContainer.prepend(n)}catch{console.error("Failed to load conversation")}}_formatHistoryTime(e){if(!e)return"";const t=new Date(e),s=new Date-t,i=Math.floor(s/864e5);return i===0?"Today":i===1?"Yesterday":i<7?`${i}d ago`:t.toLocaleDateString("en-AU",{day:"numeric",month:"short"})}open(){this.panel.style.right="",this.panel.classList.add("open"),this.isOpen=!0,setTimeout(()=>this.input.focus(),300),this._syncFeedback()}close(){const e=this.panel.offsetWidth||620;this.panel.style.right=-(e+20)+"px",this.panel.classList.remove("open"),this.isOpen=!1}toggle(){this.isOpen?this.close():this.open()}}const mt=new $o;class Bo{constructor(){this.navigationManager=null,this.fileImportManager=new So,this.productGridManager=new To,this.isInitialized=!1,J.log("SeimaScanner application starting",Q.INFO)}async init(){var e,t,o;try{J.log("Initializing application modules",Q.INFO),U.configure({googleSheetsUrl:(e=G.PRESENTATION_RECORDING)==null?void 0:e.GOOGLE_SHEETS_URL,email:G.EMAIL}),Y.configure({logoSrc:"assets/seima-logo.png",brandName:"Seima",appName:"Product Presenter"});const s=(t=G.PRESENTATION_RECORDING)==null?void 0:t.GOOGLE_SHEETS_URL;if(s&&Ht(s).catch(r=>{console.warn("Synonyms preload failed:",(r==null?void 0:r.message)||r)}),(o=G.CROSSHAIR)!=null&&o.ENABLED){const r=U.getCurrentUser();R.configure(G.CROSSHAIR,(r==null?void 0:r.email)||""),R.preload().catch(a=>{console.warn("Crosshair preload failed (user may not be logged in):",a.message)})}this.navigationManager=new Qt;const i=Se.getCompatibilityReport();J.log(`Browser compatibility: ${i.score}% (${i.browserName})`,Q.INFO),Se.shouldShowCompatibilityWarning()&&this.showCompatibilityWarning(),await this.navigationManager.init(),this.fileImportManager.init(),this.setupGlobalEventListeners(),this.productGridManager.init(),mt.init();const n=document.getElementById("ai-chat-trigger");return n&&n.addEventListener("click",()=>mt.toggle()),window.navigationManager=this.navigationManager,window.productGridManager=this.productGridManager,window.browserCompatibility=Se,window.downloadWithFallback=Ye,window.showPdfFormScreen=Je,this.isInitialized=!0,J.log("Seima Scanner initialized successfully",Q.INFO),this._dismissLoadingOverlay(),setTimeout(()=>{bt.show()},500),!0}catch(s){return J.handleError({message:"Failed to initialize application",error:s,category:ke.UI,level:Q.CRITICAL,context:"app-init"}),this._dismissLoadingOverlay(),!1}}_dismissLoadingOverlay(){const e=document.getElementById("app-loading-overlay");e&&(e.classList.add("fade-out"),e.addEventListener("transitionend",()=>e.remove(),{once:!0}),setTimeout(()=>e.remove(),400))}showCompatibilityWarning(){const e=Se.getCompatibilityReport(),t=e.recommendations;if(t.length===0)return;const o=t.filter(n=>n.type==="critical"),s=e.score<N.get("compatibility.minCompatibilityScore",70);if(o.length===0&&!s)return;const i=document.createElement("div");i.style.cssText=`
    ...
    `,document.body.insertBefore(i,document.body.firstChild)}setupGlobalEventListeners(){window.addEventListener("generatePdf",e=>{const{tipTailSettings:t,...o}=e.detail;Kt(),Je(o,t||null)}),window.addEventListener("beforeunload",()=>{}),Se.features.memoryAPI&&setInterval(()=>{const e=Se.memoryInfo;e.memoryPressure==="high"&&console.warn("High memory usage detected:",e)},6e4)}getSelectedProducts(){return E.getSelectedProducts()}clearSelection(){return E.clearAllSelections()}addProduct(e,{notes:t="",room:o="",quantity:s=1}={}){return E.addProductToSelection(e,{notes:t,room:o,quantity:s})}updateSelectionCount(){this.navigationManager&&this.navigationManager.updateSelectionCount()}showError(e){alert(e)}}document.addEventListener("DOMContentLoaded",()=>{window.seimaScanner=new Bo,window.seimaScanner.init(),fetch("./version.txt").then(e=>e.text()).then(e=>{const t=e.trim().split(`
`);if(t.length>0){const s=t[0].split(" - ")[0].trim();window._appVersion=s;const i=document.getElementById("menu-version-footer");i&&(i.textContent=`Ver: ${s}`)}}),Ao(),Fo();const f=document.getElementById("changelog-close");f&&f.addEventListener("click",()=>{document.getElementById("changelog-modal").style.display="none"})});function Ao(){const f=document.getElementById("help-btn");f&&f.addEventListener("click",()=>{No()});const e=document.getElementById("crosshair-btn");e&&e.addEventListener("click",()=>{window.location.href="screens/validator.html"});const t=document.getElementById("landscape-btn");t&&t.addEventListener("click",()=>{window.location.href="screens/landscape.html"});const o=document.getElementById("admin-btn");o&&o.addEventListener("click",()=>{window.location.href="screens/admin.html"});const s=document.getElementById("quick-start-btn");s&&s.addEventListener("click",()=>{bt.showForced()})}function Fo(){const f=document.getElementById("user-menu-container"),e=document.getElementById("user-menu-trigger"),t=document.getElementById("user-menu-dropdown"),o=document.getElementById("sign-in-btn"),s=document.getElementById("user-avatar"),i=document.getElementById("user-name-display");function n(c){var d,l,u,p,h,m,y,g,v,w;if(c){(d=G.CROSSHAIR)!=null&&d.ENABLED&&(R.configure(G.CROSSHAIR,c.email||""),R.preload().catch(H=>{console.warn("Crosshair preload after login failed:",H)})),f&&(f.style.display="block"),o&&(o.style.display="none");const b=document.getElementById("crosshair-btn");b&&(b.style.display=(l=G.CROSSHAIR)!=null&&l.ENABLED&&U.isStaffMode()?"":"none");const S=document.getElementById("landscape-btn");S&&(S.style.display=(u=G.CROSSHAIR)!=null&&u.ENABLED&&U.isAdmin()?"":"none");const C=document.getElementById("admin-btn");C&&(C.style.display=U.isAdmin()?"":"none");const P=document.getElementById("staff-divider"),k=(b==null?void 0:b.style.display)!=="none"||(S==null?void 0:S.style.display)!=="none"||(C==null?void 0:C.style.display)!=="none";P&&(P.style.display=k?"":"none");const _=r(c.name);s&&(s.textContent=_),i&&(i.textContent=((p=c.name)==null?void 0:p.split(" ")[0])||"User");const I=(c.email||"").toLowerCase().endsWith("@seima.com.au")&&c.emailVerified===!1;let L=document.getElementById("verify-email-banner");if(I?(L||(L=document.createElement("div"),L.id="verify-email-banner",L.className="verify-email-banner",L.innerHTML=`
            <span>Verify your email to access staff features.</span>
            <button id="verify-email-btn" class="verify-email-btn">Verify now</button>
          `,document.body.insertBefore(L,document.body.firstChild),L.querySelector("#verify-email-btn").addEventListener("click",()=>{Y.showVerifyEmail(c.email,()=>{n(U.getCurrentUser()),L==null||L.remove()})})),L.style.display=""):L&&(L.style.display="none"),t){const H=I?`
        ...
        `,(h=document.getElementById("menu-verify-email"))==null||h.addEventListener("click",()=>{t.style.display="none",Y.showVerifyEmail(c.email,()=>{var M;n(U.getCurrentUser()),(M=document.getElementById("verify-email-banner"))==null||M.remove()})}),(m=document.getElementById("menu-refresh"))==null||m.addEventListener("click",async()=>{t.style.display="none";try{const{del:M,keys:_e}=await z(async()=>{const{del:ce,keys:Re}=await import("./vendor-idb-DwnyWBFG.js");return{del:ce,keys:Re}},[]),Ke=await _e(),Ze=["productCatalogCsv","customerLogo","fredChatHistory","fredChatMessages","fredFeedback","fredQuestionLog"];await Promise.all(Ke.filter(ce=>typeof ce=="string"&&(Ze.includes(ce)||ce.startsWith("crosshair_"))).map(ce=>M(ce)))}catch{}localStorage.removeItem("configPreferences"),localStorage.removeItem("pdfWizardSettings"),Object.keys(localStorage).filter(M=>M.startsWith("crosshair_")||M.startsWith("fred")).forEach(M=>localStorage.removeItem(M)),window.location.reload()}),(y=document.getElementById("menu-version-footer"))==null||y.addEventListener("click",()=>{t.style.display="none",Uo()}),(g=document.getElementById("menu-profile"))==null||g.addEventListener("click",()=>{t.style.display="none",Y.showEditProfile(M=>{E.clearUserSettings(),n(M)})}),(v=document.getElementById("menu-password"))==null||v.addEventListener("click",()=>{t.style.display="none",Y.showChangePassword()}),(w=document.getElementById("menu-logout"))==null||w.addEventListener("click",()=>{t.style.display="none",E.clearUserSettings(),U.logout(),n(null)})}}else f&&(f.style.display="none"),o&&(o.style.display="block")}function r(c){if(!c)return"?";const d=c.trim().split(" ");return d.length>=2?(d[0][0]+d[d.length-1][0]).toUpperCase():c.substring(0,2).toUpperCase()}function a(c){const d=document.createElement("div");return d.textContent=c||"",d.innerHTML}e&&t&&(e.addEventListener("click",c=>{c.stopPropagation();const d=t.style.display!=="none";t.style.display=d?"none":"block"}),document.addEventListener("click",c=>{f!=null&&f.contains(c.target)||(t.style.display="none")})),o&&o.addEventListener("click",()=>{Y.showLogin(c=>{n(c)})}),U.onAuthChange=n,n(U.getCurrentUser())}function No(){const f=document.getElementById("user-guide-modal"),e=document.getElementById("user-guide-content");if(!f||!e)return;e.innerHTML=Mo(),f.style.display="flex";const t=document.getElementById("user-guide-close");t&&(t.onclick=()=>{f.style.display="none"}),f.onclick=s=>{s.target===f&&(f.style.display="none")};const o=s=>{s.key==="Escape"&&(f.style.display="none",document.removeEventListener("keydown",o))};document.addEventListener("keydown",o)}function Mo(){return`
  ...
  `}async function Uo(){try{const f=document.getElementById("changelog-modal"),e=document.getElementById("changelog-content"),s=(await(await fetch("./version.txt")).text()).trim().split(`
