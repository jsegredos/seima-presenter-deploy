...
</body></html>`;try{const l={"Content-Type":"application/json"};this.emailConfig.SEIMA_EMAIL_API_KEY&&(l["X-Api-Key"]=this.emailConfig.SEIMA_EMAIL_API_KEY),console.log("📧 Sending password reset email to:",e);const d=await fetch(r,{method:"POST",headers:l,body:JSON.stringify({to:e,toName:o,subject:"Your Seima Password Reset Code",html:n,fromName:this.emailConfig.FROM_NAME||"Seima Team"})}),c=await d.json().catch(()=>({}));d.ok?console.log("✅ Password reset email sent to:",e):console.error("Password reset email failed:",d.status,c)}catch(l){console.error("Failed to send password reset email:",l)}}async sendVerificationEmail(e,t,i){if(!this.emailConfig){console.warn("Email config not set, cannot send verification email");return}const r=this.emailConfig.SEIMA_EMAIL_API_URL;if(!r){console.error("SEIMA_EMAIL_API_URL not configured, cannot send verification email");return}const o=t||"there",a=new Date().getFullYear(),l=e.toLowerCase().endsWith("@seima.com.au")?`<p style="margin:16px 0 0;color:#166534;font-size:14px;line-height:1.6;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:6px;padding:12px 16px;">
...
<table width="480" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
  ...
  <tr><td style="background:#f8f8fa;padding:16px 32px;text-align:center;border-top:1px solid #e5e7eb;">
    ...
    `;this.showModal(t),this.setupResetHandlers()}showVerifyEmail(e="",t=null){const i=`
      <div class="auth-modal-overlay" id="auth-modal">
        <div class="auth-modal" style="position: relative;">
          <button class="auth-close" id="auth-close">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    `;this.showModal(i),this.setupVerifyEmailHandlers(t)}_escapeAttr(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}showEditProfile(e=null){const t=authService.getCurrentUser();if(!t){console.warn("Cannot edit profile: not logged in");return}const i=`
      <div class="auth-modal-overlay" id="auth-modal">
        <div class="auth-modal" style="position: relative;">
          <button class="auth-close" id="auth-close">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
