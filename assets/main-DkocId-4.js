...
`,skipEmptyLines:!1,escapeChar:`"`,transform:{value(e,t){return typeof e==`string`?e.replace(/\0/g,``).replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g,``):e}}});e.sendEmail?setTimeout(()=>{try{let e=btoa(unescape(encodeURIComponent(i)));n({name:t,data:e,contentType:`text/csv`,originalSize:i.length,base64Size:e.length})}catch(e){console.error(`CSV base64 encoding failed:`,e),n(new Blob([i],{type:`text/csv`}))}},0):n(new Blob([i],{type:`text/csv`}))},0)},0)})}function B(e){return typeof e!=`string`&&(e=String(e)),e=e.replace(/\0/g,``).replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g,``).replace(/\r?\n|\r/g,` `).trim(),e}async function ue(e,t,n=`file`){try{if(`showSaveFilePicker`in window){let r=await(await window.showSaveFilePicker({suggestedName:t,types:[{description:`${n} files`,accept:{[e.type]:[`.${t.split(`.`).pop()}`]}}]})).createWritable();return await r.write(e),await r.close(),!0}}catch(e){console.warn(`File System Access API failed:`,e)}return!1}function de(e,t,n=`file`){try{if(e.size>2*1024*1024)return console.warn(`File too large for data URI method`),!1;let n=new FileReader;return n.onload=function(e){try{let n=document.createElement(`a`);n.href=e.target.result,n.download=t,n.style.display=`none`,document.body.appendChild(n),n.click(),document.body.removeChild(n)}catch(e){console.error(`Data URI download failed:`,e)}},n.readAsDataURL(e),!0}catch(e){return console.warn(`Data URI method failed:`,e),!1}}function fe(e,t,n=`file`){let r=URL.createObjectURL(e),i=document.createElement(`div`);i.style.cssText=`
  ...
  `,i.appendChild(a),document.body.appendChild(i),document.getElementById(`manual-download-close`).onclick=()=>{URL.revokeObjectURL(r),document.body.removeChild(i)},document.getElementById(`manual-download-retry`).onclick=()=>{URL.revokeObjectURL(r),document.body.removeChild(i),setTimeout(()=>{pe(e,t,n)},1e3)},document.getElementById(`copy-url-btn`).onclick=()=>{let e=document.getElementById(`manual-download-url`);e.select(),e.setSelectionRange(0,99999);try{navigator.clipboard.writeText(r).then(()=>{let e=document.getElementById(`copy-url-btn`);e.textContent=`Copied!`,e.style.background=`#059669`,setTimeout(()=>{e.textContent=`Copy`,e.style.background=`#059669`},2e3)}).catch(()=>{document.execCommand(`copy`);let e=document.getElementById(`copy-url-btn`);e.textContent=`Copied!`,setTimeout(()=>e.textContent=`Copy`,2e3)})}catch{alert(`Copy failed. Please select the URL manually and copy it.`)}},i.onclick=e=>{e.target===i&&(URL.revokeObjectURL(r),document.body.removeChild(i))},setTimeout(()=>{i.parentElement&&(URL.revokeObjectURL(r),document.body.removeChild(i))},300*1e3)}async function pe(e,t,n=`file`){try{if(await me(e,t))return}catch(e){console.warn(`Standard download failed:`,e)}await ue(e,t,n)||de(e,t,n)||fe(e,t,n)}function me(e,t){return new Promise(n=>{try{let r=URL.createObjectURL(e),i=document.createElement(`a`);i.href=r,i.download=t,i.style.display=`none`,document.body.appendChild(i);let a=setTimeout(()=>{o(),n(!1)},3e3),o=()=>{clearTimeout(a),i.parentElement&&document.body.removeChild(i),setTimeout(()=>URL.revokeObjectURL(r),1e3)};i.onclick=()=>{o(),n(!0)},i.click(),setTimeout(()=>{o(),n(!0)},500)}catch(e){console.error(`Standard download error:`,e),n(!1)}})}function he(e){let t=document.createElement(`canvas`),n=t.getContext(`2d`);t.width=Math.min(100,e.width),t.height=Math.min(100,e.height),n.drawImage(e,0,0,t.width,t.height);let r=n.getImageData(0,0,t.width,t.height).data,i=new Set;for(let e=0;e<r.length;e+=4){let t=`${r[e]},${r[e+1]},${r[e+2]}`;i.add(t)}return i.size<1e3}function ge(e,t){let n=t.getImageData(0,0,e.width,e.height).data;for(let e=3;e<n.length;e+=4)if(n[e]<255)return!0;return!1}function _e(e,t,n){if(e<=n)return{width:e,height:t};let r=t/e;return{width:n,height:Math.round(n*r)}}function ve(e){return e>25*1024*1024?{compressionLevel:`aggressive`,imageQuality:.6,imageMaxWidth:300,removeImages:!1,usePNG:!0,message:`Aggressive compression - maintaining technical diagram clarity`}:e>20*1024*1024?{compressionLevel:`high`,imageQuality:.65,imageMaxWidth:350,removeImages:!1,usePNG:!0,message:`High compression - preserving technical diagram details`}:e>15*1024*1024?{compressionLevel:`medium`,imageQuality:.7,imageMaxWidth:400,removeImages:!1,usePNG:!0,message:`Medium compression - optimal for technical documentation`}:e>10*1024*1024?{compressionLevel:`light`,imageQuality:.75,imageMaxWidth:450,removeImages:!1,usePNG:!0,message:`Light compression - excellent technical diagram quality`}:{compressionLevel:`minimal`,imageQuality:.8,imageMaxWidth:500,removeImages:!1,usePNG:!0,message:`Minimal compression - maximum technical diagram quality`}}function ye(e,t){return e}function be(e,t){let n=(e.size/(1024*1024)).toFixed(2),r=ve(e.size);if(e.size>15*1024*1024){console.warn(`Large file detected (${n} MB) - exceeds typical email limit, may need email-compatible version`);let e=document.createElement(`div`);e.style.cssText=`
    ...
    `,e.innerHTML=`
      ...
      ">OK</button>
    `,document.body.appendChild(e),setTimeout(()=>{e.parentElement&&e.remove()},8e3)}else e.size;return{size:e.size,sizeInMB:parseFloat(n),settings:r}}function xe(e,t=``,n=``){console.error(`Detailed error:`,e);let r={type:Se(e),message:e.message||`Unknown error`,context:t,filename:n,timestamp:new Date().toISOString(),userAgent:navigator.userAgent},i=document.createElement(`div`);i.style.cssText=`
    position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
  ...
  `,i.appendChild(a),document.body.appendChild(i),document.getElementById(`error-close`).onclick=()=>{document.body.removeChild(i)},document.getElementById(`error-retry`).onclick=()=>{document.body.removeChild(i),console.log(`Retry requested for:`,t)},document.getElementById(`error-report`).onclick=()=>{De(r),alert(`Error details copied to clipboard. Please send this to support.`)},i.onclick=e=>{e.target===i&&document.body.removeChild(i)},r}function Se(e){let t=e.message?.toLowerCase()||``,n=e.stack?.toLowerCase()||``;return t.includes(`network`)||t.includes(`fetch`)?`network`:t.includes(`permission`)||t.includes(`denied`)?`permission`:t.includes(`memory`)||t.includes(`quota`)?`memory`:t.includes(`blob`)||t.includes(`url`)?`download`:t.includes(`canvas`)||t.includes(`image`)?`rendering`:n.includes(`jspdf`)||t.includes(`pdf`)?`pdf`:`unknown`}function Ce(e){return{network:`Network Connection Error`,permission:`Permission Required`,memory:`Insufficient Memory`,download:`Download Failed`,rendering:`Display Error`,pdf:`PDF Generation Error`,unknown:`Unexpected Error`}[e]||`Error Occurred`}function we(e,t,n){return{network:`Unable to load required resources. Please check your internet connection and try again.`,permission:`Browser permission required to save ${n}. Please allow downloads and try again.`,memory:`Not enough memory to process this large file. Try closing other browser tabs or use fewer products.`,download:`Failed to download ${n}. This may be due to browser security settings or storage limitations.`,rendering:`Unable to display product images properly. Some images may be missing from the final output.`,pdf:`PDF generation failed while ${t}. The file may be too large or contain problematic data.`,unknown:`An unexpected error occurred while ${t}. Please try again or contact support.`}[e]||`An unknown error has occurred.`}function Te(e){let t={network:`
      ...
      </div>`};return t[e]||t.unknown}function Ee(){let e=navigator.userAgent;return e.includes(`Chrome`)?`Chrome`:e.includes(`Firefox`)?`Firefox`:e.includes(`Safari`)?`Safari`:e.includes(`Edge`)?`Edge`:e.includes(`SamsungBrowser`)?`Samsung Internet`:`Unknown`}function De(e){let t=`
...
========================
  `.trim();try{navigator.clipboard.writeText(t)}catch(e){console.error(`Failed to copy error report:`,e)}}var V={totalImages:0,optimizedImages:0,failedImages:0,totalSavings:0};function Oe(e){let t=0;if(e.length===0)return t.toString();for(let n=0;n<e.length;n++){let r=e.charCodeAt(n);t=(t<<5)-t+r,t&=t}return Math.abs(t).toString(36)}function ke(){V={totalImages:0,optimizedImages:0,failedImages:0,totalSavings:0}}function Ae(e=!1){V.totalImages}function je(e,t){let n=document.createElement(`div`);n.style.cssText=`
    position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
    background: rgba(0,0,0,0.8); z-index: 10001; display: flex; 
    align-items: center; justify-content: center; padding: 20px;
  ...
  `,document.body.appendChild(n),setTimeout(()=>{n.parentElement&&n.remove()},8e3)}var Fe=`fredChatHistory`,H=`fredChatMessages`,U=`fredFeedback`,Ie=`fredQuestionLog`,Le=16,W={PROXY_URL:`https://seima-ai-proxy.seima.workers.dev`,MODEL:`gpt-4o`,MAX_TOKENS:2e3,TEMPERATURE:.2,MAX_CATALOG_RESULTS:60},Re=[`code`,`planCode`,`name`,`quantity`,`finish`,`section`],ze=new Set([`high`,`medium`,`low`]);function Be(){return{"Content-Type":`application/json`,...a.getAuthHeaders()}}function Ve(e){let t=String(e||``).toLowerCase();return ze.has(t)?t:`medium`}function He(e){let t=e?.confidence&&typeof e.confidence==`object`?e.confidence:{};return Object.fromEntries(Re.map(e=>[e,Ve(t[e])]))}async function Ue(e){let t=new TextEncoder().encode(e),n=await crypto.subtle.digest(`SHA-256`,t);return[...new Uint8Array(n)].map(e=>e.toString(16).padStart(2,`0`)).join(``)}function G(e){return String(e||``).toLowerCase().replace(/[^a-z0-9]+/g,` `).trim()}var We=`You are a product specification parser for building/construction projects. Extract ALL product references from the provided text.
              ...
              <div class="lmw-fields">
                ${i.map(e=>`
                  <label class="lmw-field-row">
                    <span>${q(e.label)}</span>
                    <select data-target="${q(e.key)}">
                      ${r.map(t=>`<option value="${q(t)}"${l[e.key]===t?` selected`:``}>${t?q(t):`Do not map`}</option>`).join(``)}
                    </select>
                  </label>
                `).join(``)}
              </div>
...
`);return console.log(`PDF text extraction: ${n.numPages} pages, ${r.length} with text, ${i.length} chars total`),i}catch(e){return console.warn(`PDF text extraction failed, will use vision API:`,e),null}}_fileToBase64(e){return new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(r.result.split(`,`)[1]),r.onerror=()=>n(Error(`Failed to read file`)),r.readAsDataURL(e)})}_normaliseSpecMimeType(e,t=``){let n=String(t||``).toLowerCase(),r=String(e||``).toLowerCase().split(`;`)[0].trim();return r===`image/jpg`||r===`image/pjpeg`||r.endsWith(`/jpg`)||n.endsWith(`.jpg`)||n.endsWith(`.jpeg`)?`image/jpeg`:r===`image/x-png`?`image/png`:r||`image/jpeg`}async _compressPdf(e,t){if(!window.pdfjsLib)throw Error(`PDF.js must be loaded before compression`);if(!window.jspdf){let e=document.createElement(`script`);e.src=`https://cdn.jsdelivr.net/npm/jspdf@2.5.2/dist/jspdf.umd.min.js`,document.head.appendChild(e),await new Promise((t,n)=>{e.onload=t,e.onerror=()=>n(Error(`Failed to load jsPDF`)),setTimeout(()=>n(Error(`jsPDF load timeout`)),1e4)})}let n=await e.arrayBuffer(),r=await window.pdfjsLib.getDocument({data:n}).promise,{jsPDF:i}=window.jspdf,a=null;for(let e=1;e<=r.numPages;e++){t&&t(e,r.numPages);let n=await r.getPage(e),o=n.getViewport({scale:1.5}),s=document.createElement(`canvas`);s.width=o.width,s.height=o.height;let c=s.getContext(`2d`);await n.render({canvasContext:c,viewport:o}).promise;let l=s.toDataURL(`image/jpeg`,.65),u=o.width>o.height?`landscape`:`portrait`;e===1?a=new i({orientation:u,unit:`px`,format:[o.width,o.height]}):a.addPage([o.width,o.height],u),a.addImage(l,`JPEG`,0,0,o.width,o.height),s.width=0,s.height=0}let o=a.output(`blob`),s=new File([o],e.name,{type:`application/pdf`}),c=Math.round((1-s.size/e.size)*100);return console.log(`PDF compressed: ${(e.size/(1024*1024)).toFixed(1)}MB → ${(s.size/(1024*1024)).toFixed(1)}MB (${c}% reduction)`),s.size<e.size*.9?s:(console.log(`Compression did not significantly reduce size, using original`),e)}_showSpecResults(e){let t=e.filter(e=>this._isAutoImportableSpecResult(e)),n=e.filter(e=>!this._isAutoImportableSpecResult(e)),r=[...new Set(e.map(e=>e.section).filter(Boolean))],i=document.getElementById(`spec-results-content`);if(!i)return;let a=``;if(this._projectMeta){let e=this._projectMeta;if([e.name,e.description,e.architect,e.builder,e.location].filter(Boolean).length>0){let t=e.description?`<div style="margin-top:4px;color:#444;font-size:13px">${this._escapeHtml(e.description)}</div>`:``,n=[e.architect?`Architect: ${this._escapeHtml(e.architect)}`:``,e.builder?`Builder: ${this._escapeHtml(e.builder)}`:``,e.location?`Location: ${this._escapeHtml(e.location)}`:``].filter(Boolean).join(` · `);a=`<div class="spec-project-meta" style="margin-bottom:12px;padding:8px 12px;background:#f0f9ff;border-radius:6px;border:1px solid #bae6fd;">
    ...
    `}_hasLowConfidence(e){let t=e?.confidence||{};return[`code`,`planCode`,`quantity`].some(e=>t[e]===`low`)}async _crossReferenceSpecResults(e){if(!Array.isArray(e)||e.length===0||!P?.isLoaded)return e;let t=R.isEnabled();if(t)try{await R.preload()}catch{}for(let n of e)if(!(!n||n.status!==`extracted`)){if(n.code){let e=P.findProductByCode(String(n.code).trim());if(e){n.status=`seima-own`,n.seimaProduct=e;continue}}if(t&&n.code)try{let e=await R.findSeimaMatches(String(n.code).trim());if(e?.matches?.length>0){let t=String(e.matches[0].SeimaSKU||``).trim(),r=t?P.findProductByCode(t):null;if(r){n.status=`verified`,n.seimaMatches=e.matches,n.seimaProduct=r;continue}}}catch{}}return e}_isAutoImportableSpecResult(e){return[`seima-own`,`verified`].includes(e?.status)&&!!e?.seimaProduct}_isSelectedByDefaultSpecResult(e){return e?.status===`extracted`||this._isAutoImportableSpecResult(e)}_confidenceTitle(e){let t=e?.confidence||{};return[`code`,`planCode`,`quantity`,`finish`,`section`].filter(e=>t[e]===`low`).map(e=>`${e}: low confidence`).join(`; `)||`Low confidence extraction`}_defaultLayoutMapping(){return{planCode:`planCode`,code:`code`,name:`name`,quantity:`quantity`,finish:`finish`,section:`section`,brand:`brand`,notes:``}}_normaliseLayoutMapping(e){return{...this._defaultLayoutMapping(),...e||{}}}_renderMappingSummary(){let e=this._normaliseLayoutMapping(this._currentLayoutMapping);return`<div class="spec-mapping-summary">
...
`)}:{}};r.setStorageItem(`pdfFormSettings`,u)}_showTenderImportBanner(){try{let e=sessionStorage.getItem(`tenderImportBanner`);if(!e)return;sessionStorage.removeItem(`tenderImportBanner`);let t=JSON.parse(e);if(Date.now()-t.timestamp>3e4)return;let n=document.getElementById(`tender-import-banner`);if(!n)return;let r=t.project||t.fileName,i=t.projectDescription?`<span style="opacity:0.9"> — ${this._escapeHtml(t.projectDescription)}</span>`:``;n.innerHTML=`
    ...
    `}_bindCompetitorSearch(){let e=this._overlay.querySelector(`#uv-comp-search`);if(!e)return;let t;e.addEventListener(`input`,()=>{clearTimeout(t),t=setTimeout(()=>this._onCompetitorSearch(e.value),250)}),e.addEventListener(`focus`,()=>{e.value.length>=2&&this._onCompetitorSearch(e.value)})}_normaliseCode(e){return String(e||``).toLowerCase().replace(/[.\-_\s/\\]+/g,``)}_extractPrefillCode(e){let t=String(e||``).trim();if(!t)return``;let n=t.indexOf(`:`);return(n>=0?t.slice(n+1):t).trim()}_normalizeCompetitorEntry(e){if(!e?.competitor)return null;let t=e.product||e.competitorProduct;return t?{competitor:e.competitor,product:t}:null}async _findExactPrefilledCompetitor(e){let t=this._extractPrefillCode(e);if(!t||t.length<3)return null;try{await R._ensureIndex();let e=await R.findCompetitorEntryByCode(t),n=this._normalizeCompetitorEntry(e);if(!n)return null;let r=n.product?.product_code||e?.matchedCode||``;return this._normaliseCode(r)===this._normaliseCode(t)?n:null}catch{return null}}async _onCompetitorSearch(e){let t=this._overlay.querySelector(`#uv-comp-results`);if(!t)return;if(!e||e.length<2){t.style.display=`none`;return}if(await R._ensureIndex(),!R._index){t.style.display=`none`;return}let n=this._extractPrefillCode(e),r=this._normaliseCode(n),i=await this._findExactPrefilledCompetitor(e),a=[],o=new Set;i&&(a.push(i),o.add(`${i.competitor}:${i.product?.product_code||``}`));let s=e.toLowerCase().replace(/[:\-]/g,` `).split(/\s+/).filter(Boolean);for(let e of R._index.searchable){let t=String(e.product?.product_code||``),n=`${e.competitor}:${t}`;if(o.has(n))continue;let i=this._normaliseCode(t);if((r&&i===r||s.every(t=>e.searchText.includes(t)))&&(a.push(e),o.add(n),a.length>=15))break}if(a.length===0){t.innerHTML=`<div class="uv-empty">No competitor products found</div>`,t.style.display=`block`;return}t.innerHTML=a.map((e,t)=>{let n=this._normalizeCompetitorEntry(e)?.product||e.product;if(!n)return``;let r=n.image_url||``,i=n.product_code||``,a=n.product_name||n.collection||``,o=n.product_type||``;return`
        <div class="uv-search-item" data-comp-idx="${t}">
          ...
          <div class="uv-search-item-info">
            <span class="uv-search-item-code">${this._esc(R.getPublicCompetitorLabel(e.competitor))}: ${this._esc(i)}</span>
            <span class="uv-search-item-name">${this._esc(a)}</span>
            ${o?`<span class="uv-search-item-type">${this._esc(o)}</span>`:``}
          </div>
        </div>
      `}).join(``),t.style.display=`block`,t.querySelectorAll(`.uv-search-item`).forEach(e=>{e.addEventListener(`click`,()=>{let n=parseInt(e.dataset.compIdx);this._selectCompetitorProduct(a[n]),t.style.display=`none`})})}_selectCompetitorProduct(e){let t=this._normalizeCompetitorEntry(e);if(!t){let e=this._overlay?.querySelector(`#uv-comp-search`)?.value;e&&this._onCompetitorSearch(e);return}this._currentCompetitor=t.competitor,this._currentCompetitorProduct=t.product,this._expandedCard=null;let n=this._overlay.querySelector(`#uv-body`),r=this._overlay.querySelector(`.uv-header h2`),i=t.product;r.textContent=`${i.product_name||i.collection||i.product_code||``} — ${R.getPublicCompetitorLabel(t.competitor)}`,n.innerHTML=this._renderSplitView(i,t.competitor),this._wireSplitView()}_renderSplitView(e,t){return`
      <div class="uv-layout">
        ${this._renderCompetitorPanel(e,t)}
        ${this._renderMatchesPanel(e)}
      </div>
    `}_renderCompetitorPanel(e,t){let n=e.image_url||``,r=this._extractCompetitorDimensions(e),i=e.features||``,a=[[`Name`,e.product_name||e.collection||``],[`Code`,e.product_code],[`Brand`,e.brand&&String(e.brand).trim()||R.getPublicCompetitorLabel(t)],[`Category`,[e.product_type,e.subcategory].filter(Boolean).join(` / `)],[`Collection`,e.collection],[`Finish`,e.finish||e.colour],[`Material`,e.material],[`Dimensions`,r],[`Style`,e.style],[`WELS`,e.wels_rating]].filter(([,e])=>e&&String(e).trim()).map(([e,t])=>`<tr><td>${this._esc(e)}</td><td>${e===`Name`?`<strong>${this._esc(t)}</strong>`:this._esc(t)}</td></tr>`).join(``),o=i?`<tr><td>Features</td><td class="uv-features-cell">${this._esc(i).replace(/;\s*/g,`<br>`)}</td></tr>`:``;return`
    ...
    `,a.querySelector(`.uv-confirm-cancel`).addEventListener(`click`,()=>a.remove()),a.querySelector(`.uv-confirm-done`).addEventListener(`click`,()=>{this._submitAndClose(e)}),a.addEventListener(`click`,e=>{e.target===a&&a.remove()}),t.appendChild(a)}async _submitAndClose(e){if(!this._currentCompetitor||!this._currentCompetitorProduct)return;let t=a.getCurrentUser();if(!t?.email){this._showToast(`Please sign in to submit.`,`error`);return}if(tt>=et){this._showToast(`Session limit reached. Thank you for your contributions!`,`error`);return}let n=this._currentCompetitor,r=String(this._currentCompetitorProduct.product_code||``),i=this._seimaByCode[e],o=this._onProductSelected;i&&o&&o(i),this.close(),this._showToast(`Thanks! Your suggestion has been submitted for review.`);try{await R.submitUserVerification(n,r,e,t.email,``),tt++}catch(e){console.error(`UserVerify: submit failed`,e),this._showToast(`Submission failed — please try again later.`,`error`)}}async _submitNoEquivalent(){if(!this._currentCompetitor||!this._currentCompetitorProduct)return;let e=a.getCurrentUser();if(!e?.email){this._showToast(`Please sign in to submit.`,`error`);return}if(tt>=et){this._showToast(`Session limit reached. Thank you for your contributions!`,`error`);return}let t=String(this._currentCompetitorProduct.product_code||``);try{await R.submitUserVerification(this._currentCompetitor,t,`NO_EQUIVALENT`,e.email,`User indicated no Seima equivalent exists`),tt++,this.close(),this._showToast(`Thanks! We've noted that this product has no Seima equivalent.`)}catch(e){console.error(`UserVerify: no-equivalent submit failed`,e),this._showToast(`Failed to submit. Please try again.`,`error`)}}_quickMatch(e,n=6){if(!this._seimaFormatted||this._seimaFormatted.length===0)return[];let r=(e.product_type||e.subcategory||``).toLowerCase(),i=this._normalizeFinish(e.finish||e.colour||``),a=g(e.rrp_ex_gst);Number.isNaN(a)&&(a=_(e.rrp_inc_gst,4)??0),a>0||(a=parseFloat(e.rrp||e.price)||0);let o=(e.material||``).toLowerCase(),s=this._tokenize(`${e.product_name||``} ${e.product_type||``} ${e.collection||``} ${e.finish||``} ${e.material||``}`),c=[t(e.product_name),r].filter(Boolean),l;for(let e of c)if(l=E[e.toLowerCase()],l)break;let u=[];for(let e of this._seimaFormatted){if(l){let t=`${e.subGroup} ${e.group} ${e.range} ${e.name}`.toUpperCase();if(!l.some(e=>t.includes(e)))continue}let t=[e.subGroup,e.group,e.range,e.name,e.longDescription].filter(Boolean).join(` `).toLowerCase(),n=this._tokenize(t),r=0;for(let e of s)n.includes(e)&&r++;let c=s.length>0?r/s.length*100:0,d=this._normalizeFinish(`${e.group||``} ${e.name||``}`),f=i&&d&&i===d?100:i&&d&&(i.includes(d)||d.includes(i))?60:0,p=50;if(o){let t=(e.longDescription||``).toLowerCase();p=t.includes(o)?100:o.split(/\s+/).some(e=>e.length>=4&&t.includes(e))?60:0}let m=parseFloat(e.rrpExGst)||0,h=50;if(a>0&&m>0){let e=Math.min(a,m)/Math.max(a,m);h=e>=.8?100:e>=.6?70:e>=.4?40:10}let g=Math.round(c*.35+f*.25+p*.2+h*.2);g<15||u.push({seima:e,score:g,textScore:Math.round(c),finishScore:f,materialScore:p,priceScore:h})}u.sort((e,t)=>t.score-e.score);let d=new Set,f=[];for(let e of u)if(!d.has(e.seima.orderCode)&&(d.add(e.seima.orderCode),f.push(e),f.length>=n))break;return f}_normalizeFinish(e){let t=(e||``).toLowerCase();for(let[e,n]of Object.entries({chrome:[`chrome`,` cr`,`,cr`,`cp`,`polished chrome`],"matte black":[`matte black`,`matt black`,` mb`,`,mb`,`mblk`,`black`],"brushed nickel":[`brushed nickel`,` bn`,`,bn`,`satin nickel`,`nickel`],"brushed brass":[`brushed brass`,` bb`,`,bb`,`brass`,`warm brass`],"brushed gold":[`brushed gold`,` bg`,`,bg`,`gold`,`light gold`],"gun metal":[`gun metal`,`gunmetal`,` gm`,`,gm`],white:[`white`,` wh`,`,wh`,`gloss white`],"stainless steel":[`stainless steel`,` ss`,`,ss`,`stainless`]}))if(n.some(e=>t.includes(e)))return e;return t.trim()}_tokenize(e){return(e||``).toLowerCase().replace(/[^a-z0-9\s]/g,` `).split(/\s+/).filter(e=>e.length>=2)}_showToast(e,t=`success`){let n=document.querySelector(`.uv-toast`);n&&n.remove();let r=document.createElement(`div`);r.className=`uv-toast uv-toast-${t}`,r.textContent=e,document.body.appendChild(r),setTimeout(()=>r.classList.add(`uv-toast-visible`),10),setTimeout(()=>{r.classList.remove(`uv-toast-visible`),setTimeout(()=>r.remove(),300)},3500)}_extractCompetitorDimensions(e){if(!e)return``;if(e.dimensions_mm)return e.dimensions_mm;let t=0,n=0,r=0;for(let i of Object.keys(e)){let a=i.toLowerCase();a.includes(`width`)&&!t&&(t=parseFloat(e[i])||0),a.includes(`depth`)&&!n&&(n=parseFloat(e[i])||0),a.includes(`height`)&&!r&&(r=parseFloat(e[i])||0)}if(t>0||n>0||r>0){let e=[];return t&&e.push(t),n&&e.push(n),r&&e.push(r),e.join(` × `)+`mm`}return``}_esc(e){let t=document.createElement(`div`);return t.textContent=e||``,t.innerHTML}};function at(e){if(e==null||e===``)return NaN;let t=Number(String(e).replace(/,/g,``));return Number.isFinite(t)&&t>0?t:NaN}function $(e){let t=at(e?.RRP_EX||e?.[`RRP EX GST`]||e?.RRP_EXGST||e?.rrpExGst||e?.[`PL1 - RRP EX GST`]);if(!Number.isNaN(t))return`$${t.toLocaleString(`en-AU`,{minimumFractionDigits:2,maximumFractionDigits:2})} ex GST`;let n=at(e?.RRP_INCGST||e?.[`RRP INC GST`]||e?.rrpIncGst);return Number.isNaN(n)?``:`$${n.toLocaleString(`en-AU`,{minimumFractionDigits:2,maximumFractionDigits:2})} inc GST`}function ot(e){let t=at(e?.rrp_ex_gst);if(Number.isNaN(t)){let n=_(e?.rrp_inc_gst,2);n!=null&&(t=n)}return Number.isNaN(t)?``:`$${t.toLocaleString(`en-AU`,{minimumFractionDigits:2,maximumFractionDigits:2})} ex GST`}var st=class{constructor(){this.activeDropdown=null,this.updatePositionHandler=null,document.addEventListener(`click`,e=>{e.target.closest(`.global-search-dropdown`)||this.hideDropdown()})}showDropdown(e,t,n,i=!1){this.hideDropdown();let a=document.createElement(`ul`);a.className=`global-search-dropdown`;let o=e.getBoundingClientRect(),s=window.innerWidth;window.innerHeight;let c=o.width,l=o.left;l+c>s-8&&(l=s-c-8),l<8&&(l=8);let u={position:`fixed`,top:`0px`,left:`${l}px`,width:`${c}px`,minWidth:`${c}px`,maxWidth:`${c}px`,background:`#fff`,border:`1px solid #d1d5db`,borderRadius:`8px`,boxShadow:`0 10px 25px -5px rgba(0, 0, 0, 0.15), 0 8px 10px -6px rgba(0, 0, 0, 0.10)`,maxHeight:`300px`,overflowY:`auto`,overflowX:`hidden`,zIndex:`10010`,listStyle:`none`,margin:`0`,padding:`4px 0`,whiteSpace:`normal`,wordWrap:`break-word`,display:`block`,pointerEvents:`auto`,transform:`none`,contain:`none`,isolation:`isolate`,visibility:`hidden`};if(Object.keys(u).forEach(e=>{a.style.setProperty(e,u[e],`important`)}),a.maxDropdownHeight=300,t.length===0)a.innerHTML=`<li style="padding: 12px 16px; color: #6b7280; font-style: italic; background: #fff;">No products found</li>`;else{let e=e=>r.escapeHtml(String(e||``)),n=t=>{let n=String(t||``).trim();return/^(https?:|data:image\/|assets\/)/i.test(n)?e(n):``};a.innerHTML=t.map(t=>{if(t._crosshairValidate){let r=t._crosshairValidate,i=n(r.imageUrl),a=r.imageUrl?`<img src="${i}" alt="" style="width:32px; height:32px; object-fit:contain; border-radius:4px; margin-right:10px; vertical-align:middle; flex-shrink:0;">`:``,o=(r.validatorSearch||r.productCode||``).trim();return`<li data-validate-competitor="${e(r.competitor)}" data-validate-code="${e(r.productCode)}" data-validate-search="${e(o)}"
            ...
            <div style="flex:1; min-width:0;">
              ...
              <div style="color: #78716c; font-size: 11px;">${e(R.getPublicCompetitorLabel(r.competitor))} · #${e(r.productCode)}${r.finish?` · `+e(r.finish):``} · ${r.matchCount>0?r.matchCount+` suggested match`+(r.matchCount===1?``:`es`):`no Seima match yet`}</div>
            </div>
            <span style="color: #d97706; font-size: 11px; font-weight: 600; white-space: nowrap; margin-left: 8px;">Review →</span>
          </li>`}let r=t.OrderCode||t.Code||``,i=t.Description||t.ProductName||t[`Product Name`]||``,a=t.Image_URL||t.image_url||``,o=t._crosshairMatch,s=t._outsidePublicPricelist?`<abbr class="grid-search-ext-not-public" title="Not on the public price list — confirm with Seima before quoting.">*</abbr>`:``,c=o?`<span style="display: inline-block; background: ${o.status===`Verified`?`#e8f5e9`:`#e3f2fd`}; color: ${o.status===`Verified`?`#2e7d32`:`#1565c0`}; font-size: 10px; font-weight: 600; padding: 1px 6px; border-radius: 8px; margin-left: 8px;">↔ ${e(o.competitorLabel||R.getPublicCompetitorLabel(o.competitor))}</span>`:``,l=n(a),u=a?`<img src="${l}" alt="" style="width:36px; height:36px; object-fit:contain; border-radius:4px; margin-right:10px; flex-shrink:0;" onerror="this.style.display='none'">`:``,d=o?Object.fromEntries(Object.entries(t).filter(([e])=>e!==`_crosshairMatch`)):t;return`<li data-product='${JSON.stringify(d).replace(/'/g,`&apos;`)}'
      ...
      `;i.push(a),t.forEach(e=>{i.push(this.renderRowHtml(e))})}),e.innerHTML=i.join(``),this.attachSeimaMatchSuggestions()}_isDimensionOrMeasureToken(e){let t=String(e||``).trim();return t?!!(/^\d+(\.\d+)?\s*(mm|cm|m|in|inch|inches|"|')$/i.test(t)||/^\d+(\.\d+)?(mm|cm|m|in)$/i.test(t)||/^\d+\s*x\s*\d+/i.test(t)):!1}extractCandidateCodes(e){if(!e||typeof e!=`string`)return[];let t=new Set,n=[],r=/(?:Code|Part\s*(?:No\.?|Number)|P\/N|Order\s*Code|SKU|Item\s*(?:No\.?|Number)?|#)\s*:?\s*([A-Za-z0-9]{2,14}(?:[.\-][A-Za-z0-9]{1,10})*)/gi,i;for(;(i=r.exec(e))!==null;){let e=i[1].trim();this._isDimensionOrMeasureToken(e)||e.replace(/[.\-]+/g,``).length>=4&&!t.has(e)&&(t.add(e),n.push(e))}let a=e.split(/\|/).map(e=>e.trim()),o=/^[A-Za-z0-9]{2,14}([.\-][A-Za-z0-9]{1,10})*$/,s=/\d/,c=new Set([`white`,`stainless`,`steel`,`black`,`grey`,`gray`,`chrome`,`brushed`,`matte`,`polished`]);for(let e of a){if(!o.test(e)||!s.test(e)||this._isDimensionOrMeasureToken(e)||e.replace(/[.\-]+/g,``).length<4)continue;let r=e.toLowerCase();c.has(r)||t.has(e)||(t.add(e),n.push(e))}let l=/\b([A-Za-z0-9]{2,14}(?:[.\-][A-Za-z0-9]{1,10})*)\b/g,u=/[a-z]/i,d;for(;(d=l.exec(e))!==null;){let e=d[1].trim();if(!o.test(e)||!s.test(e)||this._isDimensionOrMeasureToken(e))continue;let r=e.replace(/[.\-]+/g,``);if(r.length<4)continue;let i=e.toLowerCase();c.has(i)||!u.test(e)&&!/[.\-]/.test(e)&&r.length<8||t.has(e)||(t.add(e),n.push(e))}return n}escapeRegex(e){return String(e).replace(/[.*+?^${}()|[\]\\]/g,`\\$&`)}_isPlaceholderCrossHintFresh(e,t){let n=e?.product?._crossHintCache;if(!n||n.v!==1||typeof n.description!=`string`)return!1;let r=e.product.Description||``;if(n.description!==r)return!1;let i=`${t.join(`	`)}\n@s7`;return!(n.codesFingerprint!==i||!Array.isArray(n.codeEntries)||!n.verifiedMatch?.orderCode&&n.codeEntries.length>0)}_persistPlaceholderCrossHint(e,t,n,r,i,a){let o={v:1,description:t,codesFingerprint:`${n.join(`	`)}\n@s7`,codeEntries:r,verifiedMatch:i?{orderCode:String(i.OrderCode||i.Code||``).trim(),label:a||``}:null};if(e.product._crossHintCache=o,e.storageId)try{M.updateProductCrossHintCache(e.storageId,o)}catch(e){console.warn(`Could not persist cross-hint cache:`,e?.message||e)}}_applyPlaceholderCrossHintDom(e,t,n,r){let i=n.product.Description||``,a=e.closest(`.grid-product-cell`)?.querySelector(`.grid-placeholder-hint`);if(a&&r.codeEntries?.length>0&&(a.innerHTML=this.buildPlaceholderHintHtml(i,r.codeEntries)),!r.verifiedMatch?.orderCode||!P.isLoaded||e.querySelector(`.grid-seima-match-option`))return;let o=P.findProductByCode(String(r.verifiedMatch.orderCode).trim());if(!o)return;let s=document.createElement(`button`);s.type=`button`,s.className=`grid-seima-match-btn grid-seima-match-option`;let c=(o.Description||``).trim(),l=c.length>45?c.slice(0,45)+`…`:c;s.textContent=`Matched Seima: ${o.OrderCode||``} – ${l}`,s.title=r.verifiedMatch.label||``,s.addEventListener(`click`,()=>{this._applyVerifiedSeimaToRow(t,o.OrderCode||o.Code||``)}),e.appendChild(s)}buildPlaceholderHintHtml(e,t){if(!e)return``;let n=r.escapeHtml(String(e||``));if(t.length===0)return n;for(let{code:e,competitor:i,searchCode:a}of t){let t=this.escapeRegex(e),o=RegExp(`((?:(?:Code|Part\\s*(?:No\\.?|Number)|P\\/N|Order\\s*Code|SKU|Item\\s*(?:No\\.?|Number)?|#)\\s*:?\\s*)?`+t+`)`,`gi`),s=a??e,c=`<a href="#" class="grid-competitor-code-link" data-competitor="${r.escapeHtml(String(i||``))}" data-code="${r.escapeHtml(String(s||``))}" title="Review and link to a Seima product">$1</a>`;n=n.replace(o,c)}return n}_normalisePlaceholderMatchText(e){return String(e||``).toLowerCase().replace(/[^a-z0-9 ]/g,` `).replace(/\s+/g,` `).trim()}_productMatchText(e){return this._normalisePlaceholderMatchText([e?.OrderCode,e?.ProductName,e?.Description,e?.LongDescription||e?.[`Long Description`],e?.Range,e?.Group,e?.SubGroup||e?.[`Sub Group`],e?.Finish,e?.Colour].filter(Boolean).join(` `))}_detectPlaceholderProductType(e){let t=` ${this._normalisePlaceholderMatchText(e)} `;for(let[e,n]of[[`toilet_roll_holder`,[/\btoilet\s+(?:roll|paper)\s+holder\b/]],[`toilet_seat`,[/\btoilet\s+seat\b/,/\bseat\b/]],[`bracket`,[/\bbracket\b/]],[`pop_out_waste`,[/\bpop\s+(?:out|up)\b.*\bwaste\b/,/\bwaste\b.*\bpop\s+(?:out|up)\b/]],[`bottle_trap`,[/\bbottle\s+trap\b/]],[`floor_waste`,[/\bfloor\s+waste\b/]],[`pull_out_sink_mixer`,[/\bpull\s+out\b.*\bmixer\b.*\bsink\b/,/\bpull\s+out\b.*\bsink\b.*\bmixer\b/]],[`basin_mixer`,[/\bbasin\s+mixer\b/]],[`sink_mixer`,[/\bsink\s+mixer\b/]],[`shower_mixer`,[/\bshower\s+mixer\b/]],[`wall_mixer`,[/\bwall\s+mixer\b/]],[`bath_mixer`,[/\bbath\s+mixer\b/]],[`toilet`,[/\b(?:toilet|wc|water\s+closet|pan|suite)\b/]],[`basin`,[/\bbasin\b/]],[`sink`,[/\bsink\b/]],[`mixer`,[/\bmixer\b/]],[`waste`,[/\bwaste\b/]],[`trap`,[/\btrap\b/]]])if(n.some(e=>e.test(t)))return e;return``}_detectPlaceholderFinish(e){let t=` ${this._normalisePlaceholderMatchText(e)} `;for(let[e,n]of[[`brushed_gunmetal`,[/\bbrushed\s+gunmetal\b/,/\bgunmetal\b/,/\bgm\b/]],[`brushed_brass`,[/\bbrushed\s+brass\b/,/\bbrass\b/,/\bbb\b/]],[`brushed_nickel`,[/\bbrushed\s+nickel\b/,/\bnickel\b/,/\bbn\b/]],[`brushed_steel`,[/\bbrushed\s+(?:steel|stainless)\b/,/\bstainless\s+steel\b/,/\bbs\b/]],[`matte_black`,[/\bmatte\s+black\b/,/\bblack\s+matte\b/,/\bblack\b/,/\bmb\b/]],[`terracotta`,[/\bterra\s+cotta\b/,/\bterracotta\b/]],[`bronze`,[/\bbronze\b/]],[`chrome`,[/\bchrome\b/,/\bcr\b/]],[`white`,[/\bwhite\b/,/\bwh\b/]]])if(n.some(e=>e.test(t)))return e;return``}_placeholderFinishMatches(e,t){if(!t)return!0;let n=` ${e} `;return({brushed_gunmetal:[/\bbrushed\s+gunmetal\b/,/\bgunmetal\b/,/\bgm\b/],brushed_brass:[/\bbrushed\s+brass\b/,/\bbrass\b/,/\bbb\b/],brushed_nickel:[/\bbrushed\s+nickel\b/,/\bnickel\b/,/\bbn\b/],brushed_steel:[/\bbrushed\s+(?:steel|stainless)\b/,/\bstainless\s+steel\b/,/\bbs\b/],matte_black:[/\bmatte\s+black\b/,/\bblack\s+matte\b/,/\bblack\b/,/\bmb\b/],terracotta:[/\bterra\s+cotta\b/,/\bterracotta\b/],bronze:[/\bbronze\b/],chrome:[/\bchrome\b/,/\bcr\b/],white:[/\bwhite\b/,/\bwh\b/]}[t]||[]).some(e=>e.test(n))}_placeholderRangeTerms(e){let t=this._normalisePlaceholderMatchText(e),n=new Set,r=P?.getSeimaRangeTokenRegexes?.()||[];for(let{token:e,re:i}of r)i.test(t)&&n.add(e);let i=new Set(`bathroom.ensuite.kitchen.imported.match.code.sku.seima.basin.sink.toilet.wc.pan.suite.mixer.pull.out.pop.waste.trap.bottle.floor.wall.shower.bath.holder.seat.bracket.chrome.black.white.matte.brushed.bronze.terracotta.steel.stainless.nickel.brass.gunmetal`.split(`.`));for(let e of t.split(/\s+/))if(!(e.length<3||/^\d+$/.test(e)||i.has(e))){n.add(e);break}return[...n]}_placeholderModelRequirements(e){let t=this._normalisePlaceholderMatchText(e),n=[...t.matchAll(/\b\d{3,4}\b/g)].map(e=>e[0]),r=[];return(/\bwf\b/.test(t)||/\bwall\s+faced\b/.test(t))&&r.push({label:`wf`,re:/\b(?:wf|wall\s+faced)\b/}),{numbers:[...new Set(n)],features:r}}_placeholderTypeCompatible(e,t){return!e||!t?!1:e===t?!0:({waste:[`pop_out_waste`,`floor_waste`],trap:[`bottle_trap`],mixer:[`basin_mixer`,`sink_mixer`,`shower_mixer`,`wall_mixer`,`bath_mixer`,`pull_out_sink_mixer`]}[e]||[]).includes(t)}_findStrictSeimaPlaceholderMatch(e){if(!P?.isLoaded||!e?.product?._placeholder)return null;let t=[e.product.Description||``,e.notes].filter(Boolean).join(` `),n=this._detectPlaceholderProductType(t);if(!n)return null;let r=this._detectPlaceholderFinish(t),i=this._placeholderRangeTerms(t),a=this._placeholderModelRequirements(t),o=[`pop_out_waste`,`bottle_trap`,`floor_waste`,`waste`,`trap`].includes(n);if(i.length===0&&!o)return null;let s=[];for(let e of P.getAllProducts()){let t=this._productMatchText(e),o=this._detectPlaceholderProductType(t);if(!this._placeholderTypeCompatible(n,o))continue;let c=i.find(e=>RegExp(`\\b${this.escapeRegex(e)}\\b`).test(t));if(i.length>0&&!c||!this._placeholderFinishMatches(t,r)||a.numbers.some(e=>!RegExp(`\\b${this.escapeRegex(e)}\\b`).test(t))||a.features.some(e=>!e.re.test(t)))continue;let l=50;c&&(l+=30),r&&(l+=20),l+=a.numbers.length*12,l+=a.features.length*10,n===o&&(l+=10),s.push({product:e,score:l})}return s.length===0||(s.sort((e,t)=>t.score-e.score),s.length>1&&s[0].score===s[1].score)?null:s[0].product}_autoApplyStrictPlaceholderMatches(e){let t=[];for(let n of e){let e=n.dataset.rowId,r=this.gridRows.find(t=>t.id===e),i=this._findStrictSeimaPlaceholderMatch(r);i&&this._applyVerifiedSeimaProductToRow(e,i,{render:!1})&&t.push({rowId:e,product:i})}return t}async attachSeimaMatchSuggestions(){if(!a.isPowerUser())return;let e=++this._matchSuggestionsRunId,t=document.querySelectorAll(`.grid-seima-match-wrap`);t.forEach(e=>{e.querySelectorAll(`.grid-seima-match-btn, .grid-seima-match-option`).forEach(e=>e.remove())});let n=[...t].filter(e=>this.gridRows.find(t=>t.id===e.dataset.rowId)?.product?._placeholder);if(n.length===0)return;let r=this._autoApplyStrictPlaceholderMatches(n);if(r.length>0){this.renderGrid();let e=document.getElementById(`tender-import-banner`);e&&(e.innerHTML=`
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="flex-shrink:0">
            <polyline points="20 6 9 17 4 12"></polyline>
          </svg>
          <span>Auto-matched ${r.length} strict Seima product${r.length===1?``:`s`}; uncertain rows stayed as placeholders</span>
          <button class="tender-banner-close" title="Dismiss" onclick="this.parentElement.style.display='none'">x</button>
        `,e.style.display=`flex`,setTimeout(()=>{e&&(e.style.display=`none`)},1e4));return}let i=document.getElementById(`tender-import-banner`),o=0;if(i&&(i.innerHTML=`
      ...
      `,i.style.display=`flex`),!R.isEnabled())try{await R.preload()}catch{}if(e!==this._matchSuggestionsRunId)return;let s=R.isEnabled();!s&&i&&(i.innerHTML=`
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="flex-shrink:0;animation:spin 1s linear infinite">
          <path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83"></path>
        </svg>
        <span>Competitor data unavailable — checking Seima catalogue for order codes…</span>
      `,i.style.display=`flex`);for(let r of t){if(e!==this._matchSuggestionsRunId)return;let t=r.dataset.rowId,a=this.gridRows.find(e=>e.id===t);if(!a?.product?._placeholder)continue;let c=a.product.Description||``,l=this.extractCandidateCodes(c);if(l.length===0)continue;let u=r.closest(`.grid-product-cell`)?.querySelector(`.grid-placeholder-hint`);if(this._isPlaceholderCrossHintFresh(a,l)){if(this._applyPlaceholderCrossHintDom(r,t,a,a.product._crossHintCache),i){o++;let e=Math.round(o/n.length*100),t=i.querySelector(`span`);t&&(t.textContent=`Cross-referencing ${o}/${n.length} products (${e}%)…`)}continue}let d=null,f=``;if(P.isLoaded)for(let e of l){let t=P.findProductByCode(e);if(t){d=t,f=`Seima catalogue: ${e}`;break}}let p=[];if(s){for(let n of l)if(!(P.isLoaded&&P.findProductByCode(n)))try{let r=await R.findCompetitorEntryByCode(n);if(e!==this._matchSuggestionsRunId)return;if(r){let e=r.matchedCode??r.competitorProduct?.product_code??n;p.push({code:n,competitor:r.competitor,searchCode:e})}else P.isLoaded&&P.findProductByCode(n)||console.log(`Crosshair: no competitor match for code "${n}" (row ${t})`)}catch{}}if(u&&p.length>0&&(u.innerHTML=this.buildPlaceholderHintHtml(c,p)),s&&!d&&P.isLoaded)for(let t of l)try{let n=await R.findSeimaMatches(t);if(e!==this._matchSuggestionsRunId)return;if(n?.matches?.length>0){let e=String(n.matches[0].SeimaSKU).trim(),r=P.findProductByCode(e);if(r){d=r;let i=(n.competitorProduct||{}).product_name||r.Description||``;f=`${R.getPublicCompetitorLabel(n.competitor)}: ${t} → ${e}${i?` – `+i:``}`;break}}}catch{}if(this._persistPlaceholderCrossHint(a,c,l,p,d,f),a?.product?._placeholder&&i){o++;let e=Math.round(o/n.length*100),t=i.querySelector(`span`);t&&(t.textContent=`Cross-referencing ${o}/${n.length} products (${e}%)...`)}if(!d||r.querySelector(`.grid-seima-match-option`))continue;let m=document.createElement(`button`);m.type=`button`,m.className=`grid-seima-match-btn grid-seima-match-option`;let h=(d.Description||``).trim(),g=h.length>45?h.slice(0,45)+`…`:h;m.textContent=`Matched Seima: ${d.OrderCode||``} – ${g}`,m.title=f,m.addEventListener(`click`,()=>{this._applyVerifiedSeimaToRow(t,d.OrderCode||d.Code||``)}),r.appendChild(m)}if(e===this._matchSuggestionsRunId&&i){let e=document.querySelectorAll(`.grid-seima-match-option`).length;i.innerHTML=`
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="flex-shrink:0">
          <polyline points="20 6 9 17 4 12"></polyline>
        </svg>
      ...
      `,setTimeout(()=>{i&&(i.style.display=`none`)},1e4)}}async openValidatorModal(e,t,n){this.closeValidatorModal();let i=document.createElement(`div`);i.className=`grid-validator-overlay`;let a=document.createElement(`div`);a.className=`grid-validator-modal`,a.innerHTML=`
    ...
    `,document.body.appendChild(i),document.body.appendChild(a);let o=()=>this.closeValidatorModal(n);a.querySelector(`.gvm-close`).addEventListener(`click`,o),i.addEventListener(`click`,o);let s=e=>{e.key===`Escape`&&o()};document.addEventListener(`keydown`,s),this._validatorModal={overlay:i,modal:a,escHandler:s,competitor:e,productCode:t,rowId:n};try{await R._ensureIndex();let n=await R.getMatches(e,!0),i=(await R.getProducts(e)).find(e=>String(e.product_code)===String(t));if(!i){a.querySelector(`.gvm-body`).innerHTML=`<div class="gvm-no-matches">Product ${r.escapeHtml(String(t||``))} not found in ${r.escapeHtml(String(R.getPublicCompetitorLabel(e)||``))} data.</div>`;return}let o=n.filter(e=>String(e.CompetitorSKU)===String(t)).sort((e,t)=>(e.Rank||99)-(t.Rank||99)),s={Verified:0,Manual:1,Rejected:2,"AI-Suggested":3},c=new Map;for(let e of o){let t=String(e.SeimaSKU),n=c.get(t);(!n||(s[e.Status]??9)<(s[n.Status]??9))&&c.set(t,e)}let l=[...c.values()].sort((e,t)=>(e.Rank||99)-(t.Rank||99));this._renderValidatorModal(i,l,e)}catch(e){console.error(`Validator modal load failed:`,e),a.querySelector(`.gvm-body`).innerHTML=`<div class="gvm-no-matches">Failed to load data. Check console.</div>`}}_renderValidatorModal(e,t,n){let i=this._validatorModal?.modal;if(!i)return;let a=e.product_name||e.product_code,o=e.image_url||e.Image||``,s=e=>r.escapeHtml(e||``),c=R.getPublicCompetitorLabel(n);i.querySelector(`.gvm-title`).textContent=`${a} — ${c}`;let l;l=t.length===0?`<div class="gvm-no-matches">No Seima matches found. Use the search below to add one.</div>`:t.map(e=>{let t=String(e.SeimaSKU||``).trim(),n=P.findProductByCode(t),r=n?.Description||n?.ProductName||t,i=n?.Image_URL||n?.imageUrl||``,a=n?$(n):``,o=Number(e.Confidence)||0,c=o>=70?`high`:o>=40?`med`:`low`,l=(e.Status||``).toLowerCase().replace(/[\s-]+/g,`-`),u;return u=e.Status===`Verified`||e.Status===`Manual`?`<span class="gvm-status-label gvm-status-verified">✓ Verified</span>
        ...
        </div>`}).join(``);let u=ot(e),d=[[`Code`,e.product_code],[`Brand`,e.brand||c],[`Category`,[e.product_type,e.subcategory].filter(Boolean).join(` / `)],[`Collection`,e.collection],[`Finish`,e.finish||e.colour],[`RRP`,u]].filter(([,e])=>e&&String(e).trim()).map(([e,t])=>`<tr><td>${s(e)}</td><td>${s(t)}</td></tr>`).join(``);i.querySelector(`.gvm-body`).innerHTML=`
    ...
    `,this._wireValidatorModalActions(e,t,n)}_wireValidatorModalActions(e,t,n){let r=this._validatorModal?.modal;if(!r)return;r.querySelectorAll(`.gvm-match-card`).forEach(e=>{e.addEventListener(`click`,t=>{if(t.target.closest(`.gvm-btn`))return;let n=e.dataset.seimaSku;n&&this._showSeimaDetailInModal(n)})}),r.querySelectorAll(`.gvm-btn-verify, .gvm-btn-reject, .gvm-btn-undo`).forEach(r=>{r.addEventListener(`click`,async i=>{i.stopPropagation();let a=r.dataset.sku,o=r.dataset.action,s=o===`verify`?`Verified`:`Rejected`;r.disabled=!0,r.textContent=`…`;try{if(s===`Verified`&&this._validatorModal?.rowId){let t=this._validatorModal.rowId;this._applyVerifiedSeimaToRow(t,a),this.closeValidatorModal(t),Z.success(`Product applied. Saving verification...`),R.updateMatch(n,String(e.product_code),a,s).then(()=>Z.success(`Verification saved`)).catch(e=>{console.error(`Match update failed:`,e),Z.error(`Product applied, but verification save failed.`)});return}await R.updateMatch(n,String(e.product_code),a,s);let r=t.find(e=>String(e.SeimaSKU)===a);r&&(r.Status=s),this._renderValidatorModal(e,t,n)}catch(e){console.error(`Match update failed:`,e),r.disabled=!1,r.textContent=o===`verify`?`✓ Verify`:`✗ Reject`}})});let i=r.querySelector(`.gvm-search-add-input`),a=r.querySelector(`.gvm-search-results`);if(!i||!a)return;let o;i.addEventListener(`input`,()=>{clearTimeout(o),o=setTimeout(()=>{this._renderValidatorSeimaSearch(i.value,a,e,t,n)},250)})}_renderValidatorSeimaSearch(e,t,n,i,a){if(!e||e.length<2){t.innerHTML=``;return}let o=P.searchProducts(e,20),s=new Set(i.map(e=>String(e.SeimaSKU))),c=o.filter(e=>{let t=String(e.OrderCode||e.Code||``);return t&&!s.has(t)});if(c.length===0){t.innerHTML=`<div class="gvm-no-matches">No Seima products found.</div>`;return}let l=e=>r.escapeHtml(String(e||``));t.innerHTML=c.slice(0,15).map(e=>{let t=e.OrderCode||e.Code||``,n=e.Description||e.ProductName||``,r=e.Image_URL||e.imageUrl||``,i=$(e);return`<div class="gvm-search-result" data-seima-code="${l(t)}">
      ...
      </div>`}).join(``),t.querySelectorAll(`.gvm-search-result`).forEach(e=>{let t=e.querySelector(`.gvm-btn-verify`),r=async(e,r=t)=>{r&&(r.disabled=!0,r.textContent=`…`);try{let t=i.length+1;if(this._validatorModal?.rowId){let r=this._validatorModal.rowId;this._applyVerifiedSeimaToRow(r,e),this.closeValidatorModal(r),Z.success(`Product applied. Saving verification...`),R.addMatch(a,String(n.product_code),e,t,`Manual verification`).then(()=>R.updateMatch(a,String(n.product_code),e,`Verified`)).then(()=>Z.success(`Verification saved`)).catch(e=>{console.error(`Add match failed:`,e),Z.error(`Product applied, but verification save failed.`)});return}if(await R.addMatch(a,String(n.product_code),e,t,`Manual verification`),await R.updateMatch(a,String(n.product_code),e,`Verified`),i.push({CompetitorSKU:String(n.product_code),SeimaSKU:e,Rank:t,Confidence:``,MatchReason:`Manual verification`,Status:`Verified`}),this._validatorModal?.rowId){this._applyVerifiedSeimaToRow(this._validatorModal.rowId,e),this.closeValidatorModal(this._validatorModal.rowId);return}this._renderValidatorModal(n,i,a)}catch(e){console.error(`Add match failed:`,e),r&&(r.disabled=!1,r.textContent=`✓ Verify`)}};e.addEventListener(`click`,t=>{if(t.target.closest(`.gvm-btn`))return;let n=e.dataset.seimaCode;n&&this._showSeimaDetailInModal(n,{actionLabel:`Verify this product`,onAction:()=>r(n)})}),t?.addEventListener(`click`,async e=>{e.stopPropagation();let n=t.dataset.seimaCode;await r(n,t)})})}closeValidatorModal(e){if(this._validatorModal){this._closeSeimaDetailPanel(),this._validatorModal.overlay.remove(),this._validatorModal.modal.remove(),this._validatorModal.escHandler&&document.removeEventListener(`keydown`,this._validatorModal.escHandler),this._validatorModal=null,R._index=null;try{for(let e of this.gridRows){if(!e?.product?._placeholder)continue;let t=e.product._crossHintCache;if(!(!t||t.v!==1)&&!t.verifiedMatch?.orderCode&&(delete e.product._crossHintCache,e.storageId))try{M.updateProductCrossHintCache(e.storageId,null)}catch{}}}catch(e){console.warn(`Could not invalidate placeholder cross-hint caches:`,e?.message||e)}this.attachSeimaMatchSuggestions()}}async openPlaceholderSearch(e){let t=this.gridRows.find(t=>t.id===e);if(!t?.product?._placeholder)return;let n=String(t.product.Description||``),r=this.extractCandidateCodes(n);P.isLoaded||await new Promise(e=>{let t=Date.now(),n=()=>{if(P.isLoaded||Date.now()-t>8e3)return e();setTimeout(n,80)};n()});let i=[];if(P.isLoaded&&r.length>0)for(let e of r){let t=P.findProductByCode(e);if(!t)continue;let n=String(t.OrderCode||t.Code||``).trim();n&&!i.includes(n)&&i.push(n)}if(i.length===1){this._applyVerifiedSeimaToRow(e,i[0]);return}if(R.isEnabled()&&r.length>0)try{await R.preload()}catch{}if(R.isEnabled()){for(let t of r)if(!(P.isLoaded&&P.findProductByCode(t)))try{let n=await R.findCompetitorEntryByCode(t);if(!n)continue;let r=n.matchedCode??n.competitorProduct?.product_code??t;R.isWriteEnabled()?await this.openValidatorModal(n.competitor,String(r),e):Q.open(`${R.getPublicCompetitorLabel(n.competitor)}: ${r}`,t=>{let n=t?.OrderCode||t?.Code||``;n&&this._applyVerifiedSeimaToRow(e,n)});return}catch{}}let a=[...i];if(R.isEnabled()){for(let e of r.slice(0,3))if(!(P.isLoaded&&P.findProductByCode(e)))try{let t=await R.findSeimaMatches(e);if(t?.matches?.length)for(let e of t.matches){let t=String(e.SeimaSKU||``).trim();t&&!a.includes(t)&&a.push(t)}}catch{}}this.openSeimaSearchModal(e,n,a,r)}openSeimaSearchModal(e,t,n=[],i=[]){this.closeSeimaSearchModal();let a=e=>r.escapeHtml(String(e||``)),o=this._derivePlaceholderSearchQuery(t),s=this._summariseImportedPlaceholder(t),c=document.createElement(`div`);c.className=`grid-validator-overlay`;let l=document.createElement(`div`);l.className=`grid-validator-modal gvm-seima-picker-modal`;let u=n.map(e=>{let t=P.findProductByCode(e);if(!t)return``;let n=t.Description||t.ProductName||e,r=t.Image_URL||t.imageUrl||t.Image||`assets/no-image.png`,i=$(t);return`
    ...
    `,document.body.appendChild(c),document.body.appendChild(l);let d=()=>this.closeSeimaSearchModal();l.querySelector(`.gvm-close`)?.addEventListener(`click`,d),c.addEventListener(`click`,d);let f=e=>{e.key===`Escape`&&d()};document.addEventListener(`keydown`,f),this._seimaSearchModal={overlay:c,modal:l,escHandler:f,rowId:e},l.querySelectorAll(`.gvm-search-result-pick`).forEach(n=>{n.addEventListener(`click`,()=>{let r=n.dataset.seimaCode||``;r&&this._showSeimaDetailForSelection(r,e,t,i)})});let p=l.querySelector(`.gvm-search-add-input`),m=l.querySelector(`.gvm-search-panel .gvm-search-results`);if(!p||!m)return;l.querySelector(`[data-action="web-image-search"]`)?.addEventListener(`click`,()=>{this._openExternalImageSearch(o||t||``)});let h,g=l.querySelector(`.gvm-explorer-category`),_=l.querySelector(`.gvm-explorer-group`),v={query:o||``,category:``,group:``};this._populateModalCategoryOptions(g),this._populateModalGroupOptions(_,``),g?.addEventListener(`change`,()=>{v.category=g.value,v.group=``,_&&(_.value=``),this._populateModalGroupOptions(_,v.category),this._renderStandaloneSeimaSearch(v,m,e,t,i)}),_?.addEventListener(`change`,()=>{v.group=_.value,this._renderStandaloneSeimaSearch(v,m,e,t,i)}),p.addEventListener(`input`,()=>{clearTimeout(h),h=setTimeout(()=>{v.query=p.value,this._renderStandaloneSeimaSearch(v,m,e,t,i)},200)}),this._renderStandaloneSeimaSearch(v,m,e,t,i),p.focus()}_renderStandaloneSeimaSearch(e,t,n,i=``,a=[]){let o=String(e?.query||``).trim(),s=String(e?.category||``).trim(),c=String(e?.group||``).trim(),l=(o.length>=2?P.searchProducts(o,300):P.getAllProducts()).filter(e=>{let t=String(e.SubGroup||e.Subgroup||e[`Sub Group`]||``).trim(),n=String(e.Group||``).trim();return!(s&&t!==s||c&&n!==c)}),u=t.closest(`.gvm-search-panel`)?.querySelector(`.gvm-result-count`);if(u&&(u.textContent=l.length>0?`${Math.min(l.length,24)} shown from ${l.length} result${l.length===1?``:`s`}`:`No matching Seima products`),l.length===0){t.innerHTML=`
        ...
        </div>`;return}let d=e=>r.escapeHtml(String(e||``));t.innerHTML=l.slice(0,24).map(e=>{let t=e.OrderCode||e.Code||``,n=e.Description||e.ProductName||``,r=e.SubGroup||e.Subgroup||e[`Sub Group`]||``,i=e.Group||``,a=e.Image_URL||e.imageUrl||e.Image||`assets/no-image.png`,o=$(e);return`
      ...
      `}).join(``),t.querySelectorAll(`.gvm-search-result-pick`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.seimaCode||``;t&&this._showSeimaDetailForSelection(t,n,i,a)})})}async _openVerificationFlowFromPlaceholder(e,t,n=[],r=``){let i=Array.isArray(n)&&n.length>0?n:this.extractCandidateCodes(t||``);if(!R.isEnabled())return;try{await R.preload()}catch{}for(let t of i.slice(0,3))try{let n=await R.findCompetitorEntryByCode(t);if(!n)continue;let i=n.matchedCode??n.competitorProduct?.product_code??t;R.isWriteEnabled()?await this.openValidatorModal(n.competitor,String(i),e):Q.open(`${R.getPublicCompetitorLabel(n.competitor)}: ${i}`,t=>{let n=t?.OrderCode||t?.Code||r||``;n&&this._applyVerifiedSeimaToRow(e,n)});return}catch{}let a=t||r||``;Q.open(a,t=>{let n=t?.OrderCode||t?.Code||r||``;n&&this._applyVerifiedSeimaToRow(e,n)})}_populateModalCategoryOptions(e){e&&(e.innerHTML=[`<option value="">Any category</option>`,...[...new Set(P.getAllProducts().map(e=>String(e.SubGroup||e.Subgroup||e[`Sub Group`]||``).trim()).filter(Boolean))].sort((e,t)=>e.localeCompare(t)).map(e=>`<option value="${r.escapeHtml(String(e||``))}">${r.escapeHtml(String(e||``))}</option>`)].join(``))}_populateModalGroupOptions(e,t){e&&(e.innerHTML=[`<option value="">Any group</option>`,...[...new Set(P.getAllProducts().filter(e=>t?String(e.SubGroup||e.Subgroup||e[`Sub Group`]||``).trim()===t:!0).map(e=>String(e.Group||``).trim()).filter(Boolean))].sort((e,t)=>e.localeCompare(t)).map(e=>`<option value="${r.escapeHtml(String(e||``))}">${r.escapeHtml(String(e||``))}</option>`)].join(``))}_openExternalImageSearch(e){let t=String(e||``).trim();if(!t)return;let n=encodeURIComponent(`${t} bathroom product`);window.open(`https://www.google.com/search?tbm=isch&q=${n}`,`_blank`,`noopener,noreferrer`)}_summariseImportedPlaceholder(e){let t=String(e||``).split(`|`).map(e=>e.trim()).filter(Boolean);return{title:t.filter(e=>!/^(code|sku|match)\s*:/i.test(e)&&!/^\d+$/.test(e)).slice(0,3).join(` - `)||t.slice(0,2).join(` - `),meta:t.filter(e=>/^(code|sku|match)\s*:/i.test(e)||/chrome|black|white|steel|brushed/i.test(e)).join(` - `)}}_derivePlaceholderSearchQuery(e){let t=String(e||``);if(!t)return``;let n=t.toLowerCase(),r=``,i=P?.getSeimaRangeTokenRegexes?.()||[];for(let{token:e,re:t}of i)if(t.test(n)){r=e;break}let a=t.split(`|`).map(e=>e.trim()).filter(e=>!/^(code|sku|part\s*(?:no\.?|number)|order\s*code|match|matched)\s*:/i.test(e)).join(` `).replace(/\b(?:phoenix|caroma|abey|posh|hafele|parisi|reece|fienza|clark|argent|franke)\b/gi,` `).replace(/\b[A-Z]{1,4}[-.]?\d+[A-Z0-9.\-_/]*\b/g,` `).replace(/\s+/g,` `).trim();if(!a)return r||``;let o=a.split(/\s+/);return r&&!RegExp(`\\b${this.escapeRegex(r)}\\b`,`i`).test(a)&&o.unshift(r),[...new Set(o)].slice(0,10).join(` `)}closeSeimaSearchModal(){this._seimaSearchModal&&=(this._closeSeimaDetailPanel(),this._seimaSearchModal.overlay.remove(),this._seimaSearchModal.modal.remove(),this._seimaSearchModal.escHandler&&document.removeEventListener(`keydown`,this._seimaSearchModal.escHandler),null)}_applyVerifiedSeimaProductToRow(e,t,n={}){let{render:r=!0}=n,i=this.gridRows.find(t=>t.id===e);if(!i||!t)return!1;i.product=t,delete i.product._crossHintCache,i.price=t.RRP_EX||t[`RRP EX GST`]||t.RRP_EX||t.RRP_EXGST||t.rrpExGst||t[`PL1 - RRP EX GST`]||t.RRP_INCGST||t.RRP_INCGST||t[`RRP INC GST`]||t.rrpIncGst||``,r&&this.renderGrid();let a={...t,UserEditedPrice:i.price};return i.storageId?(M.updateSelectionProduct(i.storageId,a,{notes:i.notes,room:i.room,quantity:i.quantity,userPrice:i.price}),this.updateTotals()):this.saveRowToStorage(i),!0}_applyVerifiedSeimaToRow(e,t){let n=P.findProductByCode(String(t||``).trim());return this._applyVerifiedSeimaProductToRow(e,n)}_showSeimaDetailInModal(e,t={}){this._closeSeimaDetailPanel();let n=P.findProductByCode(e);if(!n)return;let i=e=>r.escapeHtml(String(e||``)),a=n.Description||n.ProductName||e,o=n.Image_URL||n.imageUrl||``,s=n.Website_URL||``,c=[[`Order Code`,n.OrderCode||n.Code],[`Description`,n.Description],[`Long Description`,n.LongDescription||n[`Long Description`]],[`Range`,n.Range],[`Group`,n.Group],[`Sub Group`,n.SubGroup||n[`Sub Group`]],[`RRP ex GST`,n.RRP_EX||n[`RRP EX GST`]],[`RRP inc GST`,n.RRP_INCGST||n[`RRP INC GST`]],[`Dimensions (W)`,n.DimX||n[`X Dimension (mm)`]],[`Dimensions (D)`,n.DimY||n[`Y Dimension (mm)`]],[`Dimensions (H)`,n.DimZ||n[`Z Dimension (mm)`]],[`WELS Star`,n.WELS_STAR||n[`WELS Star`]],[`WELS Consumption`,n.WELS_CONSUMPTION||n[`WELS Consumption`]]].filter(([,e])=>e&&String(e).trim()&&String(e).trim()!==`0`).map(([e,t])=>{let n=e.startsWith(`RRP`)?`$${Number(t).toLocaleString(`en-AU`,{minimumFractionDigits:2})}`:i(t);return`<tr><td>${i(e)}</td><td>${n}</td></tr>`}).join(``),l=t.actionLabel?`<button type="button" class="gvm-detail-action gvm-btn gvm-btn-verify">${i(t.actionLabel)}</button>`:``,u=/^https?:\/\//i.test(String(s||``))?s:``,d=document.createElement(`div`);d.className=`gvm-detail-overlay`;let f=document.createElement(`div`);f.className=`gvm-detail-panel`,f.innerHTML=`
    ...
    `;this.injectSaveDialogStyles(),document.body.insertAdjacentHTML(`beforeend`,a);let o=document.getElementById(`save-dialog`),s=document.getElementById(`save-doc-name`),c=document.getElementById(`save-notes`);s?.focus(),s?.select(),o.querySelectorAll(`button[data-action]`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.action;if(t===`cancel`){o.remove();return}let n=s?.value.trim()||`Untitled Selection`,r=c?.value.trim()||``;this.currentSelectionName=n;let i={...this.prepareSelectionData(),documentName:n,notes:r};o.querySelectorAll(`button`).forEach(e=>e.disabled=!0),e.textContent=`Saving...`;try{let e;t===`save-update`?e=await J.updateSelection(this.currentSelectionId,i):(e=await J.saveSelection(i),e.success&&e.id&&(this.currentSelectionId=e.id)),o.remove(),e.success?(this.hasUnsavedChanges=!1,this.lastSaveTime=new Date,this.updateContextHeader(),Z.success(t===`save-update`?`Selection updated!`:`Selection saved!`)):Z.error(`Failed to save: `+(e.error||`Unknown error`))}catch(e){o.remove(),Z.error(`Failed to save: `+e.message)}})}),o.addEventListener(`click`,e=>{e.target===o&&o.remove()});let l=e=>{e.key===`Escape`&&(o.remove(),document.removeEventListener(`keydown`,l))};document.addEventListener(`keydown`,l)}injectSaveDialogStyles(){document.getElementById(`save-dialog-styles`)||document.head.insertAdjacentHTML(`beforeend`,`
      <style id="save-dialog-styles">
        .save-dialog-overlay {
          position: fixed;
          top: 0;
    ...
    `,document.head.appendChild(e)}getSteps(){return[{icon:`logo`,title:`Welcome to Product Presenter`,text:`Create beautiful PDF presentations of Seima products for your clients in minutes.`,features:[]},{icon:`📦`,title:`Add Your Products`,text:`There are three ways to get started:`,features:[{icon:`📁`,title:`Import a File`,desc:`Upload CSV or Excel files with product codes`},{icon:`📂`,title:`Load a Selection`,desc:`Continue from a previous saved selection`},{icon:`🔍`,title:`Search Products`,desc:`Search and add products one by one`}]},{icon:`🏠`,title:`Organise by Room`,text:`Group products by room or area. Drag to reorder, and easily manage your selection.`,features:[{icon:`🎨`,title:`Colour-coded`,desc:`Rooms are visually distinct for quick reference`},{icon:`📊`,title:`Sort Options`,desc:`Sort by Room/Group, Product Code, or Product Name`},{icon:`💾`,title:`Auto-saves`,desc:`Your work is automatically preserved`}]},{icon:`📄`,title:`Create Your PDF`,text:`Click "Create PDF" to customise and generate a professional presentation with your branding.`,features:[{icon:`💰`,title:`Pricing Options`,desc:`Show RRP, add GST, or hide pricing entirely`},{icon:`📝`,title:`Content Control`,desc:`Include descriptions and custom notes`},{icon:`📑`,title:`Cover Pages`,desc:`Add branded cover and appendix pages`}]}]}renderStep(){let e=this.getSteps(),t=e[this.currentStep],n=document.getElementById(`onboarding-content`),r=document.getElementById(`onboarding-dots`),i=document.getElementById(`onboarding-next`);if(!n||!r)return;let a=``;t.features.length>0&&(a=t.features.map(e=>`
      ...
      ${a}
    `,r.innerHTML=e.map((e,t)=>`<div class="onboarding-dot ${t===this.currentStep?`active`:``}"></div>`).join(``),i&&(i.textContent=this.currentStep===e.length-1?`Get Started`:`Next`)}nextStep(){let e=this.getSteps();this.currentStep<e.length-1?(this.currentStep++,this.renderStep()):this.complete()}complete(){localStorage.setItem(dt,JSON.stringify({version:ft,completedAt:new Date().toISOString()})),this.overlay&&(this.overlay.style.animation=`fadeIn 0.2s ease reverse`,setTimeout(()=>{this.overlay.remove(),this.overlay=null},200))}reset(){localStorage.removeItem(dt)}},mt=new class{constructor(){this.panel=null,this.messagesContainer=null,this.input=null,this.sendBtn=null,this.isOpen=!1,this._lastUserMessage=null,this._conversationId=null,this._userEmail=null,this._historyOpen=!1}init(){this._createPanel(),this._bindEvents(),this._restoreMessages(),this._initUserEmail()}_createPanel(){let e=document.createElement(`div`);e.id=`ai-chat-panel`,e.className=`ai-chat-panel`,e.innerHTML=`
...
`).filter(e=>e.trim());if(t.length<2)return e;let n=e=>e.split(`|`).slice(1,-1).map(e=>e.trim()),r=e=>/^\|[\s:|-]+\|$/.test(e.trim()),i=n(t[0]),a=1;return t.length>1&&r(t[1])&&(a=2),`<table class="ai-comparison-table">${`<thead><tr>`+i.map(e=>`<th>${e}</th>`).join(``)+`</tr></thead>`}${`<tbody>`+t.slice(a).filter(e=>!r(e)).map(e=>`<tr>`+n(e).map(e=>`<td>${e}</td>`).join(``)+`</tr>`).join(``)+`</tbody>`}</table>`}),t=t.replace(/\*\*(.*?)\*\*/g,`<strong>$1</strong>`),t=t.replace(/`([^`]+)`/g,`<code>$1</code>`),t=t.replace(/^### (.+)$/gm,`<h4>$1</h4>`),t=t.replace(/^## (.+)$/gm,`<h3>$1</h3>`),t=t.replace(/^- (.+)$/gm,`<li>$1</li>`),t=t.replace(/(<li>.*<\/li>\n?)+/g,e=>`<ul>${e}</ul>`),t=t.replace(/^\d+\. (.+)$/gm,`<li>$1</li>`),t=t.replace(/\n\n/g,`</p><p>`),t=`<p>${t}</p>`,t=t.replace(/<p><\/p>/g,``),t=t.replace(/<p>(<h[34]>)/g,`$1`),t=t.replace(/(<\/h[34]>)<\/p>/g,`$1`),t=t.replace(/<p>(<ul>)/g,`$1`),t=t.replace(/(<\/ul>)<\/p>/g,`$1`),t=t.replace(/<p>(<table)/g,`$1`),t=t.replace(/(<\/table>)<\/p>/g,`$1`),t=t.replace(/\b(\d{6})\b/g,`<button class="ai-add-product-btn" data-code="$1" title="Add $1 to selection">$1 <span class="ai-add-icon">+</span></button>`),t}_getBasePath(){return(document.querySelector(`base`)?.href||window.location.origin+`/`).replace(/\/$/,``)}_getProductImage(e){return e.Image_URL||e.imageUrl||e.Image||`${this._getBasePath()}/assets/no-image.png`}_getProductName(e){return e.Description||e.ProductName||e[`Product Name`]||``}_getProductMeta(e){let t=e.Finish||e.Colour||``,n=e.DimX||e[`X Dimension (mm)`]||``,r=e.DimY||e[`Y Dimension (mm)`]||``,i=e.DimZ||e[`Z Dimension (mm)`]||``;return[t,n&&n!==`0`?`${n} × ${r||0} × ${i||0}mm`:``].filter(Boolean).join(`  ·  `)}_getProductPrice(e){let t=e[`RRP INC GST`]||e.RRP_INCGST||e[`RRP EX GST`]||e.RRP_EXGST||``;return t?`$${parseFloat(t).toLocaleString(`en-AU`,{minimumFractionDigits:2})}`:``}_enrichTableProducts(e){let t=this._getBasePath(),n=K.lastCompetitorProducts;e.querySelectorAll(`.ai-comparison-table`).forEach(e=>{let r=e.querySelector(`thead`),i=e.querySelector(`tbody`);if(!r||!i)return;let a=r.querySelectorAll(`th`).length;if(a<2)return;let o=Array(a).fill(null);if(i.querySelectorAll(`tr`).forEach(e=>{e.querySelectorAll(`td`).forEach((e,t)=>{if(o[t])return;let r=e.querySelector(`strong`),i=(r?r.textContent:e.textContent).trim();if(i){if(/^\d{6}$/.test(i)){let e=P.findProductByCode(i);e&&(o[t]={src:this._getProductImage(e),click:()=>this._showProductModal(i)})}else if(n)for(let[e,r]of n){let n=String(e);if(n===i||i.includes(n)||n.includes(i)){o[t]={src:r.imageUrl||``,click:()=>this._showCompetitorModal(r.brand,e)};break}}}})}),!o.some(Boolean))return;let s=document.createElement(`tr`);s.className=`ai-table-image-row`;for(let e=0;e<a;e++){let n=document.createElement(`td`),r=o[e];if(r&&r.src){let e=document.createElement(`img`);e.className=`ai-table-product-img`,e.src=r.src,e.alt=``,e.onerror=()=>{e.src=`${t}/assets/no-image.png`},n.appendChild(e),r.click&&(n.style.cursor=`pointer`,n.addEventListener(`click`,r.click))}s.appendChild(n)}i.insertBefore(s,i.firstChild)})}_injectProductCards(e){e.querySelectorAll(`table .ai-add-product-btn`).forEach(e=>{let t=document.createElement(`strong`);t.textContent=e.dataset.code,e.replaceWith(t)});let t=e.querySelectorAll(`.ai-add-product-btn`);if(!t.length)return;let n=this._getBasePath();t.forEach(e=>{let t=e.dataset.code,r=P.findProductByCode(t);if(!r)return;let i=e.closest(`li`);if(!(i||e.parentElement))return;let a=this._getProductImage(r),o=this._getProductName(r),s=this._getProductMeta(r),c=this._getProductPrice(r),l=document.createElement(`div`);if(l.className=`ai-product-card`,l.dataset.code=t,l.innerHTML=`
    ...
    `,r.querySelectorAll(`.ai-feedback-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let i=e.dataset.rating;r.querySelectorAll(`.ai-feedback-btn`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`),this._saveFeedback(t,n,i)})});let a=e.querySelector(`.ai-msg-bubble`);a?e.insertBefore(r,a.nextSibling):e.appendChild(r)}async _saveFeedback(e,t,n){try{let r=await this._loadFeedback(),i=r.findIndex(t=>t.id===e),a={id:e,question:this._lastUserMessage||``,answer:(t||``).slice(0,500),rating:n,timestamp:Date.now(),synced:!1};i>=0?r[i]={...r[i],...a}:r.push(a);let{set:o}=await L(async()=>{let{set:e}=await import(`./vendor-idb-BL1M7mAU.js`).then(e=>e.t);return{set:e}},__vite__mapDeps([0,1]));await o(U,r)}catch{}}_getFeedbackEntry(e){return this._loadFeedback().then(t=>t.find(t=>t.id===e)||null)}async _loadFeedback(){try{let{get:e}=await L(async()=>{let{get:e}=await import(`./vendor-idb-BL1M7mAU.js`).then(e=>e.t);return{get:e}},__vite__mapDeps([0,1])),t=await e(U);return Array.isArray(t)?t:[]}catch{return[]}}_escapeHtml(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}_scrollToBottom(){requestAnimationFrame(()=>{this.messagesContainer.scrollTop=this.messagesContainer.scrollHeight})}_enrichResponseBubble(e){this._injectProductCards(e),a.isPowerUser()&&(this._enrichTableProducts(e),this._injectCompetitorCards(e)),this._cleanupCardOrphans(e),this._collapseProductCards(e),this._attachProductButtons(e)}_persistMessages(){clearTimeout(this._persistTimer),this._persistTimer=setTimeout(()=>this._doPersistMessages(),500)}async _doPersistMessages(){try{let e=[];this.messagesContainer.querySelectorAll(`.ai-msg`).forEach(t=>{t.classList.contains(`ai-msg-user`)?e.push({role:`user`,content:t.querySelector(`.ai-msg-bubble`)?.textContent||``}):t.classList.contains(`ai-msg-assistant`)&&!t.querySelector(`.ai-msg-thinking`)&&e.push({role:`assistant`,content:t.querySelector(`.ai-msg-bubble`)?.dataset.rawContent||``,feedbackId:t.dataset.feedbackId||null})});let{set:t}=await L(async()=>{let{set:e}=await import(`./vendor-idb-BL1M7mAU.js`).then(e=>e.t);return{set:e}},__vite__mapDeps([0,1]));await t(H,e)}catch{}}async _restoreMessages(){try{localStorage.removeItem(H);let{get:e}=await L(async()=>{let{get:e}=await import(`./vendor-idb-BL1M7mAU.js`).then(e=>e.t);return{get:e}},__vite__mapDeps([0,1])),t=await e(H);if(!Array.isArray(t)||t.length===0)return;let n=this.messagesContainer.querySelector(`.ai-chat-welcome`);n&&n.remove();for(let e of t)e.role===`user`&&(this._lastUserMessage=e.content),this._addMessage(e.role,e.content,{skipPersist:!0,feedbackId:e.feedbackId||null});let r=document.createElement(`div`);r.className=`ai-chat-restored`,r.textContent=`Previous conversation restored`,this.messagesContainer.prepend(r)}catch{}}_generateId(){return Date.now().toString(36)+Math.random().toString(36).substr(2)}async _trackQuestion(e){try{let{get:t,set:n}=await L(async()=>{let{get:e,set:t}=await import(`./vendor-idb-BL1M7mAU.js`).then(e=>e.t);return{get:e,set:t}},__vite__mapDeps([0,1])),r=await t(`fredQuestionLog`)||{},i=e.trim();if(i.length<5)return;r[i]=(r[i]||0)+1,await n(Ie,r)}catch{}}async _syncFeedback(){try{let{get:e,set:t,del:n}=await L(async()=>{let{get:e,set:t,del:n}=await import(`./vendor-idb-BL1M7mAU.js`).then(e=>e.t);return{get:e,set:t,del:n}},__vite__mapDeps([0,1])),r=await this._loadFeedback(),i=r.filter(e=>!e.synced),o=await e(`fredQuestionLog`)||null;if(i.length===0&&!o)return;if((await fetch(`${W.PROXY_URL}/v1/feedback`,{method:`POST`,headers:{"Content-Type":`application/json`,...a.getAuthHeaders()},body:JSON.stringify({entries:i,questionLog:o})})).ok){for(let e of i)e.synced=!0;this._pruneFeedback(r),await t(U,r),await n(Ie)}}catch{}}_pruneFeedback(e){let t=Date.now()-10080*60*1e3;for(let n=e.length-1;n>=0;n--)e[n].synced&&e[n].timestamp<t&&e.splice(n,1)}async _clearChat(){await K.clearHistory();try{let{del:e}=await L(async()=>{let{del:e}=await import(`./vendor-idb-BL1M7mAU.js`).then(e=>e.t);return{del:e}},__vite__mapDeps([0,1]));await e(U),await e(Ie)}catch{}localStorage.removeItem(U),localStorage.removeItem(Ie),this._showWelcome()}async _initUserEmail(){try{let e=a.getCurrentUser();this._userEmail=e?.email||null}catch{}}async _saveConversation(){if(!this._userEmail)return;let e=[];if(this.messagesContainer.querySelectorAll(`.ai-msg`).forEach(t=>{t.classList.contains(`ai-msg-user`)?e.push({role:`user`,content:t.querySelector(`.ai-msg-bubble`)?.textContent||``}):t.classList.contains(`ai-msg-assistant`)&&!t.querySelector(`.ai-msg-thinking`)&&e.push({role:`assistant`,content:t.querySelector(`.ai-msg-bubble`)?.dataset.rawContent||``})}),e.length<2)return;this._conversationId||=Date.now().toString(36)+Math.random().toString(36).slice(2,8);let t=e.find(e=>e.role===`user`)?.content||`Untitled`,n=t.length>50?t.slice(0,47)+`...`:t;try{await fetch(`${W.PROXY_URL}/v1/conversations/${this._conversationId}`,{method:`PUT`,headers:{"Content-Type":`application/json`,...a.getAuthHeaders()},body:JSON.stringify({email:this._userEmail,title:n,messages:e})})}catch{}}_startNewConversation(){this._saveConversation(),this._conversationId=null,this._clearChat()}_toggleHistory(e){let t=this.panel.querySelector(`#ai-chat-history-panel`);this._historyOpen=e===void 0?!this._historyOpen:e,t.classList.toggle(`open`,this._historyOpen),this._historyOpen&&this._loadConversationList()}async _loadConversationList(){if(!this._userEmail){this.panel.querySelector(`#ai-chat-history-list`).innerHTML=`<div class="ai-chat-history-empty">Sign in to see conversation history.</div>`;return}let e=this.panel.querySelector(`#ai-chat-history-list`);e.innerHTML=`<div class="ai-chat-history-empty">Loading...</div>`;try{let t=`${W.PROXY_URL}/v1/conversations?email=${encodeURIComponent(this._userEmail)}`,n=await fetch(t,{headers:a.getAuthHeaders()});if(!n.ok)throw Error(`Failed`);let r=(await n.json()).conversations||[];if(r.length===0){e.innerHTML=`<div class="ai-chat-history-empty">No previous conversations.</div>`;return}e.innerHTML=r.map(e=>`
      ...
      `).join(``),e.querySelectorAll(`.ai-chat-history-item`).forEach(e=>{e.addEventListener(`click`,()=>this._loadConversation(e.dataset.id))})}catch{e.innerHTML=`<div class="ai-chat-history-empty">Failed to load conversations.</div>`}}async _loadConversation(e){try{let t=`${W.PROXY_URL}/v1/conversations/${e}`,n=await fetch(t,{headers:a.getAuthHeaders()});if(!n.ok)throw Error(`Failed`);let r=await n.json();this._conversationId=e,K.clearHistory(),this.messagesContainer.innerHTML=``;let i=this.messagesContainer.querySelector(`.ai-chat-welcome`);i&&i.remove();for(let e of r.messages||[])e.role===`user`&&(this._lastUserMessage=e.content),this._addMessage(e.role,e.content,{skipPersist:!0}),(e.role===`user`||e.role===`assistant`)&&K.conversationHistory.push(e);this._persistMessages(),this._toggleHistory(!1);let o=document.createElement(`div`);o.className=`ai-chat-restored`,o.textContent=`Conversation restored`,this.messagesContainer.prepend(o)}catch{console.error(`Failed to load conversation`)}}_formatHistoryTime(e){if(!e)return``;let t=new Date(e),n=new Date-t,r=Math.floor(n/864e5);return r===0?`Today`:r===1?`Yesterday`:r<7?`${r}d ago`:t.toLocaleDateString(`en-AU`,{day:`numeric`,month:`short`})}open(){this.panel&&(this.panel.style.right=``,this.panel.classList.add(`open`),this.isOpen=!0,setTimeout(()=>this.input?.focus(),300),this._syncFeedback())}close(){if(!this.panel){this.isOpen=!1;return}let e=this.panel.offsetWidth||620;this.panel.style.right=-(e+20)+`px`,this.panel.classList.remove(`open`),this.isOpen=!1}toggle(){this.isOpen?this.close():this.open()}},ht=class{constructor(){this.navigationManager=null,this.fileImportManager=new Ye,this.productGridManager=new ut,this.isInitialized=!1,N.log(`SeimaScanner application starting`,j.INFO)}async init(){try{N.log(`Initializing application modules`,j.INFO),a.configure({googleSheetsUrl:I.PRESENTATION_RECORDING?.GOOGLE_SHEETS_URL,email:I.EMAIL}),i.configure({logoSrc:`assets/seima-logo.png`,brandName:`Seima`,appName:`Product Presenter`});let e=I.PRESENTATION_RECORDING?.GOOGLE_SHEETS_URL;if(e&&F(e).catch(e=>{console.warn(`Synonyms preload failed:`,e?.message||e)}),I.CROSSHAIR?.ENABLED){let e=a.getCurrentUser();R.configure(I.CROSSHAIR,e?.email||``),R.preload().catch(e=>{console.warn(`Crosshair preload failed (user may not be logged in):`,e.message)})}this.navigationManager=new ie;let t=n.getCompatibilityReport();N.log(`Browser compatibility: ${t.score}% (${t.browserName})`,j.INFO),n.shouldShowCompatibilityWarning()&&this.showCompatibilityWarning(),await this.navigationManager.init(),this.fileImportManager.init(),this.setupGlobalEventListeners(),this.productGridManager.init(),mt.init();let r=document.getElementById(`ai-chat-trigger`);return r&&r.addEventListener(`click`,()=>mt.toggle()),window.navigationManager=this.navigationManager,window.productGridManager=this.productGridManager,window.browserCompatibility=n,window.downloadWithFallback=ae,window.showPdfFormScreen=oe,this.isInitialized=!0,N.log(`Seima Scanner initialized successfully`,j.INFO),this._dismissLoadingOverlay(),setTimeout(()=>{pt.show()},500),!0}catch(e){return N.handleError({message:`Failed to initialize application`,error:e,category:k.UI,level:j.CRITICAL,context:`app-init`}),this._dismissLoadingOverlay(),!1}}_dismissLoadingOverlay(){let e=document.getElementById(`app-loading-overlay`);e&&(e.classList.add(`fade-out`),e.addEventListener(`transitionend`,()=>e.remove(),{once:!0}),setTimeout(()=>e.remove(),400))}showCompatibilityWarning(){let e=n.getCompatibilityReport(),t=e.recommendations;if(t.length===0)return;let r=t.filter(e=>e.type===`critical`),i=e.score<A.get(`compatibility.minCompatibilityScore`,70);if(r.length===0&&!i)return;let a=document.createElement(`div`);a.style.cssText=`
    ...
    `,document.body.insertBefore(a,document.body.firstChild)}setupGlobalEventListeners(){window.addEventListener(`generatePdf`,e=>{let{tipTailSettings:t,...n}=e.detail;ce(),oe(n,t||null)}),window.addEventListener(`beforeunload`,()=>{}),n.features.memoryAPI&&setInterval(()=>{let e=n.memoryInfo;e.memoryPressure===`high`&&console.warn(`High memory usage detected:`,e)},6e4)}getSelectedProducts(){return M.getSelectedProducts()}clearSelection(){return M.clearAllSelections()}addProduct(e,{notes:t=``,room:n=``,quantity:r=1}={}){return M.addProductToSelection(e,{notes:t,room:n,quantity:r})}updateSelectionCount(){this.navigationManager&&this.navigationManager.updateSelectionCount()}showError(e){alert(e)}};document.addEventListener(`DOMContentLoaded`,async()=>{window.seimaScanner=new ht,await window.seimaScanner.init(),window._appVersion=I.VERSION;let e=document.getElementById(`menu-version-footer`);e&&(e.textContent=`Ver: ${I.VERSION}`),gt(),_t();let t=document.getElementById(`changelog-close`);t&&t.addEventListener(`click`,()=>{document.getElementById(`changelog-modal`).style.display=`none`})});function gt(){let e=document.getElementById(`help-btn`);e&&e.addEventListener(`click`,()=>{vt()});let t=document.getElementById(`crosshair-btn`);t&&t.addEventListener(`click`,()=>{window.location.href=`screens/validator.html`});let n=document.getElementById(`pending-btn`);n&&n.addEventListener(`click`,()=>{window.location.href=`screens/admin-pending.html`});let r=document.getElementById(`landscape-btn`);r&&r.addEventListener(`click`,()=>{window.location.href=`screens/landscape.html`});let i=document.getElementById(`admin-btn`);i&&i.addEventListener(`click`,()=>{window.location.href=`screens/admin.html`});let a=document.getElementById(`quick-start-btn`);a&&a.addEventListener(`click`,()=>{pt.showForced()})}function _t(){let e=document.getElementById(`user-menu-container`),t=document.getElementById(`user-menu-trigger`),n=document.getElementById(`user-menu-dropdown`),r=document.getElementById(`sign-in-btn`),o=document.getElementById(`user-avatar`),s=document.getElementById(`user-name-display`);function c(t){if(t){I.CROSSHAIR?.ENABLED&&(R.configure(I.CROSSHAIR,t.email||``),R.preload().catch(e=>{console.warn(`Crosshair preload after login failed:`,e)})),e&&(e.style.display=`block`),r&&(r.style.display=`none`);let d=document.getElementById(`crosshair-btn`),f=document.getElementById(`pending-btn`),p=a.isStaffMode(),m=a.isPowerUser(),h=a.isAdmin();d&&(d.style.display=I.CROSSHAIR?.ENABLED&&p?``:`none`),f&&(f.style.display=p?``:`none`);let g=document.getElementById(`landscape-btn`);g&&(g.style.display=I.CROSSHAIR?.ENABLED&&p?``:`none`);let _=document.getElementById(`admin-btn`);_&&(_.style.display=h?``:`none`);let v=document.getElementById(`staff-divider`),y=d?.style.display!==`none`||f?.style.display!==`none`||g?.style.display!==`none`||_?.style.display!==`none`;v&&(v.style.display=y?``:`none`),document.querySelectorAll(`#import-file-btn, #entry-import`).forEach(e=>{e&&(e.style.display=m?``:`none`)});let b=document.getElementById(`ai-chat-trigger`);b&&(b.style.display=``);let x=document.getElementById(`guided-ask-fred`);x&&(x.style.display=``);let S=l(t.name);o&&(o.textContent=S),s&&(s.textContent=t.name?.split(` `)[0]||`User`);let C=(t.email||``).toLowerCase().endsWith(`@seima.com.au`)&&t.emailVerified===!1,w=document.getElementById(`verify-email-banner`);if(C?(w||(w=document.createElement(`div`),w.id=`verify-email-banner`,w.className=`verify-email-banner`,w.innerHTML=`
  ...
  `}async function bt(){try{let e=document.getElementById(`changelog-modal`),t=document.getElementById(`changelog-content`),n=(await(await fetch(`./version.txt`)).text()).trim().split(`
