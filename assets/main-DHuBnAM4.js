...
`).filter(r=>r.trim()!==""),n=s.length>0?s[s.length-1]:"Unknown",i=n.split(" - ")[0]||n;o.innerText=i,o.innerText.trim()||(o.innerText="v2.1.0")}}else throw new Error("Version file not found")}catch{const t=document.getElementById("version-number");if(t){const o=_.get("app.version")||"v2.1.0";t.innerText=o}else setTimeout(()=>{const o=document.getElementById("version-number");if(o&&!o.innerText.trim()){const s=_.get("app.version")||"v2.1.0";o.innerText=s}},1e3);console.info("Version loaded from config (GitHub Pages mode)")}}async showProductLookupScreen(){try{const t=await(await fetch("./screens/product-grid.html")).text();document.body.innerHTML=t,this.currentScreen="product-grid";const o=document.createElement("script");o.type="module",o.src="js/app.js",document.body.appendChild(o),setTimeout(()=>{document.querySelectorAll(".back-btn").forEach(s=>s.remove())},100),window.productGridManager&&window.productGridManager.init(),await this.loadVersion(),setTimeout(()=>this.loadVersion(),1e3)}catch(e){console.error("Failed to load product grid screen:",e)}}setupSplitInterface(){const e=document.getElementById("back-to-home");e&&(e.onclick=()=>location.reload());const t=document.getElementById("download-btn"),o=document.getElementById("clear-all-btn");t&&(t.onclick=()=>this.showDownloadFormModal()),o&&(o.onclick=()=>this.showClearConfirmModal()),this.setupSplitProductSearch(),this.setupReviewTable(),this.renderReviewTable(),this.loadInitialSearchResults()}setupSplitProductSearch(){const e=document.getElementById("product-search-input"),t=document.getElementById("search-results-list"),o=document.getElementById("search-loading"),s=document.getElementById("search-no-results");if(!e||!t)return;const n=[],i=S.debounce(r=>{this.performSplitProductSearch(r,t,n,o,s)},200);e.addEventListener("input",()=>{const r=e.value.trim();r?i(r):this.loadInitialSearchResults()}),t.addEventListener("click",r=>{const a=r.target.closest(".result-item");if(!a)return;const c=parseInt(a.getAttribute("data-idx"),10),d=n.length>0?n:this.currentSearchResults||[];!isNaN(c)&&d[c]&&this.showSplitProductDetails(d[c])})}performSplitProductSearch(e,t,o,s,n){if(!D.isLoaded){s.style.display="flex",n.style.display="none",t.innerHTML="";return}o.length=0,o.push(...D.searchProducts(e)),s.style.display="none",o.length===0?(n.style.display="flex",t.innerHTML=""):(n.style.display="none",t.innerHTML=o.map((i,r)=>`
    ...
    `,document.body.appendChild(o);const n=bt();Ne("./assets/seima-logo.png",async(i,r,a)=>{const c=JSON.parse(localStorage.getItem("selection")||"[]"),d=JSON.parse(localStorage.getItem(M.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");let l=[];d.length>0?l=d.map(w=>({...w.product,Room:w.room,Notes:w.notes,Quantity:w.quantity,Timestamp:new Date(w.timestamp).toISOString()})):l=c;const u=document.getElementById("sort-by"),p=u?u.value:"room";switch(p){case"code":l.sort((w,E)=>{const C=w.OrderCode||w.Code||"",P=E.OrderCode||E.Code||"";return C.localeCompare(P)});break;case"product":l.sort((w,E)=>{const C=w.Description||w.ProductName||"",P=E.Description||E.ProductName||"";return C.localeCompare(P)});break;case"room":default:l.sort((w,E)=>{const C=w.Room||"Blank",P=E.Room||"Blank";return C.localeCompare(P)});break}if(!l.length){alert("No products selected."),t&&(t.style.display="none");return}if(Ke()>0)console.log(`📷 Using ${Ke()} pre-cached images (skipping duplicate preload)`);else{const w=document.getElementById("pdf-processing-notification");if(w){const E=document.createElement("span");E.id="preload-progress",E.style.cssText="display: block; font-size: 12px; margin-top: 8px; color: #1e40af;",E.textContent="Loading images: 0%",w.appendChild(E)}console.log("📷 Starting image preload for",l.length,"products"),ct(l).then(E=>{const C=document.getElementById("preload-progress");C&&(C.textContent=`✓ ${E} images ready`,C.style.color="#059669")}).catch(E=>{console.warn("Image preloading error:",E)})}const f={};p==="room"?l.forEach(w=>{const E=w.Room||"Blank";f[E]||(f[E]=[]),f[E].push(w)}):f.__all__=l,await n;const{jsPDF:v}=window.jspdf,h=new v({orientation:"landscape",unit:"pt",format:"a4",compress:!0,putOnlyUsedFonts:!0,precision:16,userUnit:1,floatPrecision:16}),x=h.internal.pageSize.getWidth(),y=h.internal.pageSize.getHeight();Ne("./assets/seima-logo.png",(w,E,C)=>{const P=j.getCurrentUser(),A=b.getUserSettings(),R=P?{name:P.name,email:P.email,phone:P.phone,position:P.position}:A,K=localStorage.getItem("customerLogo");St(h,{pageWidth:x,pageHeight:y,seimaLogoDataUrl:w,seimaLogoNaturalW:E,seimaLogoNaturalH:C,customerLogoDataUrl:K,userDetails:m,staffContact:R,footerHeight:Ze.footerHeight}),h.addPage(),Ne("./assets/seima-logo-white.png",(de,le,ue)=>{const gt=m.showRrp&&!m.excludePrice,Ye=!m.excludePrice,Xe=!m.excludeQty,ft=xt(x,{leftMargin:32,rightMargin:32,showRrp:gt,showPrice:Ye,showQty:Xe,showTotal:Ye&&Xe}),{colX:me,colW:be,headers:De}=ft,Ee=Ze.footerHeight;ot();const Je=(L,k,z,V,F,O,$)=>{if(!k||typeof k!="string"||k.length<10||!k.startsWith("http://")&&!k.startsWith("https://")&&!k.startsWith("data:")){$&&$();return}if((T=>{if(!T||T.length<25||/\/images\/\d+$/.test(T)||T.endsWith("/0"))return!0;const B=/\.(jpg|jpeg|png|gif|webp|svg)(\?.*)?$/i.test(T),N=T.startsWith("data:");return!B&&!N})(k)){console.warn("Skipping malformed image URL:",(k==null?void 0:k.substring(0,50))+"..."),$&&$();return}if(q.totalImages++,m.emailCompatible){q.failedImages++,$&&$();return}const W=It(k);if(W&&W.dataUrl)try{const T=W.width/W.height;let B=F,N=F/T;N>O&&(N=O,B=O*T),L.addImage(W.dataUrl,W.format,z,V,B,N,void 0,"FAST"),q.optimizedImages++,$&&$();return}catch{console.warn("Failed to use cached image, falling back to direct load")}let Z=!1;const he=["https://wsrv.nl/?url=","https://images.weserv.nl/?url=","https://api.codetabs.com/v1/proxy?quest="];let Y=0;function X(){if(Z)return;const T=new Image;T.crossOrigin="Anonymous";let B=null;T.onload=function(){if(!Z){Z=!0,B&&clearTimeout(B);try{const ee=ut(0),Ie=ee.imageMaxWidth,ve=F,J=O;try{const U=document.createElement("canvas"),Q=U.getContext("2d"),{width:te,height:ge}=Jt(T.width,T.height,Ie);U.width=te,U.height=ge,Q.imageSmoothingEnabled=!0,Q.imageSmoothingQuality="high",Q.drawImage(T,0,0,te,ge);let _e,Ae="JPEG";const yt=Xt(U,Q),vt=Yt(T);yt||vt?(_e=U.toDataURL("image/png",ee.imageQuality),Ae="PNG"):(_e=U.toDataURL("image/jpeg",ee.imageQuality),Ae="JPEG");const wt=`img_${no(k)}`;L.addImage(_e,Ae,z,V,ve,J,wt,"FAST"),q.optimizedImages++,$&&$()}catch(U){console.warn(`Failed to optimize image: ${k}`,U),console.warn("Error details:",U.message,U.stack);try{L.addImage(T,"JPEG",z,V,ve,J),q.optimizedImages++,$&&$()}catch(Q){console.error(`Fallback also failed for: ${k}`,Q),q.failedImages++,$&&$()}}}catch(ee){console.warn("Failed to add image to PDF:",ee),q.failedImages++,$&&$()}}},T.onerror=function(){Z||(B&&clearTimeout(B),console.warn(`Failed to load image with proxy ${Y}: ${k}`),console.warn(`Error details for: ${k} - Proxy: ${he[Y]}`),Y++,Y<he.length?setTimeout(()=>{X()},200):(Z=!0,console.warn("All proxies failed, skipping image"),q.failedImages++,$&&$()))},B=setTimeout(()=>{Z||(console.warn(`⏰ Timeout with proxy ${Y}: ${k}`),T.src="",T.onload=null,T.onerror=null,Y++,Y<he.length?setTimeout(()=>{X()},200):(Z=!0,console.warn("All proxies timed out, skipping image"),q.failedImages++,$&&$()))},3e3);let N=k;Y<he.length&&(N=he[Y]+encodeURIComponent(k)),T.src=N}X()},H=[];Object.keys(f).forEach((L,k)=>{const z=f[L];if(!z||!Array.isArray(z)){console.warn("⚠️ Skipping invalid room items:",L,z);return}z.forEach((V,F)=>{if(!V){console.warn("⚠️ Skipping null item in room:",L,"at index:",F);return}H.push({item:V,room:L,rIdx:k,iIdx:F,isFirstInRoom:F===0,roomCount:z.length})})}),H.reduce((L,k)=>{if(!k||!k.item)return console.warn("⚠️ Skipping null row in data analysis:",k),L;const z=String(k.item.Description||""),V=String(k.item.LongDescription||""),F=String(k.item.Notes||""),O=String(k.item.OrderCode||"");return L+z.length+V.length+F.length+O.length},0);let Se=0,Pe=0;const Ce=4,ke=8,Be=Math.floor((y-80)/Ce);let Qe=Ee+8;function $e(){if(!H||!Array.isArray(H)){console.error("❌ Critical error: rowsToDraw is not a valid array:",H),tt(new Error("Invalid product data structure"),"generating PDF","unknown.pdf");return}if(Se>=H.length){const F=h.internal.getNumberOfPages()-1;for(let B=2;B<=F+1;B++){h.setPage(B);const ee=(B-2)*Ce,Ie=Math.min(ee+Ce,H.length);let ve=!1;for(let J=ee;J<Ie;J++)if(H[J]&&H[J].item&&Et(H[J].item)){ve=!0;break}Pt(h,{pageWidth:x,colX:me,colW:be,leftMargin:32,footerHeight:Ee,logoDataUrl:de,logoNaturalW:le,logoNaturalH:ue,headers:De,userDetails:m,skipWelsHeader:!ve}),Ct(h,{pageWidth:x,pageHeight:y,leftMargin:32,footerHeight:Ee,pageNumber:B-1,totalPages:F})}const O=new Date,$=String(O.getDate()).padStart(2,"0"),pe=String(O.getMonth()+1).padStart(2,"0"),W=String(O.getFullYear()).slice(-2),Z=String(O.getHours()).padStart(2,"0"),he=String(O.getMinutes()).padStart(2,"0"),X=`${m.project.replace(/[^a-zA-Z0-9\s]/g,"")}-${$}${pe}${W}.${Z}${he}.pdf`,T=document.getElementById("pdf-processing-notification");T&&T.remove(),io(m.emailCompatible);try{const B=h.output("blob"),N=h.output("string"),ee=N?N.match(/\/Type\s*\/XObject/g):null,Ie=N?N.match(/Tj\s/g):null,ve=N?N.match(/\/A\s*<</g):null;m.pdfSize=B.size;const J=Kt(B,X);if(m.sendEmail&&B.size>15*1024*1024){console.warn(`❌ PDF too large for email (${(B.size/1024/1024).toFixed(1)}MB), offering email-compatible version`),ro(m,X);return}const U=Qt(B,J.settings);if(m.sendEmail&&m.email)if(m.exportCsv){const Q=X.replace(/\.pdf$/,".csv");et(m,Q).then(te=>{window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:m,pdfBlob:U,csvBlob:te}}))}).catch(te=>{console.error("Async CSV generation for email failed:",te),window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:m,pdfBlob:U,csvBlob:null}}))})}else window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:m,pdfBlob:U,csvBlob:null}}));else(async()=>{const Q=await co(U);if(await He(Q,X,"PDF"),m.exportCsv){const te=X.replace(/\.pdf$/,".csv");try{const ge=await et(m,te);ge&&await He(ge,te,"CSV")}catch(ge){console.error("CSV generation failed:",ge)}}})()}catch(B){console.error("PDF generation failed:",B),tt(B,"generating PDF",X);const N=document.getElementById("pdf-processing-notification");N&&N.remove()}t&&(t.style.display="none");return}Pe>=Ce&&(h.addPage(),Qe=Ee+8,Pe=0);const L=H[Se];if(!L||!L.item){console.warn(`⚠️  Skipping invalid row at index ${Se}:`,L),Se++,$e();return}const k=Qe+Be*Pe;L.isFirstInRoom&&p==="room"&&L.room!=="__all__"&&kt(h,L.room,L.roomCount,32,k);const z=me[0],V=z+90+12;Je(h,L.item.Image_URL||"",z,k+ke+16,90,Be-ke*2,()=>{Je(h,L.item.Diagram_URL||"",V,k+ke+16,90,Be-ke*2,()=>{const F=k+28,O=me[1]+be[1]/2;h.setFontSize(10),h.setTextColor("#222"),h.text(String(L.item.OrderCode||""),O,F+10,{align:"center"}),Rt(h,L.item,O,F+35);const $=be[2]-10;Lt(h,L.item,me[2],F+10,$,m.excludeLongDescription);const pe=De.indexOf("WELS")+1;if(pe>0&&me[pe]){const W=me[pe]+be[pe]/2;Tt(h,L.item,W,F+10)}Dt(h,L.item,me,be,De,F+10,{excludePrice:m.excludePrice,includeGst:m.includeGst}),Se++,Pe++,$e()})})}$e()})})})}function Ne(m,e){const t=new window.Image;t.crossOrigin="Anonymous",t.onload=function(){const o=document.createElement("canvas"),s=o.getContext("2d"),n=400,i=150;let r=t.width,a=t.height;if(r>n||a>i){const d=n/r,l=i/a,u=Math.min(d,l);r=Math.round(r*u),a=Math.round(a*u)}o.width=r,o.height=a,s.imageSmoothingEnabled=!0,s.imageSmoothingQuality="high",s.drawImage(t,0,0,r,a);const c=o.toDataURL("image/png",.9);e(c,r,a)},t.src=m}function Gt(){if(!document.getElementById("pdf-spinner")){const m=document.createElement("div");if(m.id="pdf-spinner",m.style.display="none",m.style.position="fixed",m.style.top="0",m.style.left="0",m.style.width="100vw",m.style.height="100vh",m.style.zIndex="9999",m.style.background="rgba(255,255,255,0.7)",m.style.alignItems="center",m.style.justifyContent="center",m.innerHTML='<div style="border:6px solid #e0e0e0;border-top:6px solid #2563eb;border-radius:50%;width:54px;height:54px;animation:spin 1s linear infinite;"></div>',document.body.appendChild(m),!document.getElementById("pdf-spinner-style")){const e=document.createElement("style");e.id="pdf-spinner-style",e.innerHTML="@keyframes spin { 0% { transform: rotate(0deg);} 100% { transform: rotate(360deg);} }",document.head.appendChild(e)}}}async function et(m,e){return new Promise(async t=>{if(!window.Papa)try{await S.loadScript("https://cdn.jsdelivr.net/npm/papaparse@5.4.1/papaparse.min.js")}catch(i){console.error("Failed to load PapaParse:",i),t(null);return}const o=JSON.parse(localStorage.getItem("selection")||"[]"),s=JSON.parse(localStorage.getItem(M.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");let n=[];if(s.length>0?n=s.map(i=>({...i.product,Room:i.room,Notes:i.notes,Quantity:i.quantity,Timestamp:new Date(i.timestamp).toISOString()})):n=o,!n.length){t(null);return}setTimeout(()=>{const i=n.map(r=>{let a,c,d,l;const u=m.excludePrice;let p=0;if(r.UserEditedPrice!==void 0&&r.UserEditedPrice!==null&&r.UserEditedPrice!=="")p=parseFloat(r.UserEditedPrice.toString().replace(/,/g,""));else{const h=r.RRP_EX||r["RRP EX GST"]||r.RRP_EX||r.RRP_EXGST||"";p=parseFloat((h||"0").toString().replace(/,/g,""))}a=p,d="Price ea ex GST",l="Price Total ex GST",c=!isNaN(a)&&a>=0?(a*(r.Quantity||1)).toFixed(2):"";const g=r["WELS STAR"]||r.WELS_STAR||r.WELS_STAR||r.WelsStar||"",f=g&&g.toString().trim()?g.toString().replace(/[^\d.]/g,"").trim():"",v={Code:oe(r.OrderCode||""),Description:oe(r.Description||""),"WELS Star":oe(f),Quantity:r.Quantity||1,Notes:oe(r.Notes||""),Room:oe(r.Room||""),"Image URL":oe(r.Image_URL||""),"Diagram URL":oe(r.Diagram_URL||""),"Datasheet URL":oe(r.Datasheet_URL||""),"Website URL":oe(r.Website_URL||"")};return v[d]=u?"0.00":a>=0?a.toFixed(2):"",v[l]=u?"0.00":c,v});setTimeout(()=>{const r=window.Papa.unparse(i,{quotes:!0,quoteChar:'"',delimiter:",",header:!0,newline:`\r
`,skipEmptyLines:!1,escapeChar:'"',transform:{value(a,c){return typeof a=="string"?a.replace(/\0/g,"").replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g,""):a}}});m.sendEmail?setTimeout(()=>{try{const a=btoa(unescape(encodeURIComponent(r)));t({name:e,data:a,contentType:"text/csv",originalSize:r.length,base64Size:a.length})}catch(a){console.error("CSV base64 encoding failed:",a),t(new Blob([r],{type:"text/csv"}))}},0):t(new Blob([r],{type:"text/csv"}))},0)},0)})}function oe(m){return typeof m!="string"&&(m=String(m)),m=m.replace(/\0/g,"").replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g,"").replace(/\r?\n|\r/g," ").trim(),m}async function Ht(m,e,t="file"){try{if("showSaveFilePicker"in window){const s=await(await window.showSaveFilePicker({suggestedName:e,types:[{description:`${t} files`,accept:{[m.type]:[`.${e.split(".").pop()}`]}}]})).createWritable();return await s.write(m),await s.close(),!0}}catch(o){console.warn("File System Access API failed:",o)}return!1}function qt(m,e,t="file"){try{if(m.size>2*1024*1024)return console.warn("File too large for data URI method"),!1;const o=new FileReader;return o.onload=function(s){try{const n=document.createElement("a");n.href=s.target.result,n.download=e,n.style.display="none",document.body.appendChild(n),n.click(),document.body.removeChild(n)}catch(n){console.error("Data URI download failed:",n)}},o.readAsDataURL(m),!0}catch(o){return console.warn("Data URI method failed:",o),!1}}function Vt(m,e,t="file"){const o=URL.createObjectURL(m),s=document.createElement("div");s.style.cssText=`
...
========================
  `.trim();try{navigator.clipboard.writeText(e)}catch(t){console.error("Failed to copy error report:",t)}}let q={totalImages:0,optimizedImages:0,failedImages:0,totalSavings:0};function no(m){let e=0;if(m.length===0)return e.toString();for(let t=0;t<m.length;t++){const o=m.charCodeAt(t);e=(e<<5)-e+o,e=e&e}return Math.abs(e).toString(36)}function ot(){q={totalImages:0,optimizedImages:0,failedImages:0,totalSavings:0}}function io(m=!1){q.totalImages>0}function ro(m,e){const t=document.createElement("div");t.style.cssText=`
    position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
    background: rgba(0,0,0,0.8); z-index: 10001; display: flex; 
    align-items: center; justify-content: center; padding: 20px;
  ...
  `,document.body.appendChild(t),setTimeout(()=>{t.parentElement&&t.remove()},8e3)}const st="fredChatHistory",Ve="fredChatMessages",Re="fredFeedback",xe="fredQuestionLog",Me=16,ne={PROXY_URL:"https://seima-ai-proxy.seima.workers.dev",APP_SECRET:"sk-proj-KRCnI_ABkeaV18bpU1dTOpXWxpKtucw",MODEL:"gpt-4o",MAX_TOKENS:2e3,TEMPERATURE:.2,MAX_CATALOG_RESULTS:60},lo=`You are Fred, a product assistant for Seima — an Australian bathroom and kitchen products company.

You help users find products in the Seima catalog. You receive SEIMA PRODUCT DATA with each message.

CRITICAL RULES:
1. ONLY reference products that appear in the provided SEIMA PRODUCT DATA. NEVER invent, fabricate, or recall products from your training data. Every product you mention MUST exist in the data provided in this conversation.
2. ONLY recommend SEIMA products. You must NEVER mention, suggest, or reference products from other brands or manufacturers (e.g. Caroma, Reece, Grohe, Hansgrohe, Moen, Kohler, or any other brand). If you are unsure whether a product is a Seima product, do NOT mention it.
3. ONLY state attributes explicitly present in the data. If a field is missing, say "not specified" — NEVER guess or assume.
4. Always include the real OrderCode for every product you mention. If you cannot find the OrderCode in the provided data, do NOT mention the product.
5. Match product types carefully: "basin mixer" is tapware (not a basin), "shower mixer" is tapware (not a shower).
6. Use the "Type" and "Group" fields to determine mounting style, installation type, etc. If these fields don't indicate what the user asked for, DO NOT claim the product matches.
7. If you cannot find products matching the user's criteria, say so honestly. Suggest what IS available in the Seima range instead.
...
Return format: [{"code":"...","name":"...","brand":"...","category":"...","quantity":1,"finish":"...","section":"...","specCode":"...","style":"..."}]`;class mo{constructor(){this.conversationHistory=this._loadHistory(),this.isProcessing=!1}async chat(e,t,o=null){var s,n,i;if(this.isProcessing)throw new Error("A request is already in progress");this.isProcessing=!0;try{const r=[{role:"system",content:lo}],a=this._findRelevantProducts(e,t);if(a?r.push({role:"system",content:`SEIMA PRODUCT DATA (${a.count} products):
${a.text}

IMPORTANT: The above is the COMPLETE list of matching Seima products. Do NOT reference any product whose OrderCode is not listed above.`}):r.push({role:"system",content:"No matching Seima products were found in the catalog for this query. Do NOT invent or recall products from memory. Let the user know honestly that no matching Seima products were found and suggest they refine their search."}),(o==null?void 0:o.length)>0){const l=o.map(u=>[u.OrderCode,u.ProductName||u.Description,u.room?`Room: ${u.room}`:null].filter(Boolean).join(" | ")).join(`
`);r.push({role:"system",content:`USER'S CURRENT SELECTION (${o.length} products):
${l}`})}r.push(...this.conversationHistory),r.push({role:"user",content:e});const c=await this._callProxy("/v1/chat/completions",{messages:r,model:ne.MODEL,max_tokens:ne.MAX_TOKENS,temperature:ne.TEMPERATURE}),d=(i=(n=(s=c.choices)==null?void 0:s[0])==null?void 0:n.message)==null?void 0:i.content;if(!d)throw new Error("No response from AI");return this.conversationHistory.push({role:"user",content:e},{role:"assistant",content:d}),this.conversationHistory.length>Me&&(this.conversationHistory=this.conversationHistory.slice(-Me)),this._saveHistory(),{content:d,usage:c.usage}}finally{this.isProcessing=!1}}async extractFromSpecText(e){var n,i,r;const t=await this._callProxy("/v1/chat/completions",{model:"gpt-4o-mini",messages:[{role:"system",content:uo},{role:"user",content:`Extract all product references from this specification document:
...
This can be restored later.`))try{const t=await ie.deleteSelections([e.id]);t.success?(this.showToast("Selection deleted"),this.fetchAndRenderSelections()):this.showError(t.error||"Failed to delete")}catch(t){this.showError(t.message)}}async restoreSelection(e){try{const t=await ie.restoreSelections([e.id]);t.success?(this.showToast("Selection restored"),this.fetchAndRenderSelections()):this.showError(t.error||"Failed to restore")}catch(t){this.showError(t.message)}}showToast(e){const t=document.createElement("div");t.style.cssText=`
    ...
    `;const a=i.querySelector(".toast-close");if(a.onclick=()=>this.dismiss(n),s&&s.callback){const c=i.querySelector(".toast-action");c.onclick=()=>{s.callback(),this.dismiss(n)}}return this.container.appendChild(i),this.toasts.set(n,i),requestAnimationFrame(()=>{i.classList.add("toast-enter")}),o>0&&setTimeout(()=>this.dismiss(n),o),n}dismiss(e){const t=this.toasts.get(e);t&&(t.classList.add("toast-exit"),t.addEventListener("animationend",()=>{t.remove(),this.toasts.delete(e)}))}dismissAll(){this.toasts.forEach((e,t)=>this.dismiss(t))}success(e,t={}){return this.show({message:e,type:"success",...t})}error(e,t={}){return this.show({message:e,type:"error",duration:6e3,...t})}warning(e,t={}){return this.show({message:e,type:"warning",...t})}info(e,t={}){return this.show({message:e,type:"info",...t})}withUndo(e,t,o=5e3){return this.show({message:e,type:"info",duration:o,action:{label:"Undo",callback:t}})}}const se=new wo;window.toast=se;class bo{constructor(){this.activeDropdown=null,this.updatePositionHandler=null,document.addEventListener("click",e=>{e.target.closest(".global-search-dropdown")||this.hideDropdown()})}showDropdown(e,t,o,s=!1){this.hideDropdown();const n=document.createElement("ul");n.className="global-search-dropdown";const i=300,r=e.getBoundingClientRect(),a=window.innerWidth,c=window.innerHeight,d=r.width,l=c-r.bottom,u=r.top;let p=!1;l<i&&u>l&&(p=!0);let g;p?g=Math.max(8,r.top-i-8):g=Math.min(c-i-8,r.bottom+8);let f=r.left;f+d>a-8&&(f=a-d-8),f<8&&(f=8);const v={position:"fixed",top:`${g}px`,left:`${f}px`,width:`${d}px`,minWidth:`${d}px`,maxWidth:`${d}px`,background:"#fff",border:"1px solid #d1d5db",borderRadius:"8px",boxShadow:"0 10px 25px -5px rgba(0, 0, 0, 0.15), 0 8px 10px -6px rgba(0, 0, 0, 0.10)",maxHeight:`${i}px`,overflowY:"auto",overflowX:"hidden",zIndex:"10010",listStyle:"none",margin:"0",padding:"4px 0",whiteSpace:"normal",wordWrap:"break-word",display:"block",pointerEvents:"auto",transform:"none",contain:"none",isolation:"isolate"};Object.keys(v).forEach(h=>{n.style.setProperty(h,v[h],"important")}),n.dropdownHeight=i,t.length===0?n.innerHTML='<li style="padding: 12px 16px; color: #6b7280; font-style: italic; background: #fff;">No products found</li>':n.innerHTML=t.map(h=>{if(h._crosshairValidate){const R=h._crosshairValidate,K=R.imageUrl?`<img src="${S.sanitizeInput(R.imageUrl)}" alt="" style="width:32px; height:32px; object-fit:contain; border-radius:4px; margin-right:10px; vertical-align:middle; flex-shrink:0;">`:"";return`<li data-validate-competitor="${S.sanitizeInput(R.competitor)}" data-validate-code="${S.sanitizeInput(R.productCode)}"
            ...
            <div style="flex:1; min-width:0;">
              <div style="font-weight: 600; color: #92400e;">${S.sanitizeInput(R.productName)}</div>
              <div style="color: #78716c; font-size: 11px;">${S.sanitizeInput(R.competitor)} · #${S.sanitizeInput(R.productCode)}${R.finish?" · "+S.sanitizeInput(R.finish):""} · ${R.matchCount} suggested match${R.matchCount!==1?"es":""}</div>
            </div>
            <span style="color: #d97706; font-size: 11px; font-weight: 600; white-space: nowrap; margin-left: 8px;">Review →</span>
          </li>`}const x=h.OrderCode||h.Code||"",y=h.Description||h.ProductName||h["Product Name"]||"",w=h.Image_URL||h.image_url||"",E=h._crosshairMatch,C=E?`<span style="display: inline-block; background: ${E.status==="Verified"?"#e8f5e9":"#e3f2fd"}; color: ${E.status==="Verified"?"#2e7d32":"#1565c0"}; font-size: 10px; font-weight: 600; padding: 1px 6px; border-radius: 8px; margin-left: 8px;">↔ ${S.sanitizeInput(E.competitorLabel||E.competitor)}</span>`:"",P=w?`<img src="${S.sanitizeInput(w)}" alt="" style="width:36px; height:36px; object-fit:contain; border-radius:4px; margin-right:10px; flex-shrink:0;" onerror="this.style.display='none'">`:"",A=E?Object.fromEntries(Object.entries(h).filter(([R])=>R!=="_crosshairMatch")):h;return`<li data-product='${JSON.stringify(A).replace(/'/g,"&apos;")}'
      ...
      `;n.push(l),r.forEach(u=>{n.push(this.renderRowHtml(u))})}),e.innerHTML=n.join(""),this.attachSeimaMatchSuggestions()}extractCandidateCodes(e){if(!e||typeof e!="string")return[];const t=new Set,o=[],s=/(?:Code|Part\s*(?:No\.?|Number)|P\/N|Order\s*Code|SKU|Item\s*(?:No\.?|Number)?|#)\s*:?\s*([A-Za-z0-9]{4,14}(?:[.\-][A-Za-z0-9]{2,5})?)/gi;let n;for(;(n=s.exec(e))!==null;){const d=n[1].trim();d&&!t.has(d)&&(t.add(d),o.push(d))}const i=e.split(/\|/).map(d=>d.trim()),r=/^[A-Za-z0-9]{5,14}([.\-][A-Za-z0-9]{2,5})?$/,a=/\d/,c=new Set(["white","stainless","steel","black","grey","gray","chrome","brushed","matte","polished"]);for(const d of i){if(!r.test(d)||!a.test(d))continue;const l=d.toLowerCase();c.has(l)||t.has(d)||(t.add(d),o.push(d))}return o}escapeRegex(e){return String(e).replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}buildPlaceholderHintHtml(e,t){if(!e)return"";let o=S.sanitizeInput(e);if(t.length===0)return o;for(const{code:s,competitor:n,searchCode:i}of t){const r=this.escapeRegex(s),a="(?:(?:Code|Part\\s*(?:No\\.?|Number)|P\\/N|Order\\s*Code|SKU|Item\\s*(?:No\\.?|Number)?|#)\\s*:?\\s*)?",c=new RegExp("("+a+r+")","gi"),d=i??s,l=`<a href="#" class="grid-competitor-code-link" data-competitor="${S.sanitizeInput(n)}" data-code="${S.sanitizeInput(d)}" title="Review in Validator to link to Seima product">$1</a>`;o=o.replace(c,l)}return o}async attachSeimaMatchSuggestions(){var t,o,s;if(!I.isEnabled())return;const e=document.querySelectorAll(".grid-seima-match-wrap");for(const n of e){const i=n.dataset.rowId,r=this.gridRows.find(x=>x.id===i);if(!((t=r==null?void 0:r.product)!=null&&t._placeholder))continue;const a=r.product.Description||"",c=this.extractCandidateCodes(a);if(c.length===0)continue;const d=n.closest(".grid-product-cell"),l=d==null?void 0:d.querySelector(".grid-placeholder-hint"),u=[];for(const x of c)try{const y=await I.findCompetitorEntryByCode(x);if(y){const w=y.matchedCode??((o=y.competitorProduct)==null?void 0:o.product_code)??x;u.push({code:x,competitor:y.competitor,searchCode:w})}else console.log(`Crosshair: no competitor match for code "${x}" (row ${i})`)}catch{}if(l&&u.length>0&&(l.innerHTML=this.buildPlaceholderHintHtml(a,u)),!D.isLoaded)continue;let p=null,g="";for(const x of c)try{const y=await I.findSeimaMatches(x);if(((s=y==null?void 0:y.matches)==null?void 0:s.length)>0){const w=String(y.matches[0].SeimaSKU).trim(),E=D.findProductByCode(w);if(E){p=E;const P=(y.competitorProduct||{}).product_name||E.Description||"";g=`${y.competitor}: ${x} → ${w}${P?" – "+P:""}`;break}}}catch{}if(!p)continue;const f=document.createElement("button");f.type="button",f.className="grid-seima-match-btn";const v=(p.Description||"").trim(),h=v.length>45?v.slice(0,45)+"…":v;f.textContent=`Use Seima match: ${p.OrderCode||""} – ${h}`,f.title=g,f.addEventListener("click",()=>{const x=n.closest(".grid-row"),y=x==null?void 0:x.querySelector(".grid-search-input");y&&this.selectProduct(y,p)}),n.appendChild(f)}}async openValidatorModal(e,t,o){this.closeValidatorModal();const s=document.createElement("div");s.className="grid-validator-overlay";const n=document.createElement("div");n.className="grid-validator-modal",n.innerHTML=`
    ...
    `,document.body.appendChild(s),document.body.appendChild(n);const i=()=>this.closeValidatorModal(o);n.querySelector(".gvm-close").addEventListener("click",i),s.addEventListener("click",i);const r=a=>{a.key==="Escape"&&i()};document.addEventListener("keydown",r),this._validatorModal={overlay:s,modal:n,escHandler:r,competitor:e,productCode:t};try{await I._ensureIndex();const a=await I.getMatches(e),d=(await I.getProducts(e)).find(f=>String(f.product_code)===String(t));if(!d){n.querySelector(".gvm-body").innerHTML=`<div class="gvm-no-matches">Product ${S.sanitizeInput(t)} not found in ${S.sanitizeInput(e)} data.</div>`;return}const l=a.filter(f=>String(f.CompetitorSKU)===String(t)).sort((f,v)=>(f.Rank||99)-(v.Rank||99)),u={Verified:0,Manual:1,Rejected:2,"AI-Suggested":3},p=new Map;for(const f of l){const v=String(f.SeimaSKU),h=p.get(v);(!h||(u[f.Status]??9)<(u[h.Status]??9))&&p.set(v,f)}const g=[...p.values()].sort((f,v)=>(f.Rank||99)-(v.Rank||99));this._renderValidatorModal(d,g,e)}catch(a){console.error("Validator modal load failed:",a),n.querySelector(".gvm-body").innerHTML='<div class="gvm-no-matches">Failed to load data. Check console.</div>'}}_renderValidatorModal(e,t,o){var l;const s=(l=this._validatorModal)==null?void 0:l.modal;if(!s)return;const n=e.product_name||e.product_code,i=e.image_url||e.Image||"",r=u=>S.sanitizeInput(u||"");s.querySelector(".gvm-title").textContent=`${n} — ${o}`;let a;t.length===0?a='<div class="gvm-no-matches">No Seima matches found. Use the search below to add one.</div>':a=t.map(u=>{const p=String(u.SeimaSKU||"").trim(),g=D.findProductByCode(p),f=(g==null?void 0:g.Description)||(g==null?void 0:g.ProductName)||p,v=(g==null?void 0:g.Image_URL)||(g==null?void 0:g.imageUrl)||"",h=(g==null?void 0:g.RRP_INCGST)||(g==null?void 0:g["RRP INC GST"])||"",x=h?`$${Number(h).toLocaleString("en-AU",{minimumFractionDigits:2})}`:"",y=Number(u.Confidence)||0,w=y>=70?"high":y>=40?"med":"low",E=(u.Status||"").toLowerCase().replace(/[\s-]+/g,"-");let C;return u.Status==="Verified"||u.Status==="Manual"?C=`<span class="gvm-status-label gvm-status-verified">✓ Verified</span>
    ...
    `,this._wireValidatorModalActions(e,t,o)}_wireValidatorModalActions(e,t,o){var a;const s=(a=this._validatorModal)==null?void 0:a.modal;if(!s)return;s.querySelectorAll(".gvm-match-card").forEach(c=>{c.addEventListener("click",d=>{if(d.target.closest(".gvm-btn"))return;const l=c.dataset.seimaSku;l&&this._showSeimaDetailInModal(l)})}),s.querySelectorAll(".gvm-btn-verify, .gvm-btn-reject, .gvm-btn-undo").forEach(c=>{c.addEventListener("click",async d=>{d.stopPropagation();const l=c.dataset.sku,u=c.dataset.action,p=u==="verify"?"Verified":"Rejected";c.disabled=!0,c.textContent="…";try{await I.updateMatch(o,String(e.product_code),l,p);const g=t.find(f=>String(f.SeimaSKU)===l);g&&(g.Status=p),this._renderValidatorModal(e,t,o)}catch(g){console.error("Match update failed:",g),c.disabled=!1,c.textContent=u==="verify"?"✓ Verify":"✗ Reject"}})});const n=s.querySelector(".gvm-search-add-input"),i=s.querySelector(".gvm-search-results");if(!n||!i)return;let r;n.addEventListener("input",()=>{clearTimeout(r),r=setTimeout(()=>{this._renderValidatorSeimaSearch(n.value,i,e,t,o)},250)})}_renderValidatorSeimaSearch(e,t,o,s,n){if(!e||e.length<2){t.innerHTML="";return}const i=D.searchProducts(e,20),r=new Set(s.map(d=>String(d.SeimaSKU))),a=i.filter(d=>{const l=String(d.OrderCode||d.Code||"");return l&&!r.has(l)});if(a.length===0){t.innerHTML='<div class="gvm-no-matches">No Seima products found.</div>';return}const c=d=>S.sanitizeInput(d||"");t.innerHTML=a.slice(0,15).map(d=>{const l=d.OrderCode||d.Code||"",u=d.Description||d.ProductName||"",p=d.Image_URL||d.imageUrl||"",g=d.RRP_INCGST||d["RRP INC GST"]||"",f=g?`$${Number(g).toLocaleString("en-AU",{minimumFractionDigits:2})}`:"";return`<div class="gvm-search-result" data-seima-code="${c(l)}">
      ...
      </div>`}).join(""),t.querySelectorAll(".gvm-search-result").forEach(d=>{const l=d.querySelector(".gvm-btn-verify");l==null||l.addEventListener("click",async u=>{u.stopPropagation();const p=l.dataset.seimaCode;l.disabled=!0,l.textContent="…";try{const g=s.length+1;await I.addMatch(n,String(o.product_code),p,g,"Manual verification"),await I.updateMatch(n,String(o.product_code),p,"Verified"),s.push({CompetitorSKU:String(o.product_code),SeimaSKU:p,Rank:g,Confidence:"",MatchReason:"Manual verification",Status:"Verified"}),this._renderValidatorModal(o,s,n)}catch(g){console.error("Add match failed:",g),l.disabled=!1,l.textContent="✓ Verify"}})})}closeValidatorModal(e){this._validatorModal&&(this._closeSeimaDetailPanel(),this._validatorModal.overlay.remove(),this._validatorModal.modal.remove(),this._validatorModal.escHandler&&document.removeEventListener("keydown",this._validatorModal.escHandler),this._validatorModal=null,I._index=null,this.attachSeimaMatchSuggestions())}_showSeimaDetailInModal(e){this._closeSeimaDetailPanel();const t=D.findProductByCode(e);if(!t)return;const o=u=>S.sanitizeInput(u||""),s=t.Description||t.ProductName||e,n=t.Image_URL||t.imageUrl||"",i=t.Website_URL||"",a=[["Order Code",t.OrderCode||t.Code],["Description",t.Description],["Long Description",t.LongDescription||t["Long Description"]],["Range",t.Range],["Group",t.Group],["Sub Group",t.SubGroup||t["Sub Group"]],["RRP ex GST",t.RRP_EX||t["RRP EX GST"]],["RRP inc GST",t.RRP_INCGST||t["RRP INC GST"]],["Dimensions (W)",t.DimX||t["X Dimension (mm)"]],["Dimensions (D)",t.DimY||t["Y Dimension (mm)"]],["Dimensions (H)",t.DimZ||t["Z Dimension (mm)"]],["WELS Star",t.WELS_STAR||t["WELS Star"]],["WELS Consumption",t.WELS_CONSUMPTION||t["WELS Consumption"]]].filter(([,u])=>u&&String(u).trim()&&String(u).trim()!=="0").map(([u,p])=>{const g=u.startsWith("RRP")?`$${Number(p).toLocaleString("en-AU",{minimumFractionDigits:2})}`:o(p);return`<tr><td>${o(u)}</td><td>${g}</td></tr>`}).join(""),c=document.createElement("div");c.className="gvm-detail-overlay";const d=document.createElement("div");d.className="gvm-detail-panel",d.innerHTML=`
    ...
    `,document.body.insertBefore(n,document.body.firstChild)}setupGlobalEventListeners(){window.addEventListener("generatePdf",e=>{const{tipTailSettings:t,...o}=e.detail;Gt(),qe(o,t||null)}),window.addEventListener("beforeunload",()=>{}),we.features.memoryAPI&&setInterval(()=>{const e=we.memoryInfo;e.memoryPressure==="high"&&console.warn("High memory usage detected:",e)},6e4)}getSelectedProducts(){return b.getSelectedProducts()}clearSelection(){return b.clearAllSelections()}addProduct(e,t,o,s){return b.addProductToSelection(e,t,o,s)}updateSelectionCount(){this.navigationManager&&this.navigationManager.updateSelectionCount()}showError(e){alert(e)}}document.addEventListener("DOMContentLoaded",()=>{window.seimaScanner=new Po,window.seimaScanner.init()});window.addEventListener("DOMContentLoaded",()=>{fetch("./version.txt").then(m=>m.text()).then(m=>{const e=m.trim().split(`
`);if(e.length>0){const o=e[0].split(" - ")[0].trim(),s=document.getElementById("app-version");s&&(s.textContent=`Ver: ${o}`,s.style.cursor="pointer",s.addEventListener("click",Lo))}}),Co(),ko()});function Co(){const m=document.getElementById("help-btn");m&&m.addEventListener("click",()=>{Io()});const e=document.getElementById("crosshair-btn");e&&e.addEventListener("click",()=>{window.location.href="screens/validator.html"});const t=document.getElementById("landscape-btn");t&&t.addEventListener("click",()=>{window.location.href="screens/landscape.html"});const o=document.getElementById("admin-btn");o&&o.addEventListener("click",()=>{window.location.href="screens/admin.html"});const s=document.getElementById("quick-start-btn");s&&s.addEventListener("click",()=>{ht.showForced()})}function ko(){const m=document.getElementById("user-menu-container"),e=document.getElementById("user-menu-trigger"),t=document.getElementById("user-menu-dropdown"),o=document.getElementById("sign-in-btn"),s=document.getElementById("user-avatar"),n=document.getElementById("user-name-display");function i(c){var d,l,u,p,g,f,v,h;if(c){(d=M.CROSSHAIR)!=null&&d.ENABLED&&(I.configure(M.CROSSHAIR,c.email||""),I.preload().catch(A=>{console.warn("Crosshair preload after login failed:",A)})),m&&(m.style.display="block"),o&&(o.style.display="none");const x=document.getElementById("crosshair-btn");x&&(x.style.display=(l=M.CROSSHAIR)!=null&&l.ENABLED&&j.isStaffMode()?"":"none");const y=document.getElementById("landscape-btn");y&&(y.style.display=(u=M.CROSSHAIR)!=null&&u.ENABLED&&j.isAdmin()?"":"none");const w=document.getElementById("admin-btn");w&&(w.style.display=j.isAdmin()?"":"none");const E=r(c.name);s&&(s.textContent=E),n&&(n.textContent=((p=c.name)==null?void 0:p.split(" ")[0])||"User");const C=(c.email||"").toLowerCase().endsWith("@seima.com.au")&&c.emailVerified===!1;let P=document.getElementById("verify-email-banner");if(C?(P||(P=document.createElement("div"),P.id="verify-email-banner",P.className="verify-email-banner",P.innerHTML=`
            <span>Verify your email to access staff features.</span>
            <button id="verify-email-btn" class="verify-email-btn">Verify now</button>
          `,document.body.insertBefore(P,document.body.firstChild),P.querySelector("#verify-email-btn").addEventListener("click",()=>{G.showVerifyEmail(c.email,()=>{i(j.getCurrentUser()),P==null||P.remove()})})),P.style.display=""):P&&(P.style.display="none"),t){const A=C?`
        ...
        `,(g=document.getElementById("menu-verify-email"))==null||g.addEventListener("click",()=>{t.style.display="none",G.showVerifyEmail(c.email,()=>{var R;i(j.getCurrentUser()),(R=document.getElementById("verify-email-banner"))==null||R.remove()})}),(f=document.getElementById("menu-profile"))==null||f.addEventListener("click",()=>{t.style.display="none",G.showEditProfile(R=>{b.clearUserSettings(),i(R)})}),(v=document.getElementById("menu-password"))==null||v.addEventListener("click",()=>{t.style.display="none",G.showChangePassword()}),(h=document.getElementById("menu-logout"))==null||h.addEventListener("click",()=>{t.style.display="none",b.clearUserSettings(),j.logout(),i(null)})}}else m&&(m.style.display="none"),o&&(o.style.display="block")}function r(c){if(!c)return"?";const d=c.trim().split(" ");return d.length>=2?(d[0][0]+d[d.length-1][0]).toUpperCase():c.substring(0,2).toUpperCase()}function a(c){const d=document.createElement("div");return d.textContent=c||"",d.innerHTML}e&&t&&(e.addEventListener("click",c=>{c.stopPropagation();const d=t.style.display!=="none";t.style.display=d?"none":"block"}),document.addEventListener("click",c=>{m!=null&&m.contains(c.target)||(t.style.display="none")})),o&&o.addEventListener("click",()=>{G.showLogin(c=>{i(c)})}),j.onAuthChange=i,i(j.getCurrentUser())}function Io(){const m=document.getElementById("user-guide-modal"),e=document.getElementById("user-guide-content");if(!m||!e)return;e.innerHTML=Ro(),m.style.display="flex";const t=document.getElementById("user-guide-close");t&&(t.onclick=()=>{m.style.display="none"}),m.onclick=s=>{s.target===m&&(m.style.display="none")};const o=s=>{s.key==="Escape"&&(m.style.display="none",document.removeEventListener("keydown",o))};document.addEventListener("keydown",o)}function Ro(){return`
  ...
  `}async function Lo(){try{const m=document.getElementById("changelog-modal"),e=document.getElementById("changelog-content"),s=(await(await fetch("./version.txt")).text()).trim().split(`
